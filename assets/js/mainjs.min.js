            ...
            if ("saved_fave" == e.after) {
                ...
                if ("" != e.class) {
                   // t.addClass("active");
                    ...
                    //t.find("i").removeClass("iconHeartEmpty").addClass("iconHeart")
                } else {
                   // t.removeClass("active");
                    i = parseInt($("#dataCounter").html());
                    isNaN(i) || $(".dataCounter-fav").html(i - 1);
                    //t.find("i").removeClass("iconHeart").addClass("iconHeartEmpty")
                }
            } else if ("saved_search" == e.after) {
                t = $("#fav_button_url");
                "" != e.class ? (t.addClass("active"), t.html("Remove Search")) : t.html("Save Search"), successAlert("Success!", e.message)
            }
