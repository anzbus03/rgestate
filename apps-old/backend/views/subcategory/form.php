        ...
        <div class="box box-primary">
            ...
            <div class="box-body">
                ...
                ?>
                 ...
                 <div id="header">
					<ul>
				    <li id="selected"><a href="<?php if($model->sub_category_id) { echo $this->createUrl(Yii::app()->controller->id.'/update',array("id" => $model->sub_category_id )) ; } else { echo "#"; } ?>">Sub Category Details</a></li>
                ...
                <div class="form-group col-lg-6">
                    ...
                    <?php echo $form->dropDownList($model,'category_id',CHtml::listData(Category::model()->findAll(),"category_id" ,"category_name"), $dropdwn  ); ?>
