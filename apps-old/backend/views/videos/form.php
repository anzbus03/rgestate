        ...
        <div class="box box-primary">
            <div class="box-header">
                ...
                <div class="pull-right">
                    ...
                    <?php } ?>
                    <?php echo CHtml::link(Yii::t('app', 'Cancel'), array('videos/index'), array('class' => 'btn btn-primary btn-xs', 'title' => Yii::t('app', 'Cancel')));?>
                </div>
            ...
            <div class="box-body">
                ...
                <div class="form-group">
                    ...
                    <?php echo $form->textField($article, 'title', $article->getHtmlOptions('title', array('data-article-id' => (int)$article->article_id, 'data-slug-url' => $this->createUrl('videos/slug')))); ?>
                ...
                */
                ...
                <div class="form-group">
                    ...
                    <?php echo $form->textField($article, 'content', $article->getHtmlOptions('content', array('rows' => 15))); ?>
