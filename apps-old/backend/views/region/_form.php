                ...
                <div class="clearfix"><!-- --></div>
                 ...
                 <div class="form-group col-lg-6">
                    <?php echo $form->labelEx($model, 'country_id');?>
                     <?php $mer =  array_merge($model->getHtmlOptions('country_code'),array('empty'=>"Select Country")); ?>
                    <?php echo $form->dropDownList($model, 'country_id', CHtml::listData(Countries::model()->Countrylist(),'country_id','country_name') , $mer ); ?>
