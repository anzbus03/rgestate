                       ...
                       array(
                            ...
                            'value' => function($data){
								         echo "<div class='property_img_box1'>";
								        	?>
													<div id="property_img_1" class="property_img  divborder_approve"  style="line-height:40px;width:70px;" >
													<?php echo Yii::app()->easyImage->thumbOf(Yii::app()->basePath . '/../../uploads/avatar/'.$data->avatar_name,
													array(
