...
if ($viewCollection->renderContent) { ?> 
    <div class="box box-primary">
        <div class="box-header">
            <div class="pull-left">
                <h3 class="box-title">
                    <span class="glyphicon glyphicon-book"></span> <?php echo Yii::t('articles', 'Video categories');?>
                </h3>
            </div>
            <div class="pull-right">
                ...
                <?php echo CHtml::link(Yii::t('app', 'Refresh'), array('video_categories/index'), array('class' => 'btn btn-primary btn-xs', 'title' => Yii::t('app', 'Refresh')));?>
            </div>
                        ...
                        array(
                            ...
                            'buttons'   => array(
                                ...
                                'update' => array(
                                    ...
                                    'url'       => 'Yii::app()->createUrl("video_categories/update", array("id" => $data->category_id))',
                                    'imageUrl'  => null,
                                    'options'   => array('title' => Yii::t('app', 'Update'), 'class' => ''),
                                ),
                                'delete' => array(
                                    'label'     => ' &nbsp; <span class="glyphicon glyphicon-remove-circle"></span> &nbsp; ', 
                                    'url'       => 'Yii::app()->createUrl("video_categories/delete", array("id" => $data->category_id))',
                                    'imageUrl'  => null,
