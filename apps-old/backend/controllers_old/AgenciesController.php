...
class AgenciesController extends Controller
{
    ...
    public function actionIndex()
    {
        ...
        $this->setData(array(
            'pageMetaTitle'     => $this->data->pageMetaTitle . ' | '. Yii::t('users', 'Agencies List'), 
            'pageHeading'       => Yii::t('agent', 'Agencies List'),
            'pageBreadcrumbs'   => array(
                Yii::t('capacity', 'Agencies') => $this->createUrl('Agencies/index'),
                Yii::t('app', 'View all')
            )
        ));
    ...
    public function actionCreate()
    {
        ...
        if ($request->isPostRequest && ($attributes = (array)$request->getPost($user->modelName, array()))) {
            ...
            if ($collection->success) {
                $this->redirect(array('Agencies/index'));
            }
        }
        
        $this->setData(array(
            'pageMetaTitle'     => $this->data->pageMetaTitle . ' | '. Yii::t('users', 'Create Agencies'), 
            'pageHeading'       => Yii::t('agent', 'Create Agencies'),
            'pageBreadcrumbs'   => array(
                Yii::t('agent', 'Agencies') => $this->createUrl('Agencies/index'),
    ...
    public function actionUpdate($id)
    {
        ...
        $user = Agencies::model()->findByPk((int)$id);
     ...
     //  echo  $user->password;echo "SDSD";exit;
            ...
            $user->con_password="";
        $this->setData(array(
            'pageMetaTitle'     => $this->data->pageMetaTitle . ' | '. Yii::t('capacity', 'Update Agencies'),
            'pageHeading'       => Yii::t('agent', 'Update Agencies'),
            'pageBreadcrumbs'   => array(
                Yii::t('agent', 'Agencies') => $this->createUrl('Agencies/index'),
                Yii::t('app', 'Update'),
            )
    ...
    public function actionDelete($id)
    {
        ...
        if (!$request->getQuery('ajax')) {
            ...
            $this->redirect($request->getPost('returnUrl', array('Agencies/index')));
        }
    }
