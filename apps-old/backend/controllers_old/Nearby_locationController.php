...
class Nearby_locationController extends Controller
{
     ...
     */
     public $Controlloler_title= "Nearby Location Manager";
    ...
    public function actionIndex()
    {
         ...
         $model = new NearbyLocation('serach');
    ...
    public function actionUpdate($id)
    {
        ...
        $model = NearbyLocation::model()->findByPk((int)$id);
     ...
     public function actionLoadState()
	{
	   ...
	   $id=Yii::app()->request->getQuery("country_id");
	   $data=States::model()->getStateList($id);
