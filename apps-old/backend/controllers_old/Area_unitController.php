...
class Area_unitController  extends Controller
{
     ...
     */
     public $Controlloler_title= "Area Unit";
    ...
    public function actionIndex()
    {
         ...
         $notify = Yii::app()->notify;
          if($request->getQuery('update_cache','0')=='1'){
                $cacheKey =  'area_unit'.Yii::app()->options->get('system.common.area_unit_cache','123s421');
                Yii::app()->cache->delete($cacheKey);
                Yii::app()->options->set('system.common.area_unit_cache',time());
                 $notify->addSuccess(Yii::t('app', 'Cache successfully updated!'));
				  $this->redirect(Yii::app()->createUrl(Yii::app()->controller->id.'/index')) ;
         }
         $model = new AreaUnit('serach');
    ...
    public function actionUpdate($id)
    {
        ...
        $model = AreaUnit::model()->findByPk((int)$id);
