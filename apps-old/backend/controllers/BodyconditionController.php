...
class BodyconditionController extends Controller
{
     ...
     */
     public $Controlloler_title= "Body Condition ";
     public $focus = "bodycondition_name";
    ...
    public function actionIndex()
    {
         ...
         $model = new Bodycondition('serach');
    ...
    public function actionUpdate($id)
    {
        ...
        $model = Bodycondition::model()->findByPk((int)$id);
