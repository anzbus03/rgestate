                                                    ...
                                                    <div class="row">
                                                            ...
                                                            <div class="xxsCol24">
                                                                <div id="moreFilters">
                                                                    ...
                                                                    <div id="listing_type" class="field pbxxl">
                                                                        <label class="fieldLabel">Listing Type</label>
                                                                        <div class="zIndexNavigation filterContainer">
                                                                            <div class="field man">
                                                                                <div class="btnGroup bedCls">
																					<?php
																					...
																					echo '<button class="btn btnDefault btnTouch ';echo  ( $filterModel->listing_type== $k ) ?'btnSecondary':'' ; echo '" onclick="setThisListingVal(this)" data-value="'.$k.'">'.$v.'</button>';
