...
<div id="twelve">
        ...
        <ul class="span_sec_blog">
			<li><a href="<?php echo Yii::app()->createUrl('blog');?>" class="">All</a></li>
			<?php 
			if($category):
			foreach($category as $k=>$v):
			?>
			<li><a href="<?php echo Yii::app()->createUrl('blog/'.$v->slug);?>" class=""><?php echo $v->name ;?> (<?php echo $v->blogCount;?>)</a></li>
			<?
			endforeach;
			endif;
			?>
