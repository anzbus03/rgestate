...
<div id="profile-content">
  ...
  <?php
		...
		return false;
		 ...
		 {
			 $image =Yii::app()->easyImage->thumbSrcOf(Yii::app()->basePath . '/../../uploads/avatar/'.$user->image, array('scaleAndCrop' => array('width' => '140', 'height' => 140)));
		 }
		 else
		 {
    ...
    <div class="avatar-col">
        <div class="profile-photo">
			<a href="#commingsoon">
			<img src="<?php echo $image;?>" width="144" height="144" />
		   </a><span class="chng-avatar"><a href="<?php echo Yii::app()->createUrl("user/my_avatar");?>" class="chng-avatar-link">Change avatar</a></span></div>
    </div>
                        ...
                        <ul class="user-info user-info-col">
                            ...
                            <li class="user-info-col-item">
                                <div id="cover-letter-container">
                                    ...
                                    <?php echo $form->textArea($user, 'cover_letter', array('rows' => 10,'id'=>'id_cover_letter','placeholder'=>'This is where you&#39;d type your cover letter when applying for jobs through  RS classify. Say something pertinent to the job you&#39;re applying for, keep it honest, concise and individual.','cols'=>'30','class'=>'textarea')); ?>
                        ...
                        * */
                        ...
                        <ul id="subscriptions">
                            ...
                            <li class="clear">
                                ...
                                <span class="subs-text"><label for="id_dubizzle_email_updates">The weekly  <?php echo Yii::app()->name;?> newsletter of the most popular steals across the <?php echo Yii::app()->name;?> site.</label></span>
                            </li>
                            <li class="clear">
                                <span class="subs-tick">
