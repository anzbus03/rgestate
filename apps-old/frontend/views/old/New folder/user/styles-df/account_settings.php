...
<fieldset id="account-settings" class="span12">
  ...
  <div class="group" id="name">
	...
	'htmlOptions' => array('class' => 'form-e'),
        ...
        <div class="col">
          <input type="submit" name="sitesearch" alt="Change my name" title="Change my name"  value="Change Name" style="width:96px" class="awesome2" />
        </div>
  ...
  <div class="group" id="password">
	...
	'htmlOptions' => array('class' => 'form-e'),
        ...
        <div class="col">
          <input type="submit" name="sitesearch" alt="Change my password" title="Change my password" value="Change Password"  style="width:116px" class="awesome2" />
        </div>
