 ...
 * */
 ?>
<div id="wrapper">
  <div id="header"> <a href="<?php echo Yii::app()->createUrl("");?>/" class="english"><img id="logo" src="<?php echo Yii::app()->theme->baseUrl;?>/images/classifieds-logo.png" alt="rsclassifieds" /></a> <a href="#" class="arabic"><img id="logo" src="<?php echo Yii::app()->theme->baseUrl;?>/images/classifieds-logo.png" alt="rsclassifieds" /></a>
    <div id="tag">
  ...
  <div id="hint">
    ...
    <span></span> </div>
  <div id="map"> <img src="<?php echo Yii::app()->theme->baseUrl;?>/images1/transparentmap.gif" usemap="#map" class="map" alt="" />
    <map name="map" id="map-areas">
		...
		if($model)
		{
			foreach($model as $k=>$v)
			{
				...
				<?
				 $image .= '<img src="'. Yii::app()->theme->baseUrl.'/images1/'.$v->image.'.png" class="region '.$v->image.'" alt="" title="'.$v->country_name.'" />';
			}
		}
		?>
			</map>
   <?php  echo   $image;?>
    <img src="<?php echo Yii::app()->theme->baseUrl;?>/images1/map.png" class="mapbg" alt="" /> 
      </div>
