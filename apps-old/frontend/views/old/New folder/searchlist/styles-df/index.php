            ...
            <div id="results-list" class="show-highlighted-ads"  >
             ...
             if($model)
			 {
				...
				foreach($model as $k=>$v)
				{
				  ...
				  {
					      $fields = CHtml::listData($v->category->relatedFields,'field_name','field_name');
				  }
				   ?>
				...
				<?php }
				 ...
				 ?>
						   <div class="cf item <?php echo  ($v->featured=="Y")?'paid-featured-item':'';?> featured-motors">
							...
							<div class="listing-item">
								 <div class="block item-title">
									...
									{
									?>
									AED <?php echo number_format($v->price,0,'.',''); ?> 
									<?php
									}
									?>
									<br/>
                            ...
                            <div class="thumb">
                                <a href="<?php echo Yii::app()->createUrl("details/".$v->slug) ;?>" xtclib="listing_list_16_thumb_link" xtcltype="S">
                                ...
                                <span class="image-count">
								 ...
								 <div class="description">
									<div class="block">
										<p class="breadcrumbs"> <?php echo $v->category->category_name; ?> <?php if( $v->subCategory) { ?> &#8234;&gt;&#8234;   <?php echo $v->subCategory->sub_category_name; ?> <?php } ?> </p>
									</div>
									...
									<li>
										<div  class="listing-agent">
											 ...
											 <?php 
											 if(isset($v->Customer->xml_inserted) and $v->Customer->xml_inserted=='1')
											 {
												$image = $v->Customer->xml_image; 
											 }
											 else
											 {
										 
											 if(isset($v->Customer->image))
											 {
												  $image =$v->Customer->image;
											 
													if(ListingUsers::model()->is_image(Yii::app()->basePath . '/../../uploads/avatar/'.$image)=='1')
													{
													$image =  Yii::app()->params['uploadDir'].'/avatar/'.$image;
													...
													{
													$image = Yii::app()->params['uploadDir'].'/avatar/default_avatar.png';
													}
											 }
											 else
										     {
											...
											<a href="#">
												<img src="<?php echo $image; ?>" width="85px"  alt="">
                   ...
                   <?
						...
						if(in_array("price",$fields))
						{
						$CONTENT .='<h2 class="pos_right_amount">AED '.number_format($v->price,0,'.','').'</h2>';
