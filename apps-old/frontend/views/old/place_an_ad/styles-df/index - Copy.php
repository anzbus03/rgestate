  ...
  <?php
   ...
   {?>
   <div class="error1 marginleft30"><?php echo Yii::app()->user->getFlash('error');?>.</div>
   <?php
   }
   ?>
  <?php
   ...
   {?>
   <div class="confirmation marginleft30"><?php echo Yii::app()->user->getFlash('success');?>.</div>
   <?php
   }
   ?>
  <fieldset id="report-help"  class="span12">
    ...
    ?>
                ...
                <div class="row">
                    <div class="col wide">
						...
						<?php $dropdwn =   array_merge( $model->getHtmlOptions('type'),array('empty'=>'Please choose a subject ' )) ;  ?> 
				...
				<div class="col wide">
                        ...
                        <div id="captcha">
							...
							false); ?> 
							<?php   echo $form->textField($model, 'verifyCode', array_merge($model->getHtmlOptions('verifyCode'),array("placeholder"=>"" ,"class"=>"captcha-input","style"=>" font-size: 30px;height: 42px;vertical-align: top;width: 97px;","maxlength"=>5)));  
		?>
							<?php endif; ?>
