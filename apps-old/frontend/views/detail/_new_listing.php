...
$order = '';
$order .= '  t.id desc    ' ; 
$new_listing = PlaceAnAd::model()->findAds(array('sort'=>'custom','custom_order'=>$order,'_state_id'=>$model->state),false,false,false,false);
if(!empty($new_listing)){?>
    <div class="col-lg-12 col-md-6 sfListing" style="padding-left: 0px;padding-right: 0px;">
         <div class="container">
            <div class="row">
               <h3 class="margin-top-40"> New Listings </h3>
