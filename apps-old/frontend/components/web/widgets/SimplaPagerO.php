<?php
class SimplaPagerO extends CLinkPager{
	...
	protected function createPageButton($label,$page,$class,$hidden,$selected)
	{
		...
		{
		case 'F'	:
		 return ($hidden)?' <span><a href="'.$this->createPageUrl($page).'"  class="pvl phm" id="last_page">&lt;&lt;</a></span>':'<span><a href="'.$this->createPageUrl($page).'"   class="pvl phm" id="last_page">&lt;&lt;</a></span>';
		...
		break;
		case 'N':
		 return ($hidden)?'<span><a href="'.$this->createPageUrl($page).'"  class="pvl phm" id="next_page">&gt;</a></span>':'<span><a href="'.$this->createPageUrl($page).'"   class="pvl phm" id="next_page">&gt;</a></span>';
		break;
		case 'L':
		 return ($hidden)?'<span><a href="'.$this->createPageUrl($page).'"   class="pvl phm" id="last_page">&gt;&gt;</a></span>':'<span><a href="'.$this->createPageUrl($page).'"   class="pvl phm" id="last_page">&gt;&gt;</a></span>';
		break;
		...
		{
			return '<span><a class="page-links pvl phm"   href="'.$this->createPageUrl($page).'">'.$label.'</a></span>';
		}
	    break;
		}
