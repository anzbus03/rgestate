      ...
      <div class="slider-form advamced">
        <div class="container">
          ...
          <ul class="nav-tabs--search nav-tabs--search-mobile" role="tablist">
            ...
            <li class="nav-item nav-tabs--searchh"> <a class="nav-link  "  href="javascript:void(0)"  data-href="<?php echo $conntroller->createUrl('business_listing/filter',array('sec'=>'business-for-sale'));?>" onclick="load_filter(this)"><?php echo $tag->getTag('businesses_for_sale','Businesses For Sale');?> </a> </li>
          ...
          <ul class="nav-tabs--search" role="tablist">
            ...
            <li class="nav-item nav-tabs--searchh"> <a class="nav-link  "   href="<?php echo $conntroller->createUrl('business_listing/index',array('sec'=>'business-for-sale'));?>"><?php echo $tag->getTag('businesses_for_sale','Businesses For Sale');?> </a> </li>
