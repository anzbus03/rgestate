<?php
class SimplaPagerN extends CLinkPager{
	...
	protected function createPageButton($label,$page,$class,$hidden,$selected)
	{
		...
		{
		case 'F'	:
		 return ($hidden)?' <span><a href="'.$this->createPageUrl($page).'" onclick="clickPginate2(this,event)" class="pvl phm" id="last_page">&lt;&lt;</a></span>':'<span><a href="'.$this->createPageUrl($page).'"  onclick="clickPginate2(this,event)" class="pvl phm" id="last_page">&lt;&lt;</a></span>';
		...
		break;
		case 'N':
		 return ($hidden)?'<span><a href="'.$this->createPageUrl($page).'"  onclick="clickPginate2(this,event)" class="pvl phm" id="next_page">&gt;</a></span>':'<span><a href="'.$this->createPageUrl($page).'"  onclick="clickPginate2(this,event)" class="pvl phm" id="next_page">&gt;</a></span>';
		break;
		case 'L':
		 return ($hidden)?'<span><a href="'.$this->createPageUrl($page).'"  onclick="clickPginate2(this,event)" class="pvl phm" id="last_page">&gt;&gt;</a></span>':'<span><a href="'.$this->createPageUrl($page).'"  onclick="clickPginate2(this,event)" class="pvl phm" id="last_page">&gt;&gt;</a></span>';
		break;
		...
		if($selected)
		{
			return ' <span><a class="current pvl phm" href="#">'.$label.'</a></span>';
		}
		else
		{
			return '<span><a class="page-links pvl phm"  onclick="clickPginate2(this,event)" href="'.$this->createPageUrl($page).'">'.$label.'</a></span>';
		}
	    break;
		}
