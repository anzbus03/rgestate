...
$category_list = 'all|shopping-mall|residential-building|other-commercial|schools|hospital|penthouse|factory|townhouse|hotel-apartment|floor|warehouse|bulk-units|labor-camp|labour-camps|staff-accommodation|showroom|entertainment-complex|duplex|restaurant|wedding-venue|industrial|building|retail|farm|compound|palace|office|land|apartment|villa';
...
array('listing/index', 'pattern' =>'<sec:(property-for-sale|property-for-rent|to-rent|preleased|new-development|all)>/*'),  
                    ...
                    array('business_listing/index', 'pattern' =>'<sec:(business-for-sale)>/<type_of:('.$busines_category.')>/<state:(.*)>/*'),
                    array('business_listing/index', 'pattern' =>'<sec:(business-for-sale)>/<type_of:('.$busines_category.')>/*'),
                    array('business_listing/index', 'pattern' =>'<sec:(business-for-sale)>/<state:(.*)>/*'),
                    array('business_listing/index', 'pattern' =>'<sec:(business-for-sale)>/*'),  
                    array('business_listing/index', 'pattern' =>'<sec:(business-for-sale)>/<type_of:('.$busines_category.')>/<state:(.*)>/*'),
                    array('business_listing/index', 'pattern' =>'<sec:(business-for-sale)>/<type_of:('.$busines_category.')>/*'),
                    array('business_listing/index', 'pattern' =>'<sec:(business-for-sale)>/<state:(.*)>/*'),
                    array('business_listing/index', 'pattern' =>'<sec:(business-for-sale)>/*'),  
                    '<sec:(business-for-sale)>'=>'business_listing/index',
