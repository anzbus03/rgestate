...
class Business_listingController extends Controller
{
    ...
    */
	 ...
	 * */
		...
		if (empty($m_title)) {
			$m_title .= $this->tag->getTag('business_for_sale', 'Businesses for Sale');
		} else {
		...
		$newMetaTitle = Yii::t('app',  'Business for sale' . ' | {project} ', array('{project}' => $this->project_name));
