	...
	*/
	...
	public function actionPopulating_data()
	{
	    ...
	    */
		...
		if (!isset($formData['state']) and !isset($formData['type_of'])) {
			...
			if (isset($formData['state']) and !in_array(strtolower($formData['state']), array('fujairah', 'umm-al-quwain', 'ras-al-khaimah', 'al-ain', 'ajman', 'sharjah', 'abu-dhabi', 'dubai'))) {
				$htm = $this->renderPartial('_list_location_city', compact('formData', 'adModel'), true, false);
			} else {
				$htm = $this->renderPartial('_list_categories', compact('formData', 'adModel'), true, false);
			}
		} else if (isset($formData['state'])   and  in_array(strtolower($formData['state']), array('fujairah', 'umm-al-quwain', 'ras-al-khaimah', 'al-ain', 'ajman', 'sharjah', 'abu-dhabi', 'dubai'))) {
	...
	public function actionSend(){
		...
		$services = [
		    'Real Estate' => '1192',
            'Project Funding' => '1194',
            'Startups Funding' => '1196',
            'Retail Investments' => '1198',
            'Project Development' => '1200',
            'Project Contracting' => '1202',
            'Interior Fitouts' => '1204',
            'Building Maintenance' => '1206',
            'Business Buying & Selling' => '1208',    
		];
		$crmData = [
			'FIELDS' => [
