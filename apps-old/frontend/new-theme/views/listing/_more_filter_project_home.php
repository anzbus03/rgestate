                                                                            ...
                                                                            <div class="fieldItem text  ">
                                                                                <div class="col cols24 pln">
                                                                                    <div class="suggestions" style="text-align:center;" >
                                                                                        <input style="width:100%;;"  autocomplete="off" role="combobox" aria-autocomplete="list" aria-owns="react-autowhatever-1" aria-expanded="false" aria-haspopup="false" id="keywordInput" placeholder="<?php echo  'Pool, Parking...' ;?>" name="keyword" value="" class="fieldTouch" type="text">
