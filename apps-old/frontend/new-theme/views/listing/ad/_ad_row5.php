   <div class="margin-bottom-50" id="<?php echo $rw_ids;?>">
				   <div class=" ">
                     ...
                     <div class="col-md-12 padding-0">
                        <h3 class="headline  <?php echo  empty($sub_header)? 'margin-bottom-20':'margin-bottom-0';?>    col-md-12 no-margin-left padding-left-0 "> <?php echo $header; ?> </h3>
												  ...
												  <a href="<?php echo $v->detailUrl;?>" class="listing-item-container  margin-bottom-0">
													 <div class="listing-item">
													   <?php   $image =  $v->MainImage;?>
														<img src="<?php echo $this->app->apps->getBaseUrl('timthumb.php');?>?src=<?php   echo  $image   ;?>&h=242&w=209&zc=1" alt="">
														<!--<span class="like-icon"></span>--> 
													 </div>
													 <div class="_wyr5tw"></div>
													 <div class="listing-item-content spanfont absC padding-right-0">
														 <div class="_96n9kn"><?php 
														 if(!empty($v->UserName) and in_array($tag->tag_id,array('3','7','8'))){
															 ?><div class="_w1effmn"><?php echo $v->UserName;?></div><?php
														 }
														 else if(!empty($v->community_name)){ ?><div class="_w1effmn"><?php echo $v->community_name;?></div><?php } ?>
														 
														  <div class="_eiid8jn"><?php echo $v->ad_title;?></div></div>
													 </div>
												  </a>
											   </div>
