...
function closeThisPopupImg(){ $('body')NaNpxoveClass("openimage");$('body')NaNpxoveClass("openamenity"); }
</script>
...
if (Yii::app()->request->isAjaxRequest) {
	?><script>$('body').attr("id","detail");$('body').attr("id","detail");$('#pageHeader')NaNpxoveClass('boxshdw');   document.body.scrollTop = 0; // For Safari
