          ...
          >
            ...
            <div class="d-flex align-items-center">
              <ul class="navbar-nav flex-row ms-auto mb-2 mb-lg-0 rg-fs-14 rg-fw-500">
                <li class="nav-item">
                  <a class="nav-link rg-fs-13 rg-fw-400" href="<?php echo Yii::app()->createUrl('area-guides'); ?>">Area Guides</a>
                </li>  
                <li class="nav-item ps-4">
                  <a class="nav-link rg-fs-13 rg-fw-400" href="<?php echo Yii::app()->createUrl('blog'); ?>">Blog</a>
                </li>
                <li class="nav-item ps-4">
                ...
                <li class="nav-item ps-4">
                  <a class="nav-link rg-fs-13 rg-fw-400" href="<?php echo Yii::app()->createUrl('contact-us'); ?>">Contact Us</a>
                </li>
              </ul>
              <div class="rg-search-content position-relative ms-4">
                <input
                   type="text" required="" value="" maxlength="15" id="property_id" onkeypress="return enterKeyPressed(event)" name="property_id" placeholder="Reference ID" autocomplete="off"
        ...
        <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasNavbar"
            ...
            <div class="offcanvas-body align-items-center">
                <ul class="navbar-nav ms-auto mb-2 mb-lg-0 rg-fs-14 rg-fw-500">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="<?php echo Yii::app()->createUrl('preleased'); ?>">Preleased</a>
                    </li>
                    
                    <li class="nav-item">
                        <a class="nav-link" href="<?php echo Yii::app()->createUrl('new-development');?>">New Projects</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="<?php echo Yii::app()->createUrl('business-for-sale');?>">Businesses For Sale</a>
                    </li>
                   <li class="nav-item dropdown">
                      <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">Services</a>
                      <ul class="dropdown-menu rg-dropdown">
                        <li><a class="dropdown-item" href="<?php echo Yii::app()->createUrl('services/project_funding');?>">Project Funding</a></li>
                        <li><a class="dropdown-item" href="<?php echo Yii::app()->createUrl('services/retail_investments');?>">Retail Investments</a></li>
                        <li><a class="dropdown-item" href="<?php echo Yii::app()->createUrl('services/startup_funding');?>">Startup Funding</a></li>
                        <li><a class="dropdown-item" href="<?php echo Yii::app()->createUrl('services/project_development');?>">Project Development</a></li>
                        <li><a class="dropdown-item" href="<?php echo Yii::app()->createUrl('services/project_contracting');?>">Project Contracting</a></li>
                        <li><a class="dropdown-item" href="<?php echo Yii::app()->createUrl('services/interior_fitouts');?>">Interior Fitouts</a></li>
                        <li><a class="dropdown-item" href="<?php echo Yii::app()->createUrl('services/building_maintenance');?>">Building Maintenance</a></li>
                        <li><a class="dropdown-item" href="<?php echo Yii::app()->createUrl('services/business_buying_selling');?>">Business Buying & Sell</a></li>
                      </ul>
                    </li>
                </ul>
                <a href="<?php echo Yii::app()->createUrl('choose-your-option'); ?>" class="btn btn-dark">Submit Property <span
                        class="badge rounded-pill rg-fs-11 rg-fw-500 rounded ms-2">Free</span></a>
            </div>
        </div>
    </div>
</nav>
