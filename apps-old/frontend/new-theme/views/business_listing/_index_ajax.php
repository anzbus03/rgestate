		...
		<div class="container   <?php echo  $l_view; ?>" id="d_column" style="margin-bottom: 40px !important;">
			...
			<div class="row not-for-development">
				...
				<style>
					...
					#business_listing .pagination .actions.li-css-n li {
					...
					#business_listing .pagination .actions.li-css-n a {
						width: 100%;
						height: 100%;
						margin: 0 !important
					}
					...
					#business_listing .pagination .actions.li-css-n a.current {
						background: var(--logo-color);
						color: #fff
					}
					...
					#business_listing .pagination .actions.li-css-n a:hover:not(:disabled) {
						background-color: #cdebd5;
						color: var(--logo-color)
					}

					#business_listing .actions.li-css-n span.spl-inrt {
						margin-right: 2px;
						margin-left: 2px
					}

					#business_listing .actions.li-css-n span {
						display: inline-block
					}
		...
		if ($formData['sec'] != 'new-development') { ?>
			<script>
				$(function() {
					...
					$.get('<?php echo $this->app->createUrl('site/populating_data', (array)@$formData); ?>', function(data) {
