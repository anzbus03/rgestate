    ...
    font-size: 18px;
} html #cn_property input.input-text.form-control {
    max-width: 100% !important;
               ...
               <div class="backgroundBasic sign-in-form   " id="topPanelLeadFormContainer">
                     <div data-reactroot="" class="pvn clearfix">
                        <div class="false padding-left-0 padding-right-15 padding-bottom-15"  >
	...
	<div class="form-group  margin-bottom-5">
						    ...
						    <div class="row" style="display: flex;">
							  <div class="col-sm-12" style="display: flex;">
									...
									<button  type="buttom"   onclick="OpenSignupRequiredNewEmail(this)" data-reactid="<?php echo $model->user_id;?>"  class="btn btn-primary btn-block headfont btn-sm-s  text-center"  style=" padding: 0px 10px;height: 36px;"  ><i class="fa fa-envelope margin-right-3"  style= "font-size:20px;"></i>  <span  id="bb2"><?php echo $mainTex;?></span></button>
