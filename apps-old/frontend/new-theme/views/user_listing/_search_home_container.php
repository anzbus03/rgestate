		...
		<div class=" banner-box-content">
                    ...
                    <p>Agents a local experts who can get you better result for lower fees.</p>
						...
						<?php echo $form->dropDownList($model, 'regn',CHtml::listData(States::model()->findListingCountries($model->country_slug),'slug','state_name'),$model->getHtmlOptions('region',array('class'=>'form-control','empty'=>'Select region' ))); ?>
