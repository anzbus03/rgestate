...
<section class="rg-buy-rent-sell rg-outline-btn">
    <div class="container">
        <div class="rg-section-header text-center mx-auto">
            ...
            <h2 class="rg-fs-30 rg-sm-fs-24 rg-text-blue rg-fw-600 text-capitalize rg-mt-20">Expertise in Buying, Selling & Renting Properties</h2>
            <p class="rg-fs-18 rg-sm-fs-14 rg-text-gray-600 rg-fw-400 rg-mt-20">RGEstate is your dedicated partner for buying, selling, and renting commercial properties. Unlock a world of investment opportunities as we assist you in making informed decisions that drive success in Dubai's dynamic real estate market.</p>
        </div>
        <div class="row">
            <div class="col-lg-4">
                <div class="rg-buy-rent-sell-card text-center position-relative rg-mt-50">
                    ...
                    <h2 class="rg-fs-18 rg-fw-500 text-black rg-mt-30">Qualified Agents</h2>
                    <p class="rg-fs-14 rg-fw-400 rg-text-gray-600 rg-mt-12">With deep-rooted expertise in the local real estate market, our seasoned agents offer invaluable insights, ensuring you discover your ideal property at the perfect price.</p>
            ...
            <div class="col-lg-4">
                <div class="rg-buy-rent-sell-card text-center position-relative rg-mt-50">
                    ...
                    <h2 class="rg-fs-18 rg-fw-500 text-black rg-mt-30">Excellent service</h2>
                    <p class="rg-fs-14 rg-fw-400 rg-text-gray-600 rg-mt-12">We set the bar high with our remarkable customer service, consistently surpassing expectations to fulfill our clients' requirements and aspirations.</p>
                    <!--<a href="#" class="btn btn-outline-secondary rg-mt-25">Learn More</a>-->
                </div>
            </div>
            <div class="col-lg-4">
                <div class="rg-buy-rent-sell-card text-center position-relative rg-mt-50">
                    ...
                    <h2 class="rg-fs-18 rg-fw-500 text-black rg-mt-30">Customer Care</h2>
                    <p class="rg-fs-14 rg-fw-400 rg-text-gray-600 rg-mt-12">Our adept team comprehends the significance of attentive listening and personalized care. Count on us to cater to your distinct needs and preferences with unwavering dedication.</p>
                    <!--<a href="#" class="btn btn-outline-secondary rg-mt-25">Learn More</a>-->
                </div>
            </div>
        </div>
            ...
            <div class="row align-items-center g-0">
                <div class="col-md-6">
                    <div class="rg-selling-meta rg-section-meta">
                        <h2 class="rg-fs-30 rg-sm-fs-24 rg-fw-500 rg-text-dark">Seeking the Right Agency for Your Property?</h2>
                        <p class="rg-fs-18 rg-sm-fs-14 rg-fw-300 rg-text-gray-600 mt-4">Unlock the possibilities of selling, buying and leasing your property with us. Our expert team is ready to guide you through a seamless process, ensuring you achieve the best value for your investment.</p>
