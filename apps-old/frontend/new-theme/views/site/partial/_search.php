        ...
        <div class="container">
            <ul class="rg-hero-stats w-100 position-absolute z-1 d-flex flex-row flex-xl-column justify-content-between justify-content-xl-center text-white">
                <li class="d-flex flex-column flex-xl-row">
                    ...
                    <div class="rg-text rg-fs-14 rg-fw-500 text-center">Active <br> Listings</div>
                </li>
                <li class="d-flex flex-column flex-xl-row">
                    <div class="rg-counter rg-fs-26 rg-fw-700" data-stop="900+">900+</div>
                    <div class="rg-text rg-fs-14 rg-fw-500 text-center">Happy <br> Clients</div>
                </li>
                <li class="d-flex flex-column flex-xl-row">
                    <div class="rg-counter rg-fs-26 rg-fw-700" data-stop="18+">18+</div>
                    <div class="rg-text rg-fs-14 rg-fw-500 text-center">Years of <br> Industry Experience</div>
                </li>
            </ul>
            <div class="rg-hero-content position-relative w-100 z-1 mx-auto">
                <h2 class="rg-fs-55 rg-fw-700 text-white text-center text-capitalize mx-auto">Think Investments Think RGEstate</h2>
                <p class="rg-fs-18 rg-fw-500 rg-text-gray-300 mx-auto text-center mt-2">Experience future investments with RGEstate, your UAE trusted partner. Our visionary approach to real estate leads to unmatched gains.</p>
                <ul class="rg-home-btn-group d-flex align-items-center justify-content-center flex-wrap">
                    <li>
                        <a href="javascript::void(0)" class="btn btn-secondary rg-active">Property</a>
                    </li>
                    <li>
                        <a href="<?php echo Yii::app()->createUrl('new-development'); ?>" class="btn btn-secondary">New Project</a>
                    </li>
                    <li>
                        <a href="<?php echo Yii::app()->createUrl('business-for-sale'); ?>" class="btn btn-secondary">Business For Sale</a>
                    </li>
                    <li>
                        <a href="<?php echo Yii::app()->createUrl('preleased'); ?>" class="btn btn-secondary">Preleased</a>
                    </li>
                </ul>
                <div class="rg-hero-form rg-br-20 rg-mt-25" style="display:none">
                    <div class="d-flex align-items-center justify-content-center button-container mb-0 mb-md-4 mb-lg-5">
                        <button id="commercial" class="rounded-5 px-4 py-3 text-white active">Commercial</button>
                        <button id="residential" class="rounded-5 px-4 py-3 text-white" >Residential</button>
                    </div>
                    <form onsubmit="createSearchUrl(event,this);" id="rg-search-form">
                        <div class="row">
                                    ...
                                    <div class="col-lg-3 col-md-3 mt-4 mt-md-3 mt-lg-0">
                                        <select id="property_purpose" name="purpose" data-placeholder="Purpose" class="search-select-2">
                                            <option></option>
                                    ...
                                    <div class="col-lg-5 col-md-5 mt-4 mt-md-3 mt-lg-0">
                                        <select id="rg_where" class="search-select-2" name="state[]" multiple data-placeholder="Locations">
                                            <option></option>
                                        <?php
                                ...
                                <div class="col-lg-4 col-md-4 mt-4 mt-md-3 mt-lg-0 d-none" id="red-type">
                                    ...
                                    <div class="col-lg-3 col-md-3 mt-4 mt-md-3" id="minsqft-container">
                                        ...
                                        <select id="mobile-minsqft" class="search-select-2" data-placeholder="<?php echo $this->tag->getTag('property_type','Min');?>(<?php echo AREANAME;?>)">
                                            <option></option>
                                            <?php
                                    ...
                                    <div class="col-lg-3 col-md-3 mt-4 mt-md-3" id="maxsqft-container">
                                        <select  id="mobile-maxsqft" class="search-select-2" data-placeholder="<?php echo $this->tag->getTag('property_type','Max');?>(<?php echo AREANAME;?>)">
                                            <option></option>
                                            <?php
                                            foreach($area_aray_sec as $k=>$v){ 
                                                echo '<option value="'.$k.'">'.$v.'</option>';
                                    ...
                                    <div class="col-lg-3 col-md-3 mt-4 mt-md-3">
                                        <select id="rg_min_price" class="search-select-2" data-placeholder="<?php echo $this->tag->getTag('property_type','Min Price');?>">
                                            <option></option>
                                    ...
                                    <div class="col-lg-3 col-md-3 mt-4 mt-md-3">
                                        <select id="rg_max_price" class="search-select-2" data-placeholder="<?php echo $this->tag->getTag('property_type','Max Price');?>">
                                            <option></option>
                                            <?php 
