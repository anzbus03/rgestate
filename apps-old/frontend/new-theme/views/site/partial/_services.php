  ...
  <section class="rg-services rg-mt-70 text-center rg-outline-btn">
      <div class="container">
          <div class="rg-section-header mx-auto">
              <h1 class="rg-fs-30 rg-text-blue rg-fw-600 text-capitalize mb-5">Your Trusted Real Estate Agency in Dubai</h1>
              <h3 class="rg-fs-16 rg-text-dark rg-fw-400 text-uppercase">Our Services</h3>
              <!--<h2 class="rg-fs-30 rg-text-blue rg-fw-600 text-capitalize rg-mt-20">our services</h2>-->
              <h4 class="rg-fs-18 text-black rg-fw-500 text-capitalize mt-4">Explore Lucrative Investment Opportunities in Dubai with RGEstate</h4>
              <p class="rg-fs-18 rg-sm-fs-14 rg-text-gray-600 rg-fw-400 mt-2">RGEstate your gateway to unparalleled investment possibilities in the dynamic landscape of Dubai. At RGEstate, we specialize in connecting visionary investors with prime real estate and Investment opportunities that promise exceptional returns.</p>
          </div>
          <ul class="rg-services-slider rg-mt-40">
              <li>
                  <div class="rg-service bg-white rg-br-10">
                      ...
                      <h2 class="rg-fs-18 rg-fw-500 text-black mt-4">Project Funding</h2>
              ...
              <li>
                  <div class="rg-service bg-white rg-br-10">
                      ...
                      <h2 class="rg-fs-18 rg-fw-500 text-black mt-4">Project Contracting</h2>
              ...
              <li>
                  <div class="rg-service bg-white rg-br-10">
                      ...
                      <h2 class="rg-fs-18 rg-fw-500 text-black mt-4">Startup Funding</h2>
              ...
              <li>
                  <div class="rg-service bg-white rg-br-10">
                      ...
                      <h2 class="rg-fs-18 rg-fw-500 text-black mt-4">Project Development</h2>
              ...
              <li>
                  <div class="rg-service bg-white rg-br-10">
                      ...
                      <h2 class="rg-fs-18 rg-fw-500 text-black mt-4">Interior Fitouts</h2>
              ...
              <li>
                  <div class="rg-service bg-white rg-br-10">
                      ...
                      <h2 class="rg-fs-18 rg-fw-500 text-black mt-4">Building Maintenance</h2>
              ...
              <li>
                  <div class="rg-service bg-white rg-br-10">
                      ...
                      <h2 class="rg-fs-18 rg-fw-500 text-black mt-4">Business Buying & Sell</h2>
