  ...
  <section class="rg-blogs">
      <div class="container">
          <div class="rg-section-header text-center mx-auto">
              <h3 class="rg-fs-16 rg-text-dark rg-fw-400 text-uppercase">Blogs</h3>
              <h2 class="rg-fs-30 rg-sm-fs-24 rg-text-blue rg-fw-600 text-capitalize rg-mt-20">
                  <a href="https://www.rgestate.com/blog/">Explore Our Latest Blog Posts</a>
              </h2>
              <p class="rg-fs-18 rg-sm-fs-14 rg-text-gray-600 rg-fw-400 rg-mt-20">Immerse in insightful blog articles exploring real estate's evolution. From investment tips to market trends, it's your source for empowering property decisions. Stay ahead in real estate with our thought-provoking blogs.
              </p>
              <a href="https://www.rgestate.com/blog/" class="btn btn-primary d-inline-flex align-items-center rg-mt-30">Explore Our Blog</a>
          </div>
          <?php if (!empty($latest)) { ?>            
                <div class="row">
