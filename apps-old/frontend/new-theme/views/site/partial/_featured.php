...
<section class="rg-featured">
    <div class="container">
        <div class="rg-section-header text-center mx-auto">
            <h3 class="rg-fs-16 rg-text-dark rg-fw-400 text-uppercase">Latest Listings</h3>
            <h2 class="rg-fs-30 rg-text-blue rg-fw-600 text-capitalize rg-mt-20">Our Latest Properties For Sale And Rent in UAE</h2>
            <p class="rg-fs-18 rg-sm-fs-14 rg-text-gray-600 rg-fw-400 rg-mt-20">Explore our new properties available for sale and rent in the UAE. From lucrative investment opportunities to comfortable living spaces, find your next venture or investment opportunity in our carefully curated listings.</p>
        </div>
