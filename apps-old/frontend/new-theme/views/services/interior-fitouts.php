                    ...
                    <div class="rg-breadcrumb mt-4">
                        <nav>
                            <ol class="breadcrumb rg-fs-16 rg-fw-400 mb-0">
                                ...
                                <li class="breadcrumb-item active"> <?php echo $this->tag->getTag('interior_fitout', 'Interior Fitouts'); ?> </li>
                            </ol>
                        </nav>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-7">
                    ...
                    <p class="rg-fs-18 rg-fw-400 rg-text-gray-800">
                        <?php echo $this->tag->getTag('interior_seeking','Whether you\'re seeking to enhance your commercial, industrial, or interior spaces, we have the expertise to cater to your unique requirements. Our services are designed to optimize your space\'s functionality while elevating its aesthetic appeal.');?>
                ...
                <div class="col-lg-6">
                    <div class="rg-we-partner-left">
                        ...
                        <p class="rg-fs-18 tp-bg-gray-600 rg-mt-20">
                            <?php echo $this->tag->getTag('interior_wrold_leading','As a world-leading company, we continuously push the
