        ...
        <div class="container">
            <div class="rg-page-header-bg rg-building-maintenance position-relative overflow-hidden">
                <div class="rg-page-header-content position-relative d-flex flex-column justify-content-center z-1">
                    <h1 class="rg-fs-40 rg-fw-600 text-white"><?php echo $this->tag->getTag('building_maitenance_dubai', 'Building Maintenance in Dubai'); ?></h1>
        ...
        <div class="container">
            <div
                ...
                <div class="position-relative z-1">
                    <h2 class="rg-fs-28 rg-fw-700 text-white mx-auto text-center">Transform Your Property's Future with RGEstate's Building Maintenance Services</h2>
                    <p class="rg-fs-16 rg-sm-fs-14 rg-fw-400 text-white text-center mt-3">Schedule a Consultation for Personalized Maintenance Solutions</p>
                    <ul
