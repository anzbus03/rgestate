...
if ($viewCollection->renderContent) {
    ...
    if ($collection->renderForm) {
        ...
        ?>
        <div class="box box-primary margin-top-50">
     ...
     text-align: center !important; 
                    ...
                    <div id="header_title" class="span12 text-center">
							...
							<h3 class="pre-select-cat">Thanks for listing your   property on <?php echo $this->app->options->get('system.common.site_name');?> . <br /> After administrator valiadation , your listing  will active on main website. </h3>
							<?php } ?> 
