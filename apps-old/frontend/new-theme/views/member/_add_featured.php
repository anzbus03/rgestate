...
<?php
if(!$success){ ?> 
<div class="accounb-dic-details-head" style="font-size:18px;font-weight:normal"><?php echo $this->tag->getTag('subscribe_package','Subscribe Package');?></div>
...
<?php }
	...
	?>
<div class="accounb-dic-details-price"><a class="toppcls" href="javascript;void(0)"><?php echo $this->tag->getTag('successfully_marked_as_feature','Successfully marked as featured.');?></a></div>
