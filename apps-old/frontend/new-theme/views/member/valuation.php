         ...
         <div class="box-header">
            <div class="pull-left">
                <h3 class="pageHeading">
                    <?php echo $this->tag->getTag('property_valuation_-_request','Property Valuation - Request');?>       
        ...
        <div class="box-body padding-bottom-50">
            ...
            <?php 
              ...
              $this->widget('zii.widgets.grid.CGridView', $hooks->applyFilters('grid_view_properties', array(
                    ...
                    'itemsCssClass'     => 'table table-bordered table-striped border mb-0 align-items-center',
                    'selectableRows'    => 0,
                     'summaryText' => '',
