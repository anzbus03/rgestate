      ...
      <div class="container">
          <div class="rg-news-bg rg-br-10 position-relative overflow-hidden">
              <div class="row align-items-center position-relative">
                  <div class="col-lg-7">
                      <h2 class="rg-fs-32 rg-sm-fs-24 rg-fw-700 text-white">Stay Informed with Our Newsletters</h2>
                      <p class="rg-fs-16 rg-sm-fs-14 rg-fw-400 text-white mt-3">Explore our informative newsletters to stay updated on the latest developments in the real estate industry. From market trends to investment opportunities and insights, our newsletters are your key to making informed decisions.</p>
                  </div>
                  <div class="col-lg-5">
                      <form action="" class="rg-subscribe d-flex justify-content-start justify-content-sm-end w-100">
                          <div class="form-group position-relative w-100 d-flex align-items-center">
                              ...
                              <button id="subscribe_modal" data-toggle="modal" data-target="#exampleModal" type="button" class="btn">Subscribe Now!</button>
                          </div>
                      </form>
                  </div>
              </div>
