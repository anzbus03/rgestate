<form method="get" action ="<?php echo Yii::App()->createUrl('listing/index/sec/property-for-rent');?>" id="for_sale">
                        <div class="row no-gutters" data-select2-id="13">
                           ...
                           <div class="col-md-2" data-select2-id="12">
                              <div class="input-group" data-select2-id="11">
                                 ...
                                 <?php echo  CHtml::dropDownList('locations','',$city_array ,array( 'class'=>'form-control dynamicCities  no-radius select2-hidden-accessible','empty'=>'Locations','multiple'=>"multiple")); ?> 
                              </div>
                           </div>
                           <div class="col-md-2 home-home-type miniHidden" data-select2-id="73">
