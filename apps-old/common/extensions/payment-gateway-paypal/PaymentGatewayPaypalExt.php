...
class PaymentGatewayPaypalExt extends ExtensionInit 
{
    ...
    public $allowedApps = array('customer', 'backend','frontend');
    ...
    public function run()
    {
        ...
        elseif ($this->isAppName('frontend') && $this->getOption('status', 'disabled') == 'enabled') {
    ...
    protected function backendApp()
    {
        ...
        protected function frontendApp()
    {
        $hooks = Yii::app()->hooks;
        ...
        Yii::app()->controllerMap['payment_gateway_ext_paypal_customer'] = array(
