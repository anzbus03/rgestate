...
class ListingUserAutoLoginToken extends ActiveRecord
{
    /**
    ...
    {
        return '{{booking_user_auto_login_token}}';
    }
    ...
    public function relations()
    {
        ...
        $relations = array(
            'User' => array(self::BELONGS_TO, 'BookingUsers', 'user_id'),
        );
