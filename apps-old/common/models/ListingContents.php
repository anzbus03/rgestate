...
class ListingContents extends ActiveRecord
{
  ...
  public function getPrimaryField(){
    ...
    public function rules()
    {
        $rules = array(
            ...
            array('page_title,meta_title,meta_keywords,meta_description,f_type,p_type',  'safe'),
 ...
 public function beforeSave(){
     ...
     */
     public function getp_typeName(){
      ...
      public function getsectionArray(){
         return array('1'=>'for Sale','2'=>'to Rent','6'=>'Business'); 
     }
   ...
   public function validateUid($attribute,$params){
    ...
    public function getListingContent($section=null,$category=null,$city=null){
