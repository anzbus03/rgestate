...
public function beforeSave(){
    ...
    public function relations()
    {
		...
		{
			$condition = array(self::STAT, 'PlaceAnAd', 'category_id','condition'=>"t.isTrand ls.section_id = 1ash='0' and t.status='A' and t.country=:con",  'params'=>array(':con'=>Yii::app()->request->cookies['country']));
