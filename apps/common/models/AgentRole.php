 ...
 */
class AgentRole extends  ActiveRecord
{
    /**
    ...
    public function rules()
    {
        ...
        return array(
            ...
            array('service_id, service_name, status, isTrash', 'safe', 'on'=>'search'),
        );
    }
    ...
    public function search()
    {
        ...
        $criteria->order = 't.service_id desc';
	...
	public function listData()
    {
		 ...
		 $criteria->order="-t.priority desc , t.service_name asc";
