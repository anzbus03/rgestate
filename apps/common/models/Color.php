...
/**
 * This is the model class for table "mw_color".
 *
 * The followings are the available columns in table 'mw_color':
...
class Color extends ActiveRecord
{
    ...
    public function rules()
    {
        ...
        return array(
            ...
            array('color_id, color_name, status, isTrash, priority', 'safe', 'on'=>'search'),
        );
    }
    ...
    public function search()
    {
        ...
        $criteria->compare('color_name',$this->color_name);
      	...
      	public function  listData()
    {
		 $criteria=new CDbCriteria;
		  ...
		  $criteria->order = "color_id='15' asc, color_name";
