...
class Article extends ActiveRecord
{
    ...
    public function rules()
    {
        $rules = array(
            ...
            array('featured_image', 'file', 'types' => 'jpg, jpeg, png, gif', 'allowEmpty' => true, 'on' => 'insert, update'),
            array('featured_image', 'safe'),
            array('tags', 'safe'),
            array('publish_date, publish_time, author_id', 'safe'),
    ...
    {
        $relations = array(
            'author' => array(self::BELONGS_TO, 'BlogAuthors', 'author_id'),
    ...
    public function attributeLabels()
    {
        $labels = array(
            ...
            'featured_image' => Yii::t('articles', 'Featured Image'),
            'tags'          => Yii::t('articles', 'Tags'),
            'publish_date'    => Yii::t('articles', 'Publish Date'),
            'publish_time'    => Yii::t('articles', 'Publish Time'),
            'author_id'       => Yii::t('articles', 'Author'),
        );
