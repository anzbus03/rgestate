...
class States extends ActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('state_id, country_id, state_name, isTrash,parent_id', 'safe', 'on' => 'search'),
		);
	}
