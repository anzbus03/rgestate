...
class PricePlanOrderNote extends ActiveRecord
{
	...
	public function attributeLabels()
	{
		$labels = array(
			...
			'note'       => Yii::t('orders', $this->mTag()->getTag('note','Note')),
			'author'       => Yii::t('orders',$this->mTag()->getTag('author', 'Author')),
		);
    ...
    {
        $placeholders = array(
			'note'       => Yii::t('orders',$this->mTag()->getTag('if_you_have_particular_notes_a', 'If you have particular notes about this order, please type them here...')),
		);
