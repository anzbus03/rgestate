...
class Agencies extends ListingUsers
{
	public function rules()
    {
        ...
        return array(
           ...
           // array('languages_known', 'required' ,"on"=>"agent_insert,agent_update,agent_update1"),
            ...
            array('mul_country_id,mul_state_id,service_offerng,service_offerng_detail', 'safe'),
            ...
            array('user_id, first_name, last_name, address, city, state, country, zip, phone, fax, email, password, isTrash, status,date_added,tag_list2', 'safe', 'on'=>'search'),
        );
    }
