 ...
 */
class HomeInsuraceCompany extends  ActiveRecord
{
    /**
...
public function generateSlug()
    ...
    public function attributeLabels()
    {
        return array(
            'bank_id' => 'Bank',
            'bank_name' => 'Home Insurance Company Name',
...
public function countryOption(){
    ...
    {	
		 ...
		 $criteria=new CDbCriteria;
		 $criteria->condition = "t.is_trash='0' and status='A'  and f_type= 'HI' ";
