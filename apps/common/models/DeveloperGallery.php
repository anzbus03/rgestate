 ...
 */
class DeveloperGallery extends ActiveRecord
{
    /**
    ...
    public function rules()
    {
        ...
        return array(
            ...
            array('link_url,title,user_id', 'required' ),
   ...
   public $country_name;
   public function fetchGallery($user_id=null,$limit=20)
    { 
        ...
        $criteria->compare('f_type','DB');
        $criteria->order="-t.priority desc,t.banner_id desc ";
 ...
 public function imgDefault()
    {
		...
		if(defined('DISABLE_WEBP') or Yii::App()->isAppName('backend')){
		 ...
		 $ref->resize($src,'uploads/mobile_images',896,91,$file_format,FALSE);
