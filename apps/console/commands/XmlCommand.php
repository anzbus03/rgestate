...
class XmlCommand  extends CConsoleCommand 
{
   ...
   public  $default_user; 
    ...
    public function actionIndex($url=null)
    {
		...
		$xmlfile = $this->file_get_contents_curl($url);
print_r($xmlfile);exit; 
        ...
        echo 'Total Added : '.$total_added;echo '<br />';
        echo 'Total No Action : '.$total_no_action;echo '<br />';
         echo 'Total Updated : '.$total_updated;echo '<br />';
         exit; 
