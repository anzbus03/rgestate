...
class Customer_tagController  extends Controller
{
     ...
     */
     public $Controlloler_title= "Agents / Agencies /  Developer   Tag";
     public $focus = "tag_name";
    ...
    public function actionIndex()
    {
         ...
         if($request->isPostRequest) {
                ...
                $sortOrderAll = $_POST['c_priority'];
				if(count($sortOrderAll)>0)
				{
					foreach($sortOrderAll as $menuId=>$sortOrder)
					{
						$model->isNewRecord =true; 
						$model->updateByPk($menuId,array('c_priority'=>$sortOrder)); 
					}
				}
    ...
    public function actionUpdate($id)
    {
        ...
        $model = CustomerTag::model()->findByPk((int)$id);
