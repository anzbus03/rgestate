...
class Valuation_companyController    extends Controller
{
     ...
     */
     public $Controlloler_title= "Valuation company";
     public $focus = "bank_name";
    ...
    public function actionIndex()
    {
         ...
         $model = new ValuationCompany('serach');
    ...
    public function actionCreate()
    {
        $request = Yii::app()->request;
        $notify = Yii::app()->notify;
        $model = new ValuationCompany();
        if ($request->isPostRequest && ($attributes = (array)$request->getPost($model->modelName, array()))) {
            $model->attributes = $attributes;
            if (isset(Yii::app()->params['POST'][$model->modelName]['terms'])) {
                $model->terms = Yii::app()->ioFilter->purify(Yii::app()->params['POST'][$model->modelName]['terms']);
            }
    ...
    public function actionUpdate($id)
    {
        ...
        $model = ValuationCompany::model()->findByPk((int)$id);
