...
class AvatarController extends Controller
{
     ...
     */
     public $Controlloler_title= "Avatar";
     public $focus = "avatar_name";
     public function init()
    {
    
		$this->getData('pageScripts')->add(array('src' => AssetsUrl::js('imageuploadpreview.js')));
        parent::init();
    ...
    public function actionCreate()
    {
        ...
        if ($request->isPostRequest && ($attributes = (array)$request->getPost($model->modelName, array()))) {
			...
			$uploadedFile = CUploadedFile::getInstance($model, 'avatar_name');
			 
            $fileName =  rand(0,9999).'_'.time()."-{$uploadedFile}";
    ...
    public function actionUpdate($id)
    {
        ...
        $model = Avatar::model()->findByPk((int)$id);
