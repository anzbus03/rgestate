...
class Banner_positionController extends Controller
{
     ...
     */
     public $Controlloler_title= "Banner Position";
    ...
    public function actionIndex()
    {
         ...
         $model = new BannerPosition('serach');
    ...
    public function actionUpdate($id)
    {
        ...
        $model = BannerPosition::model()->findByPk((int)$id);
