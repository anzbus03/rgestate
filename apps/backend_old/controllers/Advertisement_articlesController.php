...
class Advertisement_articlesController extends Controller
{
    ...
    public function actionIndex()
    {
        ...
        $article = new AdvertisementArticle('search');
        ...
        $this->setData(array(
            'pageMetaTitle'     => $this->data->pageMetaTitle . ' | '. Yii::t('articles', 'View adv articles'), 
            'pageHeading'       => Yii::t('articles', 'View adv articles'),
            'pageBreadcrumbs'   => array(
                Yii::t('articles', 'adv articles') => $this->createUrl($this->id.'/index'),
                Yii::t('app', 'View all')
            )
        ));
    ...
    public function actionCreate()
    {
        ...
        $article    = new AdvertisementArticle();
        ...
        $this->setData(array(
            'pageMetaTitle'     => $this->data->pageMetaTitle . ' | '. Yii::t('articles', 'Create new adv article'), 
            'pageHeading'       => Yii::t('articles', 'Create new adv article'),
            'pageBreadcrumbs'   => array(
                Yii::t('articles', 'adv article') => $this->createUrl($this->id.'/index'),
    ...
    {
        $article = AdvertisementArticle::model()->findByPk((int)$id);
        ...
        $this->setData(array(
            ...
            'pageHeading'       => Yii::t('articles', 'Update adv articles'),
            'pageBreadcrumbs'   => array(
                Yii::t('articles', 'adv articles') => $this->createUrl($this->id.'/index'),
                Yii::t('app', 'Update'),
            )
