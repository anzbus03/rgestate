...
class Adv_categoriesController extends Controller
{
    ...
    public function actionIndex()
    {
        ...
        $category   = new AdvCategory('search');
        ...
        $this->setData(array(
            ...
            'pageBreadcrumbs'   => array(
                ...
                Yii::t('articles', 'Categories')    => $this->createUrl('adv_categories/index'),
                Yii::t('app', 'View all'),
            )
        ));
    ...
    public function actionCreate()
    {
        ...
        if ($request->isPostRequest && ($attributes = (array)$request->getPost($category->modelName, array()))) {
            ...
            if ($collection->success) {
                $this->redirect(array('adv_categories/index'));
            }
        }
        ...
        $this->setData(array(
            ...
            'pageBreadcrumbs'   => array(
                Yii::t('articles', 'Articles')      => $this->createUrl('article/index'),
                Yii::t('articles', 'Categories')    => $this->createUrl('adv_categories/index'),
    ...
    {
        $category = AdvCategory::model()->findByPk((int)$id);
