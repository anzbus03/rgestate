...
class Agent_roleController  extends Controller
{
     ...
     */
     public $Controlloler_title= "Agent Designation";
    ...
    public function actionUpdate($id)
    {
        ...
        $model = AgentRole::model()->findByPk((int)$id);
