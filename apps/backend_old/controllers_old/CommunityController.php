...
class CommunityController extends Controller
{
     ...
     */
     public $Controlloler_title= "Community Manager";
     public $focus = "community_name";
    ...
    public function actionUpdate($id)
    {
        ...
        $model = Community::model()->findByAttributes(array('community_id'=>(int)$id));
