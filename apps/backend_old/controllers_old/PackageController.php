...
class PackageController extends Controller
{
     ...
     */
     public $Controlloler_title= "Package";
     public $focus = "color_name";
     ...
     */
     public function actionAutocomplete($term,$offer=0)
    {  
        ...
        $criteria->select = 't.*';
        $criteria->compare('package_name', $term, true);
        if(!empty($offer)){
			$criteria->compare('p_type', '2');
		}
        $criteria->limit = 30;
        ...
        foreach ($models as $model) {
            $results[] = array(
                'plan_id' => $model->package_id,
                'value'   => $model->packageTitle ,
            );
        }
  ...
  /*
    public function actionAutocomplete($term)
    {
        ...
        $criteria = new CDbCriteria();
        $criteria->select = 'package_id, package_name';
        $criteria->compare('package_name', $term, true);
        $criteria->limit = 10;
