...
class Developer_galleryController extends Controller
{
     ...
     */
     public $Controlloler_title= "Developer Gallery";
    ...
    public function actionIndex()
    {
         ...
         $model = new DeveloperGallery('serach');
        ...
        if(Yii::app()->request->getQuery('user_id','') != ''){ $model->user_id = Yii::app()->request->getQuery('user_id','');  } 
    ...
    public function actionUpdate($id)
    {
        ...
        $model = DeveloperGallery::model()->findByPk((int)$id); 
    ...
    public function _setupEditorOptions(CEvent $event)
    {
      ...
      public function fileUploadDropzoneBanner(){
			...
			$file =  $_FILES['DeveloperGallery']['name']['image'];
			//$file =  $_FILES['Banner']['name']['image'];
			$file_orginal = $_FILES['DeveloperGallery']['tmp_name']['image'];
			...
			$out = $ref->resize($file_orginal,$path,869,100,$file_format,TRUE);
