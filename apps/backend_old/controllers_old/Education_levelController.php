...
class Education_levelController extends Controller
{
     ...
     */
     public $Controlloler_title= "Education level";
     public $focus = "education_name";
    ...
    public function actionIndex()
    {
         ...
         $model = new EducationLevel('serach');
    ...
    public function actionUpdate($id)
    {
        ...
        $model = EducationLevel::model()->findByPk((int)$id);
