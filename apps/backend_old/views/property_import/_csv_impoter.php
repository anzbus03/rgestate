          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                $form = $this->beginWidget('CActiveForm', array(
                    ...
                    'action'        => Yii::app()->createUrl('property_import/csv_import',array('type'=>$type)),
                ...
                <div class="form-group">
                    ...
                    <?php echo $form->labelEx($importCsv, 'download_images');?>

                    <?php echo $form->checkbox($importCsv, 'download_images', $importCsv->getHtmlOptions('download_images',array('class'=>'form-control','style'=>'width:auto;'))); ?>

                    <?php echo $form->error($importCsv, 'download_images');?>
