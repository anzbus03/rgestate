<script>
var ad_picker_url_base = '<?php echo Yii::app()->createUrl('advertisement/select_ad/ad_section');?>';
var ad_picker_url = '<?php echo Yii::app()->createUrl('advertisement/select_ad/ad_section/A');?>';
var deleteurl = '<?php echo Yii::app()->createUrl('advertisement/delete_items/layout_id/'.$model->primaryKey);?>';
var refreUrl = '<?php echo Yii::app()->createUrl('advertisement/add_values/id/'.$model->primaryKey);?>';
var saveHeadUrl = '<?php echo Yii::app()->createUrl('advertisement/save_heads/id/'.$model->primaryKey);?>';
</script>
<style>
...
<div id="myModal" class="modal fade" role="dialog">
  <div class="modal-dialog">
    ...
    <!-- Modal content-->
		...
		'action'=>Yii::app()->createUrl('advertisement/validate_ad'),
		...
		ajaxSubmitHappen3(form, data, hasError,"'.Yii::app()->createUrl('advertisement/save_ad').'"); 
		}
		}',
		),
