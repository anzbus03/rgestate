...
if ($viewCollection->renderContent) { ?>
    <div class="box box-primary">
        ...
        <div class="box-body">
            ...
            'type'=>'raw',
             'filter'=>false,
            'value'=>'CHtml::textField("priority[$data->color_id]",$data->priority,array("style"=>"width:50px;text-align:center","class"=>"form-controll"))',
                        ...
                        array(
                            ...
                            'buttons'   => array(
                                'update' => array(
                                    ...
                                    'url'       => 'Yii::app()->createUrl("'.Yii::app()->controller->id.'/update", array("id" => $data->color_id))',
                                    'imageUrl'  => null,
                                    'options'   => array('title' => Yii::t('app', 'Update'), 'class' => ''),
                                ),
                                'delete' => array(
                                    'label'     => ' &nbsp; <span class="fa fa-trash"></span> &nbsp; ', 
                                    'url'       => 'Yii::app()->createUrl("'.Yii::app()->controller->id.'/delete", array("id" => $data->color_id))',
                                    'imageUrl'  => null,
