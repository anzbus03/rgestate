...
if ($viewCollection->renderContent) { ?>
    <div class="box box-primary">
        <div class="box-header">
            <div class="pull-left">
                <h3 class="box-title">
                    <span class="glyphicon glyphicon-star"></span> <?php echo Yii::t(Yii::app()->controller->id, "Developer Gallery  List");?>
                </h3>
            </div>
                ...
                $this->widget('zii.widgets.grid.CGridView', $hooks->applyFilters('grid_view_properties', array(
                    ...
                    'columns' => $hooks->applyFilters('grid_view_columns', array(
                          ...
                          array(
                            ...
                            'filter'=>CHtml::listData(ListingUsers::model()->DeveloperData(),'user_id','company_name'),
                        ),
                          array(
                            'name'  => 'title',
                            'value' => '@$data->LinkUrl' ,
