								         ...
								         echo "<div class='property_img_box1'>";
				                             	...
				                             	?>
				                             		<div id="property_img_1" class="property_imgdivborder_approve" >
														 <?php echo Yii::app()->easyImage->thumbOf(Yii::app()->basePath . '/../../uploads/developer/'.$data->logo,
															array(
                        ...
                        array(
                            ...
                            'buttons'   => array(
                                'update' => array(
                                    ...
                                    'url'       => 'Yii::app()->createUrl("'.Yii::app()->controller->id.'/update", array("id" => $data->developer_id))',
                                    'imageUrl'  => null,
                                    'options'   => array('title' => Yii::t('app', 'Update'), 'class' => ''),
                                ),
                                'delete' => array(
                                    'label'     => ' &nbsp; <span class="fa fa-trash"></span> &nbsp; ', 
                                    'url'       => 'Yii::app()->createUrl("'.Yii::app()->controller->id.'/delete", array("id" => $data->developer_id))',
                                    'imageUrl'  => null,
