                        ...
                        array(
                            ...
                            'buttons'   => array(
                                ...
                                'update' => array(
                                    ...
                                    'url'       => 'Yii::app()->createUrl("advertisement_articles/update", array("id" => $data->article_id))',
                                    'imageUrl'  => null,
                                    'options'   => array('title' => Yii::t('app', 'Update'), 'class' => ''),
                                ),
                                'delete' => array(
                                    'label'     => ' &nbsp; <span class="glyphicon glyphicon-remove-circle"></span> &nbsp; ', 
                                    'url'       => 'Yii::app()->createUrl("advertisement_articles/delete", array("id" => $data->article_id))',
                                    'imageUrl'  => null,
