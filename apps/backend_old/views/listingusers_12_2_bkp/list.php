        ...
        <div class="box-header">
         ...
         <?php } ?> 
            ...
            if( AccessHelper::hasRouteAccess(Yii::app()->controller->id."/update_cache") ){ ?>
                            <?php echo CHtml::link(Yii::t('app', 'Update Featured cache'), Yii::app()->createUrl($this->id.'/update_cache'), array('class' => 'btn btn-primary btn-xs', 'title' => Yii::t('app', 'cache')));?>
 <?php } ?> 
        ...
        <div class="box-body">
			...
			if($type != 'U'){
			 echo CHtml::checkbox('featured','' ,array('class'=>'form-control','value'=>'Y','uncheckValue'=>'','onchange'=>'setTagThis(this,"featured")','style'=>'width:auto;display:inline;vertical-align: middle;')).'<label for="featured" style="display: inline;display: inline-block;vertical-align: middle;margin-left: 10px;padding-top: 10px;">Featured</label>'; 
	        		 echo ' &nbsp;&nbsp;&nbsp;'.CHtml::checkbox('premium','' ,array('class'=>'form-control','value'=>'1','uncheckValue'=>'','onchange'=>'setTagThis(this,"premium")','style'=>'width:auto;display:inline;vertical-align: middle;')).'<label for="premium" style="display: inline;display: inline-block;vertical-align: middle;margin-left: 10px;padding-top: 10px;">Premium</label>'; 
