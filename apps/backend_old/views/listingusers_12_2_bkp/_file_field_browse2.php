...
if(!empty($model->$fileField)){
 ...
 <div class="<?php echo !empty($model->$fileField) ? 'hidden' : '';?> browse_type row" id="abc_<?php echo $fileField;?>">
				...
				var <?php echo $fileField;?><?php echo $fileField;?> = new Dropzone("div#file_<?php echo $fileField;?>", { url: "<?php echo Yii::app()->createUrl('place_an_ad/upload'); ?>",addRemoveLinks: true, maxFilesize: <?php echo $maxFilesize;?>,resizeWidth : 1920 ,maxFiles:<?php echo $maxFiles;?>,  acceptedFiles: "<?php echo $types;?>",}) //according to your forms action
