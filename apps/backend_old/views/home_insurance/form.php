...
<td colspan="2">Property Details <span class="pull-right">Amount in (<?php echo $currency->code;?>)</span></td>
 ...
 <tr class="odd">
<td  colspan="2"><?php echo $model->getAttributeLabel('property_type');?> : <?php echo @$model->propertyTitle;?><br /><?php echo $model->getAttributeLabel('o_status');?> : <?php echo @$model->o_statusTitle;?><br /> <?php echo $model->getAttributeLabel('c_required');?> : <?php echo @$model->c_requiredTitle;?><br /> <?php echo $model->getAttributeLabel('v_of_content');?> : <?php echo @$model->v_of_contentTitle;?><br /> <?php echo $model->getAttributeLabel('v_of_personal');?> : <?php echo @$model->V_of_personalTitle;?><br /><i class="fa fa-map-marker"></i>  <?php echo @$model->AddressDetails;?><br /> <br /><br /> <br />   </td>
</tr>
<?php } 
else{
	$ad = $model->property;
