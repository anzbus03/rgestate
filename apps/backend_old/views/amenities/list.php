...
if ($viewCollection->renderContent) { ?>
    <div class="box box-primary">
        ...
        <div class="box-body"><div id="google_translate_element" class="pull-right"></div>
            ...
            if ($collection->renderGrid) {
                $this->widget('zii.widgets.grid.CGridView', $hooks->applyFilters('grid_view_properties', array(
                    ...
                    'columns' => $hooks->applyFilters('grid_view_columns', array(
                          ...
                          array(
                            'name'  => 'amenities_name',
                            'value' => '"<span>".$data->AmentiesValid."</span>&nbsp;".$data->getTranslateHtml("amenities_name")',
                            'type'=>'raw'
                        ...
                        array(
                            ...
                            'filter' => CHtml::listData(Master::model()-> listData(2),'master_id','master_name')
            ...
            'type'=>'raw',
             'filter'=>false,
            'value'=>'CHtml::textField("priority[$data->amenities_id]",$data->priority,array("style"=>"width:50px;text-align:center","class"=>"form-controll"))',
                        ...
                        array(
                            ...
                            'buttons'   => array(
                                'update' => array(
                                    ...
                                    'url'       => 'Yii::app()->createUrl("'.Yii::app()->controller->id.'/update", array("id" => $data->amenities_id))',
                                    'imageUrl'  => null,
                                ...
                                'delete' => array(
                                    ...
                                    'url'       => 'Yii::app()->createUrl("'.Yii::app()->controller->id.'/delete", array("id" => $data->amenities_id))',
                                    'imageUrl'  => null,
