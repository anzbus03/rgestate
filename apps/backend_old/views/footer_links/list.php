...
if ($viewCollection->renderContent) { ?>
   <?php echo CHtml::link(Yii::t('app', 'Update Cache'),Yii::app()->createUrl( Yii::app()->controller->id.'/index',array('refresh'=>'1')), array('class' => 'btn btn-success btn-xs', 'title' => Yii::t('app', 'Update Cache')));?>
    ...
    <div class="box box-primary">
        ...
        <div class="box-body"><div id="google_translate_element" class="pull-right"></div>
            ...
            if ($collection->renderGrid) {
                $this->widget('zii.widgets.grid.CGridView', $hooks->applyFilters('grid_view_properties', array(
                    ...
                    'columns' => $hooks->applyFilters('grid_view_columns', array(
                        ...
                        array(
                            'name'  => 'title',
                            'value' => '"<span>".$data->title."</span>&nbsp;".$data->getTranslateHtml("title")',
                            'type'=>'raw'
                        ...
                        array(
                            'name'  => 'master_name',
                             'value' => '"<span>".$data->MasterUrl."</span>"',
            ...
            'type'=>'raw',
             'filter'=>false,
            'value'=>'CHtml::textField("priority[$data->master_id]",$data->priority,array("style"=>"width:50px;text-align:center","class"=>"form-controll"))',
