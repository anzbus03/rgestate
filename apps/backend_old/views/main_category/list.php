    ...
    <div class="box box-primary">
        <div class="box-header">
            ...
            <div class="pull-right">
				...
				<?php // echo CHtml::link(Yii::t('app', '<i class="fa fa-keyboard-o"></i> Polish Bulk Update'), Yii::app()->createUrl($this->id.'/index',array('bulk_update'=>'1','lan'=>'pl')), array('class' => 'btn btn-default btn-flat' , 'title' => Yii::t('app', 'Goole Translate Polish')));?>
            </div>
        ...
        <div class="box-body">
            ...
            if ($collection->renderGrid) {
                $this->widget('zii.widgets.grid.CGridView', $hooks->applyFilters('grid_view_properties', array(
                    'ajaxUrl'           => $this->createUrl($this->route,array('bulk_update'=>Yii::app()->request->getQuery('bulk_update','0'))),
