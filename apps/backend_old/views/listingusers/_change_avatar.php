 ...
 $resize_height = $options->get('system.upload.avatar_resize_height','100');
	...
	$class="hidden";
	if(!empty($user->image)){
	$image_name= ENABLED_AWS_PATH.$user->image ;
	$class="";
	}
...
?>
				...
				<?php
				if(!empty($user->image)){
				echo '<div id="imgd" style="width:210px;height:210px;border:1px solid #eee; margin-top:10px; margin-bottom:10px;"><div style="background-image:url('.$user->AvatarUrl.');background-size:ccontain;background-size: contain;width:200px;height:200px;margin:auto;background-repeat:  no-repeat;background-position: center center;" /></div><div class="clearfix"><!-- --></div></div>';
