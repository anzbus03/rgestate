...
?>
 ...
 <div class="col-sm-6 form-group">
  ...
  <button type="button" onclick="submmitFRm(this)" class="btn btn-info" data-action="<?php echo Yii::app()->createUrl('place_property/export_properties',array('type'=>'xl'));?>" >Export Excel</button>
        ...
        <div class="box-body">
            <div class="row">
                <div class="col-sm-2">
                 ...
                 <div class="col-sm-2">
                     <div class="form-group">
                 <label for="por"> <input type="checkbox" value="1" style="width:auto;height:auto;float:left; margin-right:10px;" class="form-control" id="por"   onchange="setTagThis2(this,'PlaceAnAd_p_o_r')" <?php echo !empty($model->p_o_r) ? 'checked' : '';?>  >Price on Request</label>
                   </div>
                   </div>
                 <div class="col-sm-2">
                     <div class="form-group">
                 ...
                 <label for="verified"> <input type="checkbox" value="1" style="width:auto;height:auto;float:left; margin-right:10px;" class="form-control" id="verified"   onchange="setTagThis2(this,'PlaceAnAd_verified')" <?php echo !empty($model->verified) ? 'checked' : '';?>  >Verified</label>
                     ...
                     <div class="col-sm-2">
                     <div class="form-group">
                 <label for="site1">Scrap From</label>
                 <select onchange="setvalThis(this,'PlaceAnAd_site')" >
                      <option value=""   >Select</option>
                     <option value="P" <?php echo $model->site=='P' ? 'selected="true"' : '';?> >Property Finder</option>
                     <option value="B" <?php echo $model->site=='B' ? 'selected="true"' : '';?> >Bayut</option> 
                 </select>
                   </div>
                   </div>
                       ...
                       $(document).ready(function() {
                        ...
                        $('#exportExcel').click(function(e) {
                            ...
                            if (startDate && endDate) {
                                exportUrl += '?type=unpublished&startDate=' + encodeURIComponent(startDate) + '&endDate=' + encodeURIComponent(endDate);
                            }
                    ...
                    'columns' => $hooks->applyFilters('grid_view_columns', array(
                        ...
                        */
                        ...
                        array(
                            ...
                            'name'  => 'country_name',
                            'value' => '@$data->CountryNameSection2' ,
                            'htmlOptions'=>array("width"=>"100px"),
                            'type'=>'raw',
                        ...
                        array(
                            ...
                            'filter'=>array(''=>'All')+Section::model()->getSection(),
                        ),
                        /*
                        array(
                        ...
                        */
                        ...
                        array(
                            ...
                            'template' => '{featured}{verified}{ban}{app}{image}{update}{delete}  '
                        ),
                    ), $this),
                ), $this)); 
            }
