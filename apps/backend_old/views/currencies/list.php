            ...
            if ($collection->renderGrid) {
                $this->widget('zii.widgets.grid.CGridView', $hooks->applyFilters('grid_view_properties', array(
                    ...
                    'columns' => $hooks->applyFilters('grid_view_columns', array(
                        ...
                        array(
                            'name'  => 'base_rate',
                            'value' => '( strtolower($data->is_default) != strtolower("Yes")) ? CHtml::textField("rate[$data->currency_id]",$data->base_rate,array("style"=>"width:50px;text-align:center","class"=>"form-controll")) : " 1 $data->code" ',
                            'type'	=>'raw',
                            'filter' =>false,
                        ),
                        array(
