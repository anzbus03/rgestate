                ...
                $this->widget('zii.widgets.grid.CGridView', $hooks->applyFilters('grid_view_properties', array(
                    ...
                    'columns' => $hooks->applyFilters('grid_view_columns', array(
                        ...
                        * */
                        ...
                        array(
                            'name'  => 'status',
                            'value' => '($data->getIsActive2())? "Active" : "Inactive"',
                            'filter'=>false,
                        ),
                        array(
                            'class'     => 'CButtonColumn',
                            ...
                            'buttons'   => array(
                                ...
                                'enable'=> array(
                                    ...
                                    'url'       => 'Yii::app()->createUrl("delivery_servers/enables", array("id" => $data->server_id))',
                                    'imageUrl'  => null,
                                    'options'   => array('title' => Yii::t('app', 'Enable'), 'class' => 'enable-server'),
                                    'visible'   => 'AccessHelper::hasRouteAccess("delivery_servers/enables") && $data->getIsDisabled2()',
                                ),
                                'disable'=> array(
                                    'label'     => ' &nbsp; <span class="glyphicon glyphicon-save"></span> &nbsp;', 
                                    'url'       => 'Yii::app()->createUrl("delivery_servers/disables", array("id" => $data->server_id))',
                                    'imageUrl'  => null,
                                    'options'   => array('title' => Yii::t('app', 'Disable'), 'class' => 'disable-server'),
                                    'visible'   => 'AccessHelper::hasRouteAccess("delivery_servers/disables") && $data->getIsActive2()',
                                ),
                                'delete' => array(
                            ...
                            'template' => '{update}  {enable} {disable} {delete}'
                        ),
                    ), $this),
                ), $this)); 
            }
