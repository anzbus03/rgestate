                ...
                $this->widget('zii.widgets.grid.CGridView', $hooks->applyFilters('grid_view_properties', array(
                    ...
                    'columns' => $hooks->applyFilters('grid_view_columns', array(
                        ...
                        array(
                            ...
                            'value' => '@$data->CurrencyTitle' ,
                        ),
                        array(
                            'name'  => 'p_type',
                            'value' => '@$data->PtypeTitle' ,
                            'filter' => $model->p_typePackage() ,
                        ),
                        array(
                            'name'  => 'category',
                            'value' => '@$data->categoryTitle' ,
                            'filter' => $model->castegoryPackage() ,
                        ),
                        array(
                            'name'  => 'validity_in_days',
                            'value' => '@$data->ValidityTitle' ,
                            'filter' => $model->getListingPackageMonthly(),
                        ),
                        array(
                            'name'  => 'status',
                        ...
                        array(
                            ...
                            'buttons'   => array(
                                'update' => array(
                                    ...
                                    'url'       => 'Yii::app()->createUrl("'.Yii::app()->controller->id.'/update", array("id" => $data->package_id))',
                                    'imageUrl'  => null,
                                    'options'   => array('title' => Yii::t('app', 'Update'), 'class' => ''),
                                ),
                                'delete' => array(
                                    'label'     => ' &nbsp; <span class="glyphicon glyphicon-remove-circle"></span> &nbsp; ', 
                                    'url'       => 'Yii::app()->createUrl("'.Yii::app()->controller->id.'/delete", array("id" => $data->package_id))',
                                    'imageUrl'  => null,
