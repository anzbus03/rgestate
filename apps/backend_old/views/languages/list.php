    ...
    <div class="box box-primary">
        <div class="box-header">
            ...
            <div class="pull-right">
                ...
                <?php echo CHtml::link(Yii::t('app', 'Refresh'), array('languages/index'), array('class' => 'btn btn-primary btn-xs', 'title' => Yii::t('app', 'Refresh')));?>
                <?php echo CHtml::link(Yii::t('app', 'Export'), array('languages/export'), array('class' => 'btn btn-aqua btn-xs', 'title' => Yii::t('app', 'Export')));?>
            </div>
            ...
            if ($collection->renderGrid) {
                $this->widget('zii.widgets.grid.CGridView', $hooks->applyFilters('grid_view_properties', array(
                    ...
                    'columns' => $hooks->applyFilters('grid_view_columns', array(
                         array(
                            'name'  => 'name',
                            'value' => '"<span>".$data->name."</span>&nbsp;".$data->getTranslateHtml("name")',
                            'type'=>'raw'
                        ...
                        array(
                            ...
                            'buttons'   => array(
                                ...
                                'delete' => array(
                                    ...
                                    'visible'   => '$data->is_default === Language::TEXT_NO',
                                ),    
                            ),
                            'htmlOptions' => array(
                                'style' => 'width:70px;',
