        ...
        <div class="box box-primary">
            ...
            <div class="box-body">
                ...
                ?>
					...
					'update'=>'#FloorPlan_project_id', //selector to update
					...
					<div class="clearfix"><!-- --></div>        
					<div class="form-group col-lg-6">
						<?php echo $form->labelEx($model, 'floor_plan_name');?>
						<?php echo $form->textField($model, 'floor_plan_name',$model->getHtmlOptions('floor_plan_name')); ?>
						<?php echo $form->error($model, 'floor_plan_name');?>
					</div>   
