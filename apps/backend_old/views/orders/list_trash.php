                    ...
                    'columns' => $hooks->applyFilters('grid_view_columns', array(
                        ...
                        array(
                            ...
                            'buttons'   => array(
                                'restore' => array(
                                    'label'     => ' &nbsp; Restore &nbsp;', 
                                    'url'       => 'Yii::app()->createUrl("orders/restore", array("id" => $data->order_id))',
                                    'imageUrl'  => null,
                                    'options'   => array('title' => Yii::t('app', 'View'), 'class' => '','onclick'=>'restoreItem(this,event)'),
                                     'visible'   => 'AccessHelper::hasRouteAccess("orders/restore")',
                                ...
                                'delete' => array(
                                    ...
                                    'url'       => 'Yii::app()->createUrl("orders/delete_permanent", array("id" => $data->order_id))',
                                    'imageUrl'  => null,
                                    'options'   => array('title' => Yii::t('app', 'Delete'), 'class' => 'delete'),
                                     'visible'   => 'AccessHelper::hasRouteAccess("orders/delete_permanent")',
