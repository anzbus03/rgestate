        ...
        <div class="box box-primary">
            ...
            <div class="box-body">
                ...
                ?>
					...
					<?php $dropdwn =   array_merge( $model->getHtmlOptions('property_id'),array('empty'=>'Select Property ',"style"=>"1")) ;  ?> 
					<?php echo $form->dropDownList($model,'property_id',CHtml::listData(Property::model()->listData(),"id" ,"name"), $dropdwn  ); ?>
					<?php echo $form->error($model, 'property_id');?>
					</div>           
					<div class="clearfix"><!-- --></div>        
					<div class="form-group col-lg-6">
						<?php echo $form->labelEx($model, 'project_name');?>
						<?php echo $form->textField($model, 'project_name',$model->getHtmlOptions('project_name')); ?>
