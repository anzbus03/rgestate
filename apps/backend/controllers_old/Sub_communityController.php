...
class Sub_communityController extends Controller
{
     ...
     */
     public $Controlloler_title= "Sub Community";
     public $focus = "category_id";
    ...
    public function actionCreate()
    {
		...
		$this->getData('pageScripts')->add(array('src' => Yii::app()->apps->getBaseUrl('assets/js/select2script.js')));
        $this->setData(array(
    ...
    public function actionUpdate($id)
    {
        ...
        $model = SubCommunity::model()->findByPk((int)$id);
