...
class MechanicalconditionController extends Controller
{
     ...
     */
     public $Controlloler_title= "Mechanical Condition ";
     public $focus = "mechanicalcondition_name";
    ...
    public function actionIndex()
    {
         ...
         $model = new Mechanicalcondition('serach');
    ...
    public function actionUpdate($id)
    {
        ...
        $model = Mechanicalcondition::model()->findByPk((int)$id);
