...
class Payment_optionController extends Controller
{
     ...
     */
     public $Controlloler_title= "Payment Gateways";
     public $focus = "name";
    ...
    public function actionIndex()
    {
         ...
         $model = new PaymentOption('serach');
    ...
    public function actionUpdate($id)
    {
        ...
        $model = PaymentOption::model()->findByPk((int)$id);
