...
class AdvertisementController extends Controller
{
     ...
     */
     public $Controlloler_title= "Advertisement";
    ...
    public function actionIndex()
    {
         ...
         $model = new AdvertisementLayout('serach');
    ...
    public function actionUpdate($id)
    {
        ...
        $model = AdvertisementLayout::model()->findByPk((int)$id);
