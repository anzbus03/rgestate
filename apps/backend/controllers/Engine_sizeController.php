...
class Engine_sizeController extends Controller
{
     ...
     */
     public $Controlloler_title= "Enigine Size";
     public $focus = "engine_size_name";
    ...
    public function actionUpdate($id)
    {
        ...
        $model = EngineSize::model()->findByPk((int)$id);
