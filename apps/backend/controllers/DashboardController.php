...
class DashboardController extends Controller
{
    ...
    public function actionIndex()
    {
        ...
        $this->render('index', compact('checkVersionUpdate','ads', 'adsBusiness','enquiries', 'preLeasedProperties', 'newProjects','adsRent','usr','limit','pro_enquiry','general_enquiry','pro_enquiry_unread','general_enquiry_unread','agent_enquiry','agent_enquiry_unread'));
    }
