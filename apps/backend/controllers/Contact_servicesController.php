...
class Contact_servicesController extends Controller
{
    ...
    {
        $model = ContactPopup::model()->findByPk((int)$id);
     ...
     public function actionView($id)
    {
		...
		$model = ContactPopup::model()->findByPk($id);
      ...
      public function actionBulk_action()
    {
        ...
        if ($action == ContactUs::BULK_ACTION_DELETE && count($items)) {
            $affected = 0;
            $customerModel = new  ContactPopup();
