                ...
                $this->widget('zii.widgets.grid.CGridView', $hooks->applyFilters('grid_view_properties', array(
                    ...
                    'columns' => $hooks->applyFilters('grid_view_columns', array(
                        array(
                            ...
                            'value' => '@$data->advertising_title' ,
                        ),
                        array(
                            'name'  => 'position_banner',
						...
						'type'=>'raw',
						'filter'=>false,
						'value'=>'CHtml::textField("priority[$data->advertisemen_id]",$data->priority,array("style"=>"width:50px;text-align:center","class"=>"form-controll"))',
                        ...
                        array(
                            ...
                            'buttons'   => array(
                                'add' => array(
                                    ...
                                    'url'       => 'Yii::app()->createUrl("'.Yii::app()->controller->id.'/add_values", array("id" => $data->advertisemen_id))',
                                    'imageUrl'  => null,
                                    'options'   => array('title' => Yii::t('app', 'Add Advertisement'), 'class' => ''),
                                ),
                                'update' => array(
                                    'label'     => ' &nbsp; <span class="fa fa-pencil"></span> &nbsp;', 
                                    'url'       => 'Yii::app()->createUrl("'.Yii::app()->controller->id.'/update", array("id" => $data->advertisemen_id))',
                                    'imageUrl'  => null,
                                    'options'   => array('title' => Yii::t('app', 'Update'), 'class' => ''),
                                ),
                                'delete' => array(
                                    'label'     => ' &nbsp; <span class="fa fa-trash"></span> &nbsp; ', 
                                    'url'       => 'Yii::app()->createUrl("'.Yii::app()->controller->id.'/delete", array("id" => $data->advertisemen_id))',
                                    'imageUrl'  => null,
                                    'options'   => array('title' => Yii::t('app', 'Delete'), 'class' => 'delete'),
                                     'visible'   => '$data->removable === "yes"',
                                ),    
                            ),
                            'htmlOptions' => array(
                                'style' => 'width:100px;',
