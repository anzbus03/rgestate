	<div class="form-group">
			   	...
			   	<?php echo CHtml::activeLabel($model, 'sent_on', array('required' => true )); ?>
			    <div class="clearfix"><!-- --></div>
				<div class="form-group col-lg-6 clsDatePicker"  style="padding-right:15px;padding-left:0px;margin-bottom:0px">
						...
						'htmlOptions'=>$model->getHtmlOptions('datepicker',array('readonly'=>true )),
						));
						?>
						</div>  
				...
				<div class="form-group col-lg-6"  style="padding-left:0px;padding-right:0px;margin-bottom:0px">
						<div class="input-group input-append bootstrap-timepicker">
						<?php echo $form->textField($model, 'timepicker',$model->getHtmlOptions('timepicker',array('readonly'=>true))); ?>
						...
						<?php echo $form->error($model, 'timepicker');?>
								...
								<div class="pull-right">
									<?php echo $form->dropDownList($model, 'email_template',(array) CHtml::listData((array) CustomerEmailTemplate::model()->findAllByPk($model->email_template),'template_id','name'),$model->getHtmlOptions('email_template',array('empty'=>'Select Template ','class'=>'form-control selectTwo','style'=>'width:300px;','onchange'=>'return ChangeContent(this)','data-href'=>Yii::app()->createUrl('ajax/templateData')))); ?>
								</div>
