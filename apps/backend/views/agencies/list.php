...
if ($viewCollection->renderContent) { ?>
    <div class="card">
        <div class="card-header">
            <div class="pull-left">
                <h3 class="card-title">
                    <span class="glyphicon glyphicon-star"></span> <?php echo Yii::t('hotel', 'Agencies List');?>
                </h3>
            </div>
                        ...
                        array(
                            ...
                            'buttons'   => array(
                                'update' => array(
                                    ...
                                    'url'       => 'Yii::app()->createUrl( "Agencies/update", array("id" => $data->user_id))',
                                    'imageUrl'  => null,
                                    'options'   => array('title' => Yii::t('app', 'Update'), 'class' => ''),
                                ),
                                'delete' => array(
                                    'label'     => ' &nbsp; <span class="fa fa-trash"></span> &nbsp; ', 
                                    'url'       => 'Yii::app()->createUrl("Agencies/delete", array("id" => $data->user_id))',
                                    'imageUrl'  => null,
 ...
 function  openUp2(k)
    {
		...
		if(property_id !=undefined){
			...
			$.get('<?php echo Yii::app()->createAbsoluteUrl("place_an_ad/get_tag_list2"); ?>',{id:property_id,listing_type:'C'},function(data){ 
				 var data = JSON.parse(data);
				//  alert(data.enabled)
