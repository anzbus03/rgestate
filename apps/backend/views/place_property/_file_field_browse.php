  <div class="browse_type row" id="abc_<?php echo $fileField;?>">
      ...
      <div class="col-sm-12" style="padding:0px;">
          <h3 class="subHeadh2 padding-bottom-0"> Upload Images <br /><span class="rui-qvKkT1">Hint: File types
                  allowed:<?php echo $types;?>, Maximum filesize : <?php echo $maxFilesize;?>MB </span> </h3>

          <div class="">
              <div class="" style="padding:0px;float: left;width: auto;margin-right: 10px;">
                  <div id="file_<?php echo $fileField;?>" style="width:100% !important;" class="dropzone"
                      title="Click or Drag here to upload photos">
                      <div class="dz-message" data-dz-message>
                          <div class="upload-btn-wrapper">
                              <div class="drop_fil">Drop files here </div>
                              <div><span class="div_od">or</span></div>
                              <div> <button class="btn btn-info" type="button"><i
                                          class="fa fa-camera"></i><?php echo $title_text;?></button></div>
                              <div class="accepted">Accepted File Formats : <b><?php echo $types;?></b></div>
                              <div class="maximum_size">Maximum file size must be less than
                                  <b><?php echo $maxFilesize;?>MB</b> </div>
                          </div>
                      </div>
                  </div>
                  ...
                  <div id="property_img_<?php echo $k;?>" class="property_img">
                      ...
                      <div class="property_img_overlay">
                          ...
                          <a class="btn btn-danger btn-small"
                              onclick="delete_property_image2('<?php echo $v;?>',this);">
...
var <?php echo $fileField;?><?php echo $fileField;?> = new Dropzone("div#file_<?php echo $fileField;?>", {
    url: "<?php echo Yii::app()->createUrl('place_an_ad/upload'); ?>",
    addRemoveLinks: true,
    maxFilesize: <?php echo $maxFilesize;?>,
    maxFiles: <?php echo $maxFiles;?>,
    acceptedFiles: "<?php echo $types;?>",
...
<?php echo $fileField;?><?php echo $fileField;?>.on("success", function(file, serverFileName) {
    ...
    $("#table_append_boc").append(
        '<div id="property_img_0" class="property_img"><img src="<?php echo ENABLED_AWS_PATH ;?>' +
        serverFileName +
        '" style="width:140px;"><div class="property_img_overlay"><span class="isw-delete" style="margin-right: 0px;"></span> <a class="btn btn-danger btn-small" onclick=delete_property_image2("' +
        serverFileName +
        '",this) ><span class="isw-delete2" style="margin-right: 0px;"></span></a></div></div>')
...
.browse_type .drop_fil,
.browse_type .div_od,
.browse_type .accepted,
.browse_type .maximum_size {
    display: none;
}
...
.browse_type .dropzone .dz-preview,
.browse_type .dropzone-previews .dz-preview {
    width: 100px;
    box-shadow: unset !important;
    padding: 0px;
}

.browse_type .dropzone .dz-preview .dz-details,
.browse_type .dropzone-previews .dz-preview .dz-details {
...
.browse_type .dropzone .dz-preview .dz-details img,
.browse_type .dropzone-previews .dz-preview .dz-details img {
    display: none;
}

.browse_type .dropzone .dz-preview .dz-progress,
.browse_type .dropzone-previews .dz-preview .dz-progress {
    top: 30px !important;
    left: 0px !important;
    right: 6px !important;
}
...
.browse_type .dropzone a.dz-remove,
.browse_type .dropzone-previews a.dz-remove {
...
function delete_property_image2(val, k) {
    ...
    $.post("<?php echo  Yii::app()->createUrl($this->id.'/delete_image'); ?>", {
        file: val,
        inp: imgs
    }, function(data) {
        $("#PlaceAnAd_image").val(data);
        imgs = data;
    });
    $(k).parent().parent().remove();
}
