...
if ($viewCollection->renderContent) { ?>
    <div class="box box-primary">
        <div class="box-header">
            <div class="pull-left">
                <h3 class="box-title">
                    <span class="glyphicon glyphicon-user"></span> <?php echo Yii::t('users', 'Users');?>
                </h3>
            </div>
            <div class="pull-right">
               ...
               // echo CHtml::link(Yii::t('app', 'Create new'), array('users/create'), array('class' => 'btn btn-primary btn-xs', 'title' => Yii::t('app', 'Create new')));
                ?>
                <?php echo CHtml::link(Yii::t('app', 'Refresh'), array('users/index'), array('class' => 'btn btn-primary btn-xs', 'title' => Yii::t('app', 'Refresh')));?>
            </div>
                    ...
                    'columns' => $hooks->applyFilters('grid_view_columns', array(
                        ...
                        array(
                         ...
                         array(
                            ...
                            'filter'=> UserGroup::getAllAsOptions(),
                        ),
                        array(
                            'name'  => 'status',
                            'value' => '$data->status',
                        ...
                        array(
                            ...
                            'buttons'   => array(
                                    ...
                                    'url'       => 'Yii::app()->createUrl("users/impersonate", array("id" => $data->user_id))',
                                    'imageUrl'  => null,
                                ...
                                'delete' => array(
                                    ...
                                    'options'   => array('title' => Yii::t('app', 'Delete'), 'class' => 'delete'),
                                      'visible'   => 'AccessHelper::hasRouteAccess("'.Yii::app()->controller->id.'/delete") && $data->removable === User::TEXT_YES',
                                ),    
                            ),
                            'htmlOptions' => array(
                                'style' => 'width:100px;',
