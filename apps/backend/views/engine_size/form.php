        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="form-group col-lg-6">
                    <?php echo $form->labelEx($model, 'engine_size_name');?>
                    <?php echo $form->textField($model, 'engine_size_name',$model->getHtmlOptions('engine_size_name')); ?>
                    <?php echo $form->error($model, 'engine_size_name');?>
                </div>   
