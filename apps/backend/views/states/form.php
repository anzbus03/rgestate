        ...
        <div class="card">
            <div class="card-header">
                ...
                <div class="pull-right">
                    ...
                    <?php echo CHtml::link(Yii::t('app', 'Create new'), array('states/create'), array('class' => 'btn btn-primary btn-xs', 'title' => Yii::t('app', 'Create new')));?>
                    <?php } ?>
                    <?php echo CHtml::link(Yii::t('app', 'Cancel'), array('states/index'), array('class' => 'btn btn-primary btn-xs', 'title' => Yii::t('app', 'Cancel')));?>
                </div>
            ...
            <div class="card-body">
                ...
                <div class="form-group col-lg-6">
                    <?php echo $form->labelEx($user, 'country_id');?>
                     <?php $mer =  array_merge($user->getHtmlOptions('country_code'),array('empty'=>"Select Country")); ?>
                   ...
                   <div class="clearfix"><!-- --></div>
                <div class="form-group col-lg-6">
                    <?php echo $form->labelEx($user, 'state_name');?>
                    <?php echo $form->textField($user, 'state_name', $user->getHtmlOptions('state_name')); ?>
                    <?php echo $form->error($user, 'state_name');?>
                </div>        
                 <div class="clearfix"><!-- --></div>
               <?php
