        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="form-group col-lg-6">
                    <?php echo $form->labelEx($model, 'experience_name');?>
                    <?php echo $form->textField($model, 'experience_name',$model->getHtmlOptions('experience_name')); ?>
                    <?php echo $form->error($model, 'experience_name');?>
                </div>   
