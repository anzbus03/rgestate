        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="form-group col-lg-6">
                    ...
                    <?php echo $form->textField($model, 'section_name',$model->getHtmlOptions('section_name')); ?>
                    <?php echo $form->error($model, 'section_name');?>
                </div>        
                <div class="clearfix"><!-- --></div>
                <div class="form-group col-lg-6">
                    <?php echo $form->labelEx($model, 'disable_frotend');?>
                    <?php echo $form->dropDownList($model, 'disable_frotend',$model->Yeno(),$model->getHtmlOptions('disable_frotend')); ?>
                    <?php echo $form->error($model, 'disable_frotend');?>
                </div>        
