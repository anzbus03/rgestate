                    ...
                    <?php echo $form->error($model, 'i_o');?>
                  	...
                  	<div class="">
									   ...
									   <div class="amn1">
										<div class="amn">
										  <?php
										   $categoris =   CHtml::listData(Category::model()->listData(),'category_id','category_name');
										  
										 
											 	 
											   echo '<div class="col-sm-12 amlabel " style="">';
											       
											      echo '<h4 class="subheading_font row ">Hidden on</h4><div class="clearfix"></div>';
											      foreach( $categoris as $k=>$v){
													
													  echo '<div class="col-sm-4 form-check form-check-flat"><label class="form-check-label"><input class="amnit" value="'.$k.'" id="amenities_'.$k.'" '; echo  in_array($k,(array) $model->amenities_available_for) ? 'checked' : '';  echo ' type="checkbox" name="amenities_available_for[]"  >  '.$v.' <i class="input-helper"></i></label></div>';
												  }
