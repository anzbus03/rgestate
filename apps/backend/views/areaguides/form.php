    ...
    if ($collection->renderForm) {
        ...
        <div class="card">
            ...
            <div class="card-body">
				...
				<div class="form-group col-lg-12">
                    <?php echo $form->labelEx($areaguides, 'neighborhood');?><?php echo $areaguides->getTranslateHtml('neighborhood','ar',false,'1200px');?>
				...
				<div class="form-group col-lg-12">
                    <?php echo $form->labelEx($areaguides, 'lifestyle');?><?php echo $areaguides->getTranslateHtml('lifestyle','ar',false,'1200px');?>
                    <?php echo $form->textArea($areaguides, 'lifestyle', $areaguides->getHtmlOptions('lifestyle', array('rows' => 15))); ?>
                    <?php echo $form->error($areaguides, 'lifestyle');?>
                </div>
				<div class="form-group col-lg-12">
                    <?php echo $form->labelEx($areaguides, 'location_detail');?><?php echo $areaguides->getTranslateHtml('location_detail','ar',false,'1200px');?>
                    <?php echo $form->textArea($areaguides, 'location_detail', $areaguides->getHtmlOptions('location_detail', array('rows' => 15))); ?>
                    <?php echo $form->error($areaguides, 'location_detail');?>
                </div>
				
                <div class="form-group col-lg-12">
                    <?php echo $form->labelEx($areaguides, 'meta_title');?>
                ...
                <div class="form-group col-lg-12">
                    <?php echo $form->labelEx($areaguides, 'meta_description');?>
                ...
                <div class="row">
                    ...
                    <div class="form-group col-lg-6">
                        <?php echo $form->labelEx($areaguides, 'status');?>
                        <?php echo $form->dropDownList($areaguides, 'status', $areaguides->getStatusesArray(), $areaguides->getHtmlOptions('status')); ?>
                        <?php echo $form->error($areaguides, 'status');?>
                    </div>
                </div>
                <div class="clearfix"><!-- --></div>
                <?php 
