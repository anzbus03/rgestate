    ...
    if ($collection->renderForm) {
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="form-group col-lg-8">
                    <?php echo $form->labelEx($model, 'bank_name');?><?php if(!$model->isNewRecord){  echo $model->getTranslateHtml('bank_name');}?>
                    <div class="clearfix"></div>
                ...
                <div class="form-group col-lg-12">
						<?php echo $form->labelEx($model, 'terms');?><?php if(!$model->isNewRecord){  echo $model->getTranslateHtml('terms','ar',false,'1200px'); } ?>
						  <div class="clearfix"></div>
