...
<head>
    ...
    <link
        href="<?php echo Yii::app()->apps->getBaseUrl('assets_backend/vendor/jquery-nice-select/css/nice-select.css'); ?>"
        rel="stylesheet" type="text/css" />
    <link href="<?php echo Yii::app()->apps->getBaseUrl('assets_backend/css/style.css'); ?>" rel="stylesheet"
        type="text/css" />
    <link rel="stylesheet" href="//maxcdn.bootstrapcdn.com/font-awesome/4.5.0/css/font-awesome.min.css">
    <link
        href="<?php echo Yii::app()->apps->getBaseUrl('assets_backend/vendor/datatables/css/jquery.dataTables.min.css'); ?>"
        rel="stylesheet" type="text/css" />
    <link rel="stylesheet" type="text/css" href="https://cdn.jsdelivr.net/npm/daterangepicker/daterangepicker.css" />
    <link href="<?php echo Yii::app()->apps->getBaseUrl('theme'); ?>/assets/lib/select2/css/select2.min.css"
        rel="stylesheet">
    <link href="<?php echo Yii::app()->apps->getBaseUrl('theme'); ?>/assets/lib/slick/slick.css" rel="stylesheet">
    <link href="<?php echo Yii::app()->apps->getBaseUrl('assets_backend/vendor/swiper/css/swiper-bundle.min.css'); ?>"
        rel="stylesheet" type="text/css" />
    <link rel="stylesheet" type="text/css"
        href="<?php echo Yii::app()->apps->getBaseUrl('theme'); ?>/assets/js/build/css/intlTelInput.min.css" />
    <?php
    ...
    html.isOnFram aside.left-side,
    html.isOnFram header {
        display: none
    }

    html.isOnFram aside.right-side {
        width: 100%;
        margin-left: 0
    }

    html.isOnFram textarea.form-control {
        height: 400px
    }

    html.isOnFram .col-sm-5 {
        width: 41.66666667%;
        float: left
    }

    html.isOnFram .col-sm-7 {
        width: 58.33333333%;
        float: left
    }

    html.isOnFram .box-header {
        display: none
    }

    html.isOnFram .box-footer {
        border: 0;
        padding-top: 0;
        position: fixed;
        z-index: 11111;
    ...
    html.isOnFram .col-sm-2 {
        width: 16.66666667%;
        float: left
    }

    html.isOnFram .col-lg-9 {
        width: 75%;
        float: left
    }

    html.isOnFram .col-lg-3 {
        width: 25%;
        float: left
    }

    html.isOnFram .col-sm-6 {
        width: 50%;
        float: left
    }

    html.isOnFram .box-danger .col-sm-2 {
        width: 25%;
        float: left
    }

    html.isOnFram .col-sm-3 {
        width: 25%;
        float: left
    }
    </style>
...
<body>
                ...
                <ul class="metismenu" id="menu">
                    <li class="dropdown header-profile">
                        <a class="nav-link" href="javascript:void(0);" role="button" data-bs-toggle="dropdown">
                            <div
                                style="width: 55px; height: 55px; border-radius: 50%; overflow:hidden; display:flex; align-items:center; justify-content: center;">
                                <img src="<?php echo '/uploads/images/' . Yii::app()->user->getModel()->profile_image; ?>"
                                    alt="Profile image">
                            </div>
                    ...
                    <li>
                        <a class="<?php echo isset($item['items']) ? 'has-arrow' : 'ai-icon'; ?>" aria-expanded="false"
                            href="<?php echo isset($item['route']) ? Yii::app()->createUrl($item['route'][0]) : 'javascript:void(0)'; ?>">
        ...
        <div class="content-body">
            ...
            <div class="container-fluid">
                <section class="content" id="<?php echo $this->id == 'place_property' ? 'place_an_ad' : ''; ?>">
                    ...
                    <script
                        src="<?php echo Yii::app()->apps->getBaseUrl('assets_backend/vendor/jquery-nice-select/js/jquery.nice-select.min.js'); ?>"
                        type="text/javascript"></script>
    ...
    ***********************************-->
    ...
    <script src="<?php echo Yii::app()->apps->getBaseUrl('assets_backend/vendor/chart-js/chart.bundle.min.js'); ?>"
        type="text/javascript"></script>
    <script src="<?php echo Yii::app()->apps->getBaseUrl('assets_backend/vendor/apexchart/apexchart.js'); ?>"
        type="text/javascript"></script>
    <script src="<?php echo Yii::app()->apps->getBaseUrl('assets_backend/vendor/nouislider/nouislider.min.js'); ?>"
        type="text/javascript"></script>
    <script src="<?php echo Yii::app()->apps->getBaseUrl('assets_backend/vendor/wnumb/wNumb.js'); ?>"
        type="text/javascript"></script>
    <script src="<?php echo Yii::app()->apps->getBaseUrl('assets_backend/js/dashboard/dashboard-1.js'); ?>"
        type="text/javascript"></script>
    <script src="<?php echo Yii::app()->apps->getBaseUrl('assets_backend/js/custom.js'); ?>" type="text/javascript">
    </script>
    <script src="<?php echo Yii::app()->apps->getBaseUrl('assets_backend/js/dlabnav-init.js'); ?>"
        type="text/javascript"></script>
    <script src="<?php echo Yii::app()->apps->getBaseUrl('assets_backend/js/demo.js'); ?>" type="text/javascript">
    </script>
    <script src="<?php echo Yii::app()->apps->getBaseUrl('assets_backend/js/styleSwitcher.js'); ?>"
        type="text/javascript"></script>
    <script src="<?php echo Yii::app()->apps->getBaseUrl('assets_backend/js/dashboard/cms.js'); ?>"
        type="text/javascript"></script>
    <script
        src="<?php echo Yii::app()->apps->getBaseUrl('assets_backend/vendor/datatables/js/jquery.dataTables.min.js'); ?>"
        type="text/javascript"></script>
    <script src="<?php echo Yii::app()->apps->getBaseUrl('assets_backend/js/plugins-init/datatables.init.js'); ?>"
        type="text/javascript"></script>

    <script src="<?php echo Yii::app()->apps->getBaseUrl('assets_backend/vendor/swiper/js/swiper-bundle.min.js'); ?>"
        type="text/javascript"></script>
