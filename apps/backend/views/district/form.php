        ...
        <div class="box box-primary">
            ...
            <div class="box-body">
                ...
                <div class="form-group col-lg-6">
                    <?php 
                    if(empty( $model->country_id) and !empty($model->city_id)){
                    ...
                    <?php echo $form->dropDownList($model,'country_id',CHtml::listData(Countries::model()->Countrylist2(),"country_id" ,"country_name"), $dropdwn  ); ?> 
                ...
                <div class="form-group col-lg-6">
                    ...
                    <?php 
                    if(empty( $model->state_id) and !empty($model->city_id)){
						$model->state_id = $model->city->state_id;
					}
                    
                    
                    $dropdwn =   array_merge( $model->getHtmlOptions('state_id'),array('empty'=>'Select State ',"style"=>"1",
                       'ajax' =>
                       array('type'=>'GET',
                       'url'=>$this->createUrl('LoadCities'), //url to call.
                       'update'=>'#'.$model->modelName.'_city_id', //selector to update
                ...
                <div class="form-group col-lg-6">
                    ...
                    <?php $dropdwn =   array_merge( $model->getHtmlOptions('city_id'),array('empty'=>'Select City ',"style"=>"1")) ;  ?> 
                    <?php echo $form->dropDownList($model,'city_id',CHtml::listData(City::model()->FindCities($model->state_id),"city_id" ,"city_name"), $dropdwn  ); ?>
                    <?php echo $form->error($model, 'city_id');?>
                </div>
                <div class="clearfix"><!-- --></div>
                <div class="form-group col-lg-6">
                    <?php echo $form->labelEx($model, 'district_name');?>
                    <?php echo $form->textField($model, 'district_name',$model->getHtmlOptions('district_name')); ?>
