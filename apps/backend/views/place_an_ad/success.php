            ...
            <div class="box-body">
                ...
                <div class="content_place_an_ad">
                    ...
                    <div id="header_title" class="span12">
							...
							<h3 class="pre-select-cat">Thanks for listing  property on <?php echo Yii::app()->options->get('system.common.site_name');?> . <br /> After administrator valiadation , your listing  will active on main website. </h3>
							<?php } ?> 
