    ...
    if ($collection->renderForm) {
        ...
        <div class="card">
            <div class="card-header">
                <h3 class="card-title"><?php echo Yii::t('customer', 'Forgot password?');?></h3>
            </div>
            <div class="card-body">
                <?php 
                /**
            ...
            <div class="box-footer">
                <div class="pull-left">
                    <a href="<?php echo $this->createUrl('guest/index');?>" class="btn btn-default"><?php echo Yii::t('customer', 'Go to login');?></a>
                </div>
