        ...
        <div class="box box-primary">
            ...
            <div class="box-body">
                ...
                $hooks->doAction('before_active_form_fields', new CAttributeCollection(array(
                 ...
                 $fields=  ($model->change_parent_fields=="N") ? CHtml::listData($model->category->relatedFields,'field_name','field_name'):CHtml::listData($model->relatedFields,'field_name','field_name');
                ?>
                 <div id="header">
					<ul>
						...
						<li id="selected"><a href="<?php if($model->sub_category_id) { echo $this->createUrl(Yii::app()->controller->id.'/fields',array("id" => $model->sub_category_id )) ; } else { echo "#"; } ?>">Required Fields</a></li>
						<?php if($model->sub_category_id and in_array("model", $fields))
						{
						?>
                 ...
                 <div class="clearfix"><!-- --></div>
				  <div class="form-group col-lg-6">
                    <?php echo $form->labelEx($model, '<b>Sub Category</b>');?> : 
                 ...
                 <div class="clearfix"><!-- --></div>
                   <div class="form-group col-lg-6">
                    <?php echo $form->labelEx($model, 'change_parent_fields');?> 
                    <?php $dropdwn =   array_merge( $model->getHtmlOptions('change_parent_fields'),array("style"=>"1")) ;  ?> 
                    <?php echo $form->dropDownList($model,'change_parent_fields',$model->YesNoArray(), $dropdwn  ); ?>
                    <?php echo $form->error($model, 'change_parent_fields');?>
                </div>
                 <div class="clearfix"><!-- --></div>
                 <div class="form-group col-lg-6">
					<?php echo $form->labelEx($model, 'fields');?>(In Order to change fields make above as "Yes")
					<div class="container34">
					  <?php
					     
					    $amenties=  $fields;
						echo CHtml::checkBoxList('fields',$amenties , PlaceAnAd::model()->dynamicFields());                                              
						?>
					</div>
