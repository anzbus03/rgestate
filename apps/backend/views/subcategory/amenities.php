                ...
                ?>
                 <div id="header">
					<ul>
						...
						<li  id="selected"><a href="<?php if($model->sub_category_id) { echo $this->createUrl(Yii::app()->controller->id.'/updateAmenities',array("id" => $model->sub_category_id )) ; } else { echo "#"; } ?>">Amenities Details</a></li>
                 ...
                 <div class="form-group col-lg-6">
					...
					<div class="container34">
					  <?php
					   ...
					   $amenties=   CHtml::listData($model->relatedAmenities,'amenities_id','amenities_id');
					     
						echo CHtml::checkBoxList('amenities',$amenties ,CHtml::listData(Amenities::model()->ListDataWithAmenities($model->category_id),'amenities_id','amenities_name'));                                              
						?>
					</div>
