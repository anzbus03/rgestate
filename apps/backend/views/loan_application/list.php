...
<div id="export_generator" class="hide">
            <div style="width:100%;display:block;">
				<form   action="<?php echo Yii::app()->createUrl('loan_application/export');?>">
             <div class="row"  >
...
?>
    ...
    <div class="col-sm-3 form-group">
	   <label for="fr_date">Status</label>
	   <?php echo CHtml::dropDownList('status_m','',  $model->status_array() ,array('class'=>'form-control','empty'=>'All Types'));?>
	  </div>
    ...
    <div class="card">
        <div class="card-header">
            ...
            <div class="pull-right">
                <?php
            if( AccessHelper::hasRouteAccess(Yii::app()->controller->id."/export") ){ ?>
 ...
 <div class="clearfix">
        ...
        <div class="card-body">
			...
			'model'      => $model,
			'formAction' => $this->createUrl('loan_application/bulk_action'),
			));
                ...
                $this->widget('zii.widgets.grid.CGridView', $hooks->applyFilters('grid_view_properties', array(
                    ...
                    'columns' => $hooks->applyFilters('grid_view_columns', array(
                        ...
                        array(
                            'name'  => 'asked_type',
                            'value' => '@$data->askTitle' ,
                            'filter' => array(''=>'All','1'=>'Property','2'=>'General')
                        ),
                        array(
                            'name'  => 'name',
                            'value' => '@$data->name' ,
