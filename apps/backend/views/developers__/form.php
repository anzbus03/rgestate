            ...
            <div class="box-body">
               ...
               <div class="clearfix"><!-- --></div>
					<div class="form-group col-lg-6">
						<?php echo $form->labelEx($model, 'developer_name');?>
						<?php echo $form->textField($model, 'developer_name',$model->getHtmlOptions('developer_name')); ?>
						<?php echo $form->error($model, 'developer_name');?>
					</div>
                <div class="clearfix"><!-- --></div>
                	<div class="form-group col-lg-6">
