            ...
            <div class="clearfix"><!-- --></div>  
                <div class="form-group col-lg-6">
                    ...
                    <?php echo $form->labelEx($model, 'used_in');
                     $ar = CHtml::listData(Section::model()->ListData(),'section_id','section_name');
                    $ar['3'] =  'New Projects';
                    ?>
                    <?php echo $form->dropDownList($model, 'used_in', $ar ,$model->getHtmlOptions('used_in',array('empty'=>'Select','multiple'=>true))); ?>
