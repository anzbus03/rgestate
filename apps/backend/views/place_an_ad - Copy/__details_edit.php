                 ...
                 <div class="form-group col-lg-6">
					...
					<div class="container34">
					  <?php
						 ...
						 {
						    if(isset($model->adAmenities))
						    {
								 $model->amenities =  CHtml::listData($model->adAmenities,'amenities_id','amenities_id');
							}
		    ...
		    ?>  
                ...
                <div class="form-group col-lg-6">
                 ...
                 <div class="form-group col-lg-6">
                    <?php echo $form->labelEx($model, 'state');?>
                      <?php $dropdwn =   array_merge( $model->getHtmlOptions('state'),array('empty'=>'Select regions',"style"=>"1",'class'=>"form-control"));
                ...
                <div class="clearfix"><!-- --></div> 
                 <div class="form-group col-lg-6">
                    ...
                    <?php $mer =  array_merge($model->getHtmlOptions('city'),array('empty'=>"All Cities")); ?>
                    <?php echo $form->dropDownList($model, 'city',  CHtml::listData(City::model()->FindCities($model->state),'city_id','city_name') , $mer ); ?>
...
?>
 ...
 $("#PlaceAnAd_state").change(function(){ 
	 $("#myDiv").addClass("grid-view-loading");
	 $.post("<?= Yii::app()->createUrl("place_an_ad/loadCities")?>",{state:$(this).val()},function(data){ $("#PlaceAnAd_city").html(data); $("#myDiv").removeClass("grid-view-loading"); })
