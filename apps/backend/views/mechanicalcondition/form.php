        ...
        <div class="box box-primary">
            ...
            <div class="box-body">
                ...
                <div class="form-group col-lg-6">
                    <?php echo $form->labelEx($model, 'mechanicalcondition_name');?>
                    <?php echo $form->textField($model, 'mechanicalcondition_name',$model->getHtmlOptions('mechanicalcondition_name')); ?>
                    <?php echo $form->error($model, 'mechanicalcondition_name');?>
                </div>   
