        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="form-group col-lg-6">
                    ...
                    <?php echo $form->textField($model, 'position_name',$model->getHtmlOptions('position_name')); ?>
                ...
                <div class="form-group col-lg-6">
                    ...
                    <?php echo $form->textField($model, 'banner_width',$model->getHtmlOptions('banner_width')); ?>
                ...
                <div class="form-group col-lg-6">
                    ...
                    <?php echo $form->textField($model, 'banner_height',$model->getHtmlOptions('banner_height')); ?>
                ...
                <div class="clearfix"><!-- --></div>        
                 <?php
                  $model->slider = "N";
                  echo $form->hiddenField($model, 'slider'); ?>
