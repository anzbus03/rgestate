...
<?php
if(AccessHelper::hasRouteAccess("listingusers/status_change")){ ?> 
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-warning" onclick="updateStatus(this)" data-url="<?php echo Yii::app()->createUrl('listingusers/status_change',array('val'=>'I','id'=>$user->user_id));?>" >Inactive</button>
