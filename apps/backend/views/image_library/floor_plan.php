        ...
        $('#apply-bulk-action').on('click', function() {
            ...
            if (action && selectedItems.length) {
                if (confirm('Are you sure you want to proceed with this action?')) {
                    ...
                    $.ajax({
                        url: '<?php echo Yii::app()->createUrl(Yii::app()->controller->id . '/bulk_action_floor'); ?>', // Update with your action URL
                        type: 'GET',
                        data: {
                            bulk_action: action,
    ...
    Yii::app()->clientScript->registerScript('initialize-dataTables', "
            $(document).ready(function() {
                $('#home-banner-table').DataTable({
                    ...
                    processing: true,
                    ajax: {
                        url: '" . Yii::app()->createUrl(Yii::app()->controller->id . '/ajaxDataFloorPlan') . "',
                        type: 'GET',
                        data: function (d) {
