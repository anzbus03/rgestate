    ...
    <div class="card">
        <div class="card-header">
            ...
            <div class="pull-right">
                <?php echo CHtml::link(Yii::t('app', 'Remove all'), array('email_blacklist/delete_all'), array('class' => 'btn btn-primary btn-xs delete-all', 'title' => Yii::t('app', 'Remove all'), 'data-message' => Yii::t('dashboard', 'Are you sure you want to remove all blacklisted emails?')));?>
