        ...
        <div class="box box-primary">
            ...
            <div class="box-body">
                ...
                <div class="form-group col-lg-6">
                    <?php echo $form->labelEx($model, 'employment_type_name');?>
                    <?php echo $form->textField($model, 'employment_type_name',$model->getHtmlOptions('employment_type_name')); ?>
                    <?php echo $form->error($model, 'employment_type_name');?>
                </div>   
