...
if ($viewCollection->renderContent) {
    ...
    if ($collection->renderForm) {
         $form = $this->beginWidget('CActiveForm',array('htmlOptions'=>array('class'=>'form-horizontal','enctype' => 'multipart/form-data'),'focus'=>array($category,'name'))); 
        ...
        <div class="card">
            <div class="card-header">
                ...
                <div class="pull-right">
                    ...
                    <?php echo CHtml::link(Yii::t('app', 'Create new'), array('video_categories/create'), array('class' => 'btn btn-primary btn-xs', 'title' => Yii::t('app', 'Create new')));?>
                    <?php } ?>
                    <?php echo CHtml::link(Yii::t('app', 'Cancel'), array('video_categories/index'), array('class' => 'btn btn-primary btn-xs', 'title' => Yii::t('app', 'Cancel')));?>
                </div>
            ...
            <div class="card-body">
                ...
                <div class="clearfix"><!-- --></div>
					...
					<?php echo $form->labelEx($category, 'image');?>
					<?php echo $form->fileField($category, 'image',$category->getHtmlOptions('image')); ?>
					<?php echo $form->error($category, 'image');?>
					</div>   
					<div class="form-group col-lg-2" style="width:100px;height:100px; background-image:url('<?php echo Yii::App()->apps->getBaseUrl('uploads/default/'.$category->image);?>');background-size:contain;background-position:center;background-repeat:no-repeat;"></div>	 	
