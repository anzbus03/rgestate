        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                ?>
				    ...
				    <div class="clearfix"><!-- --></div>
				    <?php
				    if($model->isNewRecord and Yii::app()->request->getQuery('user_id','') != ''){ $model->user_id = Yii::app()->request->getQuery('user_id','');  } ?> 
                <div class="form-group col-lg-6">
                    <?php echo $form->labelEx($model, 'user_id');?>
                    <?php echo $form->dropDownList($model, 'user_id',CHtml::listData(ListingUsers::model()->DeveloperData(),'user_id','company_name'),$model->getHtmlOptions('user_id',array('empty'=>'Please Select'))); ?>
                ...
                <div class="form-group col-lg-6">
                    ...
                    <?php echo $form->dropDownList($model, 'status',array('A'=>'Active','Inactive'),$model->getHtmlOptions('link_url')); ?>
