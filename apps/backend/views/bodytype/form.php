        ...
        <div class="box box-primary">
            ...
            <div class="box-body">
                ...
                <div class="form-group col-lg-6">
                    <?php echo $form->labelEx($model, 'body_type_name');?>
                    <?php echo $form->textField($model, 'body_type_name',$model->getHtmlOptions('body_type_name')); ?>
                    <?php echo $form->error($model, 'body_type_name');?>
                </div>   
