...
'htmlOptions'=>array('enctype'=>'multipart/form-data'),
        ...
        <div class="card">
            ...
            <div class="card-body">
				...
				<?php echo $form->labelEx($model, 'alphabet');?>
				<?php echo $form->dropDownList($model, 'alphabet',$model->alphabetArray(),$model->getHtmlOptions('alphabet')); ?>
				<?php echo $form->error($model, 'alphabet');?>
				</div>  
                <div class="clearfix"><!-- --></div>
                 ...
                 <div class="forImage"   >    
					...
					<div class="form-group col-lg-6">
						<?php echo $form->labelEx($model, 'cover_image');?>
							<label>1140X160</label>
						<?php echo $form->fileField($model, 'cover_image',$model->getHtmlOptions('cover_image')); ?>
						<?php echo $form->error($model, 'cover_image');?>
					</div>   
				   	<?php
					if(!Yii::App()->request->isPostRequest and !empty($model->cover_image)){ ?>
					<div class="form-group col-lg-2">
					<?php echo $model->CoverImage;?>
					</div>   
					<?php } 
					?>
					<div class="clearfix"><!-- --></div>        
					...
					<div class="form-group col-lg-6">
						...
						<label>200X200</label>
						<?php echo $form->fileField($model, 'profile_image',$model->getHtmlOptions('profile_image')); ?>
						<?php echo $form->error($model, 'profile_image');?>
					</div>   
				   	<?php
					if(!Yii::App()->request->isPostRequest and !empty($model->profile_image)){ ?>
					<div class="form-group col-lg-2">
