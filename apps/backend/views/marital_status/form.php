        ...
        <div class="box box-primary">
            ...
            <div class="box-body">
                ...
                <div class="form-group col-lg-6">
                    <?php echo $form->labelEx($model, 'marital_name');?>
                    <?php echo $form->textField($model, 'marital_name',$model->getHtmlOptions('marital_name')); ?>
                    <?php echo $form->error($model, 'marital_name');?>
                </div>  
                  <div class="clearfix"><!-- --></div>
