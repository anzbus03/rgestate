...
?>
    <div class="row invoice-card-row" data-source="<?php echo $this->createUrl('dashboard/glance'); ?>">
                ...
                <div class="card bg-warning invoice-card">
                    <div class="card-body d-flex">
                        ...
                        <div>
                            ...
                            <span class="text-white fs-18">Revenue</span>
                        </div>
                    </div>
                </div>
            </a>
        ...
        <div class="col-xl-4 col-xxl-4 col-sm-6">
            <a href="#" class="card bg-secondary invoice-card text-white">
                <div class="card-body d-flex">
                    ...
                    <div>
                        <h2 class="text-white invoice-num"><?php echo $salesThisMonth; ?></h2>
        ...
        <div class="col-xl-4 col-xxl-4 col-sm-6">
            <!-- <a href="<?php echo Yii::app()->createUrl('place_property/index', array('PlaceAnAd[status]' => 'A', 'PlaceAoAd[section_id]' => '2')); ?>"
                class="card-link"> -->
            <a href="#" class="card-link">
                    ...
                    <div class="card-body d-flex">
                        ...
                        <div>
                            <h2 class="text-white text-left invoice-num">
                                <?php echo $user->target_for_sale ?: 'Not found'; ?><span
                                    style="font-size: 16px"><?php echo "/" . $user->target_period ?></span>
                            </h2>
                            <span class="text-white fs-18">Target for Sales</span>
                        </div>
                    </div>
                </div>
            </a>
            ...
            <a href="#" style="color: inherit; text-decoration: none;">
                <div class="card bg-secondary invoice-card">
                    <div class="card-body d-flex">
                        ...
                        <div>
                            <h2 class="text-white invoice-num"><?php echo $user->target_for_rent ?: 'Not found'; ?><span
                                    style="font-size: 16px"><?php echo "/" . $user->target_period ?></span></h2>
                            <span class="text-white fs-18">Target for Rent</span>
                        </div>
                    </div>
                </div>
            </a>
        ...
        <div class="row">
            <div class="col-xl-9 col-xxl-8 col-lg-7"></div>
