            ...
            if ($collection->renderGrid) {
                $this->widget('zii.widgets.grid.CGridView', $hooks->applyFilters('grid_view_properties', array(
                    ...
                    'columns' => $hooks->applyFilters('grid_view_columns', array(
                          ...
                          array(
                            'name'  => 'state_name',
                            'value' => '"<span>".$data->state_name."</span>&nbsp;".$data->getTranslateHtml("state_name")',
                            'type'=>'raw'
						...
						'type'=>'raw',
						'filter'=>false,
						'value'=>'CHtml::textField("priority[$data->state_id]",$data->priority,array("style"=>"width:50px;text-align:center","class"=>"form-controll"))',
                        ...
                        array(
                            ...
                            'buttons'   => array(
                                'update' => array(
                                    ...
                                    'url'       => 'Yii::app()->createUrl("'.Yii::app()->controller->id.'/update", array("id" => $data->state_id))',
                                    'imageUrl'  => null,
                                ...
                                'delete' => array(
                                    ...
                                    'url'       => 'Yii::app()->createUrl("'.Yii::app()->controller->id.'/delete", array("id" => $data->state_id))',
                                    'imageUrl'  => null,
