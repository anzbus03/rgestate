                    ...
                    <?php foreach ($article->search()->getData() as $data) { ?>
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="<?php echo Yii::app()->createUrl('blog_articles/update', array('id' => $data->article_id)); ?>" title="<?php echo Yii::t('app', 'Update'); ?>" class="btn btn-xs btn-warning">
                                    <span class="fa fa-pencil"></span>
                                </a>
                                <a href="<?php echo Yii::app()->createUrl('blog_articles/delete', array('id' => $data->article_id)); ?>" title="<?php echo Yii::t('app', 'Delete'); ?>" class="btn btn-xs btn-danger delete">
...
<script type="text/javascript">
    $(document).ready(function() {
        $('#blogs-datatable').DataTable({
            ...
            "columnDefs": [
                { "orderable": false, "targets": 4 } // Disable sorting for the Options column
            ],
            language: {
                paginate: {
