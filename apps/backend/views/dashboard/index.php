...
if ($viewCollection->renderContent) {
    ...
    <div class="row invoice-card-row" data-source="<?php echo $this->createUrl('dashboard/glance');?>">
        ...
        <div class="col-xl-4 col-xxl-4 col-sm-6">
            <a href="<?php echo Yii::app()->createUrl('place_property/index',array('PlaceAnAd[status]'=>'A','PlaceAnAd[section_id]'=>'1'));?>" class="card-link">
                <div class="card bg-warning invoice-card">
                    <div class="card-body d-flex">
                        ...
                        <div>
                            <h2 class="text-white invoice-num" data-bind="text: glance.subscribersCount">
                                <?php echo(count($ads)); ?>
                            </h2>
                            <span class="text-white fs-18">Active For Sale</span>
                        </div>
                    </div>
                </div>
            </a>
        ...
        <div class="col-xl-4 col-xxl-4 col-sm-6">
            <a href="<?php echo Yii::app()->createUrl('place_property/index',array('PlaceAnAd[status]'=>'A','PlaceAnAd[section_id]'=>'2'));?>" class="card-link">
                <div class="card bg-success invoice-card">
                    <div class="card-body d-flex">
                        ...
                        <div>
                            <h2 class="text-white text-left invoice-num">
                                <?php echo(count($adsRent)); ?>
                            </h2>
                            <span class="text-white fs-18">Active For Rent</span>
                        </div>
                    </div>
                </div>
            </a>
        ...
        <div class="col-xl-4 col-xxl-4 col-sm-6">
            <a href="<?php echo Yii::app()->createUrl('place_property/index',array('PlaceAnAd[status]'=>'A','PlaceAnAd[section_id]'=>'6'));?>" class="card-link">
                    ...
                    <div class="card-body d-flex">
                        ...
                        <div>
                            <h2 class="text-white invoice-num">
                                <?php echo(count($adsBusiness)); ?>
                            </h2>
                            <span class="text-white fs-18">Business Opportunities</span>
                        </div>
                    </div>
                </div>
            </a>
        ...
        <div class="col-xl-4 col-xxl-4 col-sm-6">
            <a href="<?php echo Yii::app()->createUrl('new_projects/index',array('NewDevelopment[status]'=>'A'));?>" class="card bg-secondary invoice-card text-white">
                <div class="card-body d-flex">
                    <div class="icon me-3">
                        <svg width="33px" height="32px">
                            <path fill-rule="evenodd" fill="rgb(255, 255, 255)"
                    ...
                    <div>
                        <h2 class="text-white invoice-num"><?php echo count($newProjects); ?></h2>
                        <span class="text-white fs-18">New Projects</span>
                    </div>
                </div>
            </a>
        </div>
        ...
        <div class="col-xl-4 col-xxl-4 col-sm-6">
            <a href="<?php echo Yii::app()->createUrl('place_property/index',array('PlaceAnAd[status]'=>'A','PlaceAnAd[preleased]'=>'1'));?>" style="color: inherit; text-decoration: none;">
                <div class="card bg-secondary invoice-card">
                    <div class="card-body d-flex">
                        ...
                        <div>
                            <h2 class="text-white invoice-num"><?php echo count($preLeasedProperties); ?></h2>
                            <span class="text-white fs-18">Preleased</span>
                        </div>
                    </div>
                </div>
            </a>
        ...
        <div class="col-xl-4 col-xxl-4 col-sm-6">
            <a href="<?php echo $this->createUrl('contact_us/index');?>" style="color: inherit; text-decoration: none;">
                <div class="card bg-secondary invoice-card">
                    <div class="card-body d-flex">
                        <div class="icon me-3">
                        <svg width="33px" height="32px">
                        ...
                        <div>
                            <h2 class="text-white invoice-num"><?php echo count($enquiries); ?></h2>
                            <span class="text-white fs-18">Enquiries</span>
                        </div>
                    </div>
                </div>
            </a>
