                ...
                $this->widget('zii.widgets.grid.CGridView', $hooks->applyFilters('grid_view_properties', array(
                    ...
                    'columns' => $hooks->applyFilters('grid_view_columns', array(
                        ...
                        array(
                            ...
                            'value' => '@$data->floor_plan_name' ,
                              
                              
                        ),
                        array(
                            'name'  => 'property',
                            'value' => '@$data->property1->name' ,
                              'filter'=>Property::model()->getProperty(),
                              ),
                       
                        array(
                            'name'  => 'project_id',
                            'value' => '@$data->project1->project_name' ,
                              'filter'=>Project::model()->getProject(),
                              ),
                        ...
                        array(
                            ...
                            'buttons'   => array(
                                'update' => array(
                                    ...
                                    'url'       => 'Yii::app()->createUrl("'.Yii::app()->controller->id.'/update", array("id" => $data->floor_plan_id))',
                                    'imageUrl'  => null,
                                    'options'   => array('title' => Yii::t('app', 'Update'), 'class' => ''),
                                ),
                                'delete' => array(
                                    'label'     => ' &nbsp; <span class="glyphicon glyphicon-remove-circle"></span> &nbsp; ', 
                                    'url'       => 'Yii::app()->createUrl("'.Yii::app()->controller->id.'/delete", array("id" => $data->floor_plan_id))',
                                    'imageUrl'  => null,
                                  ...
                                  'ban' => array(
                                    'label'     => ' &nbsp; <span class="glyphicon glyphicon-ban-circle"></span> &nbsp; ', 
                                     'url'       => 'Yii::app()->createUrl("'.Yii::app()->controller->id.'/status",array("id"=>$data->floor_plan_id,"status"=>$data->status))',
                                    'imageUrl'  => null,
