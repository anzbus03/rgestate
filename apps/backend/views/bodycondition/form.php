        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="form-group col-lg-6">
                    <?php echo $form->labelEx($model, 'bodycondition_name');?>
                    <?php echo $form->textField($model, 'bodycondition_name',$model->getHtmlOptions('bodycondition_name')); ?>
                    <?php echo $form->error($model, 'bodycondition_name');?>
                </div>   
