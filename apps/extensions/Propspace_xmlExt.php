...
class Propspace_xmlExt extends ExtensionInit 
{
    // name of the extension as shown in the backend panel
    public $name = 'Propspace -  XML';
   ...
   // public $pageUrl =  "WERWER";
    ...
    public function run()
    {
        $hooks = Yii::app()->hooks;
         Yii::app()->urlManager->addRules(array(
            array('gomasterkey_xml/index', 'pattern' => 'gomasterkey_xml/index'),
            
        ));
        
        // add the controller
        Yii::app()->controllerMap['gomasterkey_xml'] = array(
    ...
    {
        return Yii::app()->createUrl('gomasterkey_xml/index');
    }
