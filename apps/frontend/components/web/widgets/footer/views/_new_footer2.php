            ...
            <div class="row">
              <div class="col-sm-8 footer-left">
                ...
                <ul class="clearfix">
                  ...
                  <li> <a title="#" href="<?php echo $app->createUrl('business_listing/index',array('sec'=>'business-opportunities'));?>"><?php echo $tag->getTag('businesses_for_sale','Business Opportunities');?> </a> </li> 
