   ...
   <div class="zsg-footer-nav zsg-separator zsg-separator_narrow">
      <nav class="zsg-footer-row zsg-footer-linklist-container">
         <ul class="zsg-list_inline zsg-footer-linklist zsg-fineprint-header" style="margin-bottom:0px;" data-za-category="Navigation" data-za-action="Footer">
            <li><a href="<?php echo $app->createUrl('about-us');?>"  onclick="easyload(this,event,'mainContainerClass')"  >About<span class="m-mob"> Us</span></a></li><li><a href="<?php echo $app->createUrl('contact/index');?>"  >Contact<span class="m-mob"> Us</span></a></li><li><a href="<?php echo $app->createUrl('privacy');?>"  onclick="easyload(this,event,'mainContainerClass')"  >Legal Privacy</a></li><li><a href="<?php echo $app->createUrl('terms');?>"  onclick="easyload(this,event,'mainContainerClass')"  >Terms<span class="m-mob"> Of Use</span></a></li><li><a href="<?php echo $options->get('system.common.blog_link','#nogo');?>" target="_blank"   >Blog</a></li><li><a href="<?php echo $app->createUrl('sitemap');?>"  >Sitemap</a></li><li><span class="contact-nms"><span><a href="tel:<?php echo $options->get('system.common.contact_fax','');?>"><i class="fa fa-phone"></i> <?php echo $options->get('system.common.contact_phone_hide_with','');?></a></span><span><a href="tel:<?php echo $options->get('system.common.contact_phone','');?>"><i class="fa fa-phone"></i> <?php echo $options->get('system.common.contact_phone','');?></a></span></span></li>
          </ul>
      ...
      <ul class="zsg-list_inline"  >
         <li class="no-m-mob-h">
            <a href="<?php echo $app->createUrl('site/index');?>" class="zfoot-footer-logo">
                <img src="<?php echo $app->apps->getBaseUrl('assets/img/feetapk2.svg');?>" style="height:40px;">
        ...
        if(stripos($ua,'android') !== false){}else { ?> 
