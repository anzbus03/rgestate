  ...
  <section class="rg-partners">
      <div class="rg-section-header text-center mx-auto">
          <h2 class="rg-fs-30 rg-sm-fs-24 rg-text-blue rg-fw-600 text-capitalize rg-mt-20"><?php echo Yii::app()->tags->getTag('clients_partners','Our Clients and Partners')?></h2>
          <p class="rg-fs-18 rg-sm-fs-14 rg-text-gray-600 rg-fw-400 rg-mt-20"><?php echo Yii::app()->tags->getTag('work_companies','We are proud to work with these companies')?></p>
      </div>
