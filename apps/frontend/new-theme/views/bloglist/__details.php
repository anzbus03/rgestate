    ...
    <div class="container">
        <div class="row margin-top-40">
            <div class="col-sm-9  ">
                ...
                <article
                    class="post type-post status-publish format-standard has-post-thumbnail hentry category-rental-basics category-tips-advice">
                    ...
                    <div id="blogheader" class="padding-bottom-25">
                        <nav id="main-menu" class="default" style="position:relative;top: 6px;">
                            <ul id="menu-main-menu" class="main j-main-menu sf-js-enabled">
                                <li
                                    class="menu-item menu-item-type-taxonomy menu-item-object-category menu-item-4252 <?php echo $slug=='blog' ? 'active':'';?>">
                                    <a href="<?php echo Yii::app()->createUrl('bloglist/index');?>"><?php echo $this->tag->getTag('blog','Blog')  ;?>
                                    </a>
                                </li>
                                <?php
			foreach($category as $k=>$v){ ?>
                                <li
                                    class="menu-item menu-item-type-taxonomy menu-item-object-category menu-item-4252 <?php echo $slug==$v->slug ? 'active':'';?>">
                                    <a
                                        href="<?php echo Yii::app()->createUrl('bloglist/index',array('category'=>$v->slug));?>"><?php echo ucfirst($v->name)  ;?>
                                    </a>
                                </li>
                                <?php } ?>
                            </ul>
				...
				if(isset($imageUrl)){
                    ...
                    <div class="thumbnail">
                        ...
                        <img style="object-fit: contain;margin-top:10px;display:block;" src="<?php echo @$imageUrl;?>"
                            class="attachment-blog-image size-blog-image wp-post-image"
                    ...
                    <div class="detail">
                        ...
                        <div class="share-buttons">
                            <div class="addthis_toolbox addthis_default_style">
                                <a title="Facebook Share" target="_blank"
                                    href="https://www.facebook.com/sharer.php?u=<?php echo urlencode(Yii::app()->createAbsoluteUrl($model->slug.'/blog'));?>">
                                    <span class="fa fa-facebook"></span>
                                </a> <a title="Twitter Share" target="_blank"
                                    href="https://twitter.com/intent/tweet?original_referer=<?php echo urlencode(Yii::app()->createAbsoluteUrl($model->slug.'/blog'));?>&amp;url=<?php echo urlencode(Yii::app()->createAbsoluteUrl($model->slug.'/blog'));?>&amp;text=<?php echo urlencode($model->title);?>"><span
            ...
            <div class="col-sm-3" id="stky_w">
                <div id="stky" style="width:100%;">
                    <div>
                        ...
                        <!-- /widget -->
                        <button type="button" class="btn btn-primary sb-btn  " data-toggle="modal"
                            data-target="#exampleModal"><?php echo  $this->tag->getTag('subscribe_to_our_free_newslett','Subscribe to our free newsletter');?></button>
                        ...
                        <div class="widget">
							...
							?>
                                <li>
                                    <div class="alignleft">
                                        <a
                                            href="<?php echo Yii::app()->createUrl('bloglist/details', array('slug' => $v2->slug));?>"><img
                                                src="<?php echo $img;?>" alt=""></a>
                                    </div>
                                    <h3><a href="<?php echo Yii::app()->createUrl('bloglist/details', array('slug' => $v2->slug));?>"
                                            title=""><?php echo $v2->title;?></a></h3>
                                </li>
                                <?php } ?>
                            </ul>
                        </div>
