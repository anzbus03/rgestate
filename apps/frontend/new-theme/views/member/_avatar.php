 <div class="form-group col-lg-12 float-left <?php echo !empty($model->image) ? 'hidden' : '';?>" id="avatar_updator">
				...
				var largeImageDropzone = new Dropzone("div#largeImage", { url: "<?php echo Yii::app()->createUrl('place_an_ad/upload',array('width'=>'400','height'=>'400')); ?>",addRemoveLinks: true, maxFilesize: 1 ,maxFiles:1,  acceptedFiles: ".gif,.jpg,.jpeg,.png",}) //according to your forms action
