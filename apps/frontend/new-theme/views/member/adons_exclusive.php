<?php 
$video_packages = Package::model()->findFromCategoryID(5);
...
<div class="row margin-bottom-15 margin-top-60 first-marg">
	  <div class="col-sm-12">
		        ...
		        <div class="pageHeading   margin-bottom-25">
					<div class="desc-img"><img src="<?php echo Yii::app()->apps->getBaseUrl('assets/img/sticker.png');?>" alt="Video Package / Per Ad"  ></div>
					<div class="desc-det">
