...
if ($viewCollection->renderContent) { ?>
    <div class="box box-primary">
		...
		<strong><?php echo $this->tag->getTag('warning','Warning');?>!</strong> <?php echo $this->tag->getTag('inactive_or_deleted_ads_automa','Inactive or deleted ads automaticaly remove from your favorite list.');?>
		</div>
		 <div class="clearfix"><!-- --></div>
        <div class="box-body">
