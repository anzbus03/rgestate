...
if ($viewCollection->renderContent) { ?>
    <div class="box box-primary savedUrl">
                ...
                <li class=""> <a href="<?php echo Yii::app()->createUrl('member/enquiry');?>"><?php echo $this->tag->getTag('property_inquiries','Property Inquiries');?></a></li>
                
            	  <li class="active"><a href="#current"><?php echo $this->tag->getTag('agent_inquiries','Agent Inquiries');?></a></li>
     ...
     $name =  $model->getAttributeLabel('name');$ad_title =  $model->getAttributeLabel('ad_title');
           ...
           $user    =  $model->getAttributeLabel('realtor');
             $date = $model->getAttributeLabel('date1');
                        ...
                        array(
                            ...
                            'buttons'   => array(
                                'update' => array(
                                    ...
                                    'url'       => 'Yii::app()->createUrl("'.Yii::app()->controller->id.'/enq_agent_view", array("id" => $data->id))',
                                    'imageUrl'  => null,
                                   'options'   => array('title' => Yii::t('app', 'View'), 'id' => 'iframe','class'=>'iframe1'),
                                ),
                                'delete' => array(
                                    'label'     => ' &nbsp; <span class="fa fa-trash"></span> &nbsp; ', 
                                    'url'       => 'Yii::app()->createUrl("'.Yii::app()->controller->id.'/delete_agent_enq", array("id" => $data->id))',
                                    'imageUrl'  => null,
