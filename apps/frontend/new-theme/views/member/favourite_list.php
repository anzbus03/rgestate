...
if ($viewCollection->renderContent) { ?>
    <div class="box box-primary">
        <div class="box-header">
            <div class="pull-left">
                <h3 class="pageHeading">
                   <?php echo $this->tag->getTag('favourite_properties','Favourite Properties');?>    
	 ...
	 .owner { display:none !important; }
         ...
         <div class="clearfix"><!-- --></div>
		<div class="alert alert-warning" style="margin-bottom:10px;margin-top:10px;">
		<strong><?php echo $this->tag->getTag('warning','Warning');?>!</strong> <?php echo $this->tag->getTag('inactive_or_deleted_ads_automa','Inactive or deleted ads automaticaly remove from your favourite list.');?>
		</div>
		 <div class="clearfix"><!-- --></div>
        <div class="box-body">
                        ...
                        array(
                            ...
                            'buttons'   => array(
                                ...
                                'delete' => array(
                                    ...
                                    'url'       => 'Yii::app()->createUrl("'.Yii::app()->controller->id.'/delete_fave", array("id"=>$data->ad_id))',
                                    'imageUrl'  => null,
