...
<div class="insidecontent">
	...
	<div class="clearfix"></div>
	<div class="row <?php if (Yii::app()->isAppName('backend')) { ?> gap-3 <?php } ?>">
		<div class="clearfix"></div>
		<div class="form-group <?php if (Yii::app()->isAppName('backend')) { ?> col-lg-12 <?php } else { ?> col-lg-3 <?php } ?>">
			<?php
...
<div class="insidecontent">
	...
	<div class="row <?php if (Yii::app()->isAppName('backend')) { ?> gap-3 <?php } ?>">
		...
		<div class="form-group col-lg-12">
			<?php echo $form->labelEx($model, 'meta_title'); ?><?php echo $model->getTranslateHtml('meta_title'); ?>
			<?php echo $form->textField($model, 'meta_title', $model->getHtmlOptions('meta_title')); ?>
			<?php echo $form->error($model, 'meta_title'); ?>
		</div>

		<div class="form-group col-lg-12">
			<?php echo $form->labelEx($model, 'meta_description'); ?><?php echo $model->getTranslateHtml('meta_description'); ?>
			<?php echo $form->textArea($model, 'meta_description', $model->getHtmlOptions('meta_description', array('rows' => 4))); ?>
