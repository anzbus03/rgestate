...
if ($viewCollection->renderContent) {
    ...
    if ($collection->renderForm) {
        ...
        <div class="box box-primary">
            ...
            <div class="box-body place-property">
...
background:
    #fafafa;
     ...
     <?php  
                  ...
                  <div class="row">
                  	<div class="form-group col-lg-12">
						 ...
						 <div class="row">			 
                            ...
                            <h5 class="modal-title" id="exampleModalLabel">More Details / Features</h5>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">X</button>
                          </div>
							<div class="modal-body">
							 <?php $this->renderPartial('//place_property/_property_details',compact('form'));?>
                ...
                <div class="clearfix"><!-- --></div>
                 <div class="subhead font_s ros subhead_img" style="padding-right:10px;">Add Images <span class="pull-right">Hint: File types allowed: jpg, gif, png, Maximum filesize : 2MB </span></div>
		 <div class="clearfix"><!-- --></div> 
                <div class="row">
                	 <?php $this->renderPartial('//place_property/_image_upload',compact('form'));?> 
                </div>
 ...
 <div class="form-group col-lg-6">
										...
										<?php echo $form->error($model, 'mobile_number');?>
										 	 ...
										 	 <div class="form-group col-lg-6 hide">
												 <?php echo $model->user_id = Yii::app()->user->getId(); ?> 
