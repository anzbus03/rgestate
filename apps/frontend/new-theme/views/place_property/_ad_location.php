	...
	<?php  
	// Fetch cities initially based on the selected country
	...
	<div class="row">
	    <div class="form-group col-sm-12">
	        <div style="clear:both;padding:5px 5px 5px 0px;color:var(--secondary-color);font-weight:bold;font-size:15px;">
	            <?php echo $this->tag->getTag('enter_property_location','Enter property location');?>.</div>
	        <?php
...
function zoomMapminus(k) {
	...
	<div id="map_parent" class="form-group col-sm-12;positio:relative" style="position:relative">
	    <div class="zoomer-t" onclick="zoomMap(this)"><img
	            src="<?php echo Yii::app()->apps->getBaseUrl('assets/img/full-screen.png');?>" /></div>
	    <div class="zoomer-l" onclick="zoomMapminus(this)"><img
	            src="<?php echo Yii::app()->apps->getBaseUrl('assets/img/closen.png');?>" class=" "></div>
	...
	<script type="text/javascript"
	    src="<?php echo  'https://maps.googleapis.com/maps/api/js?libraries=places&key='.Yii::app()->options->get('system.common.google_map_api_key','AIzaSyBJ2Jo_mnCk9CnTNbTQAcb__elC9cKt6WQ');?>&language=<?php echo LANGUAGE;?>">
	</script>
	<script>
const componentForm = {
...
var latlng = new google.maps.LatLng('<?php echo $model->location_latitude; ?>',
    '<?php echo $model->location_longitude; ?>');
placeMarker(latlng);
<?php
	}
	?>
