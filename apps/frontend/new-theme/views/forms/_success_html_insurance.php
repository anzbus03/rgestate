...
<div class="success-modal" style="    margin: auto;" >
        ...
        <div class="info">
            ...
            <a href="<?php echo Yii::app()->createUrl('forms/insurance');?>" class="continue" style="display: inline-block;"  data-dismiss="modal"><?php echo $this->tag->gettag('continue','Continue') ;?></a>
        </div>
    </div>
