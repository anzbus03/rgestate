...
?>
 <style>.style2 h1 { font-size:28px;margin-bottom: 0 !important; }
              .feat_property .details .tc_content h1{color:#555;font-weight:600}.feat_property .details .tc_content h2{font-size:14px;font-family:var(--main-font);color:#333;line-height:1.2;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;margin-bottom:7px}
