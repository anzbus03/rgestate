...
<style>
.top_cls { display:flex; }.top_cls li,.plan-details li { list-style-type:none;     padding: 0 !important; 
    list-style-type: none !important;}.top_cls li:before,.plan-details li:before{ content:unset !important; }
...
ul.plan-details li {
    ...
    padding: 0!important;
    margin: 0!important;
}.top_cls li.active, .top_cls li:hover {
    color: var(--secondary-color) !important;
}.color_1 .price-option__purchase.green {
...
<?php
 ...
 $listPackage_ids = Package::model()->type_user_categories($u_type);
 ...
 $this->renderPartial('//member/_subscribe_pack',compact('idd','listing_packages','sb_title','offer_packages'));
 
 echo '<div class="add-f">';
...
?>     
<Style>
.add-f ul.plan-details li { display:none; }
.add-f    .price-option__detail {
    min-height: 89px;
    }
  .add-f   ul.plan-details li:first-child { 
