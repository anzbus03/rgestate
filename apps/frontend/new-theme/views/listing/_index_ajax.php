...
#listing .srp__sc-1scjcmt-0 { display:none !important; }
.list_details li { white-space:nowrap;overflow:hidden;text-overflow:ellipsis;}
.list_details li span{
    text-transform: capitalize;
}
@media only screen and (max-width: 768px) {
#listing .projects .project, #site .projects .project { 
...
#listing .maker_adjust.projects.filterModel_new-development .project .proj-info{
    margin-bottom: 16px;
    border-radius: 8px;
}.project-tile-info { padding-left:5px; padding-right:5px;}
		</style>
		<div class="clearfix"></div>
...
<style>
     html #listing-cnt.container{ padding:25px 0px 50px !important;}#listing-cnt h2{ font-weight:700; margin-bottom:15px;font-size:28px;}
