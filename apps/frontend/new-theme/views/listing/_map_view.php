...
var icon1 ={
   ...
   var icon2 ={
    ...
    var e = 'details-page-container'; var t = $(k).attr('data-href');  //window.location.href = t;
...
var is_aj = false
 function initMapView2() {
    ...
    */
    ...
    for (n.addListener("idle", function() {
            ...
            var s = t.getNorthEast(),
                a = t.getSouthWest();
            new google.maps.LatLng(s.lat(), a.lng()), new google.maps.LatLng(a.lat(), s.lng()), e ? ($("#a").val(boundsSwLatLng.lat()), $("#b").val(boundsSwLatLng.lng()), $("#c").val(boundsNeLatLng.lat()), $("#d").val(boundsNeLatLng.lng()), $("#lt").val(i), $("#lg").val(o), $("#zoom").val(n.getZoom()),  is_aj = true, search_byAjax()) : e = 1
        ...
        return function() {
            var htm = '<div style="position:relative"><a href="'+locations[t][5]+'" target="_blank" style="position:absolute;left:0;right:0;top:0;bottom:0;z-index:1111;"></a><div class="cardPhoto backgroundPulse"  data-g ="b"  style="height:80px;width:100%; background-color:#ddd;background-image:url('+locations[t][6]+') ; background-position:center center;background-size:cover; background-repeat:no-repeat;"> <div class="tagsListContainer"></div></div><div class="cardDetails cardDetailsmm man pts pbn phm h6 typeWeightNormal"><div><span class="cardPrice h5 man pan typeEmphasize noWrap typeTruncate">' + locations[t][7] + '</span></div><div data-reactid="61"> <ul class="listInline typeTruncate mvn prop_detailss" data-reactid="62">'+locations[t][8]+'</ul></div><div class="cardDetails man pts pbn phm h6 typeWeightNormal"  ><div ><span class="cardPrice h5 man pan typeEmphasize noWrap typeTruncate" data-reactid="59" style="width:120px;font-size:12px;">'+locations[t][9]+'</span></div></div></div>'
...
function onhoverShowProp(){ 
	  $(".lst-prop").mouseover(function() {
		...
		if(imgsrc===undefined){
			var imgsrc = $(this).find('.lozad').attr('data-src');
		}
