            ...
            <a href="<?php echo $v->detailUrl; ?>">
                <figure class="project-effect llod">
                    <img data-src="<?php echo $v->getAd_image_singlenew('600'); ?>"
                         ...
                         style="min-height:150px;z-index:1">
                    <figcaption>
                        <div class="hidden-info">
                            <?php
                            /* Uncomment to display property categories
                            ...
                            if (!empty($all_property_types)) { ?>
                                ...
                                <div class="desc">
                                    <?php
                                    $str = '';
                                    foreach ($all_property_types as $k2 => $v2) {
                                        $str .= $v2->category_name . ',';
                                    }
                                    echo rtrim($str, ',');
                                    ?>
                                </div>
                ...
                <div class="project-tile-info">
                    <div class="project-info-mob">
                        <div class="logo">
                            <img src="<?php echo $v->CompanyImage; ?>" alt="<?php echo $v->CompanyName; ?>">
                        </div>
                        <div class="dev-info">
