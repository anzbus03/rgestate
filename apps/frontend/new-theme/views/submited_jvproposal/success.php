				...
				<div class="col-sm-12">
					...
					<h3>
						<font style="vertical-align: inherit;">
							<font style="vertical-align: inherit;">
								<?php echo $this->tag->getTag('successfully_submitted!','Successfully Submitted!');?>
							</font>
						</font>
					</h3>
					<p>
						<font style="vertical-align: inherit;">
							<font style="vertical-align: inherit;">
								<?php echo Yii::t('app',$this->tag->getTag('your_message_was_successfully_','Thanks [NAME] <span class="email">[EMAIL]</span> <br /> Your message was successfully sent to the [SITE] Support Team.<br /> One of our representative will contact you soon.'),array('[SITE]'=>$this->project_name, '[NAME]'=>$name, '[EMAIL]' => $email));?>  
							</font>
						</font>
					</p>
					<p> 
						<a href="<?php echo Yii::app()->createUrl('site/index');?>" class="btn btn-primary btn-block headfont" style=";;font-size: 14px;line-height: unset;padding: 0px;vertical-align: middle;display: inline-block;padding: 5px 15px;">
							<?php echo $this->tag->getTag('go_to_the_home_page','Go to the home page');?>
						</a> 
					</p>
				</div>
			</div>
