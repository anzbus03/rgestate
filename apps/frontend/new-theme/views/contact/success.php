	 ...
	 <div class="confirm-page">
			<div class="row">
				<div class="col-sm-12">
					...
					<p><font style="vertical-align: inherit;"><font style="vertical-align: inherit;"><?php echo Yii::t('app',$this->tag->getTag('your_message_was_successfully_','Your msessage was successfully sent to the [SITE] Support Team. One of our representative will contact you soon.'),array('[SITE]'=>$this->project_name));?>  </font></font></p>
					<p> <a href="<?php echo Yii::app()->createUrl('site/index');?>" class="btn btn-primary btn-block headfont" style="font-size: 14px;"><?php echo $this->tag->getTag('go_to_the_home_page','Go to the home page');?></a> </p>
					</div>
			</div>
		</div>
