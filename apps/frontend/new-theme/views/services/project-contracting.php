                        ...
                        <?php
					       ...
					       'id' =>'signUpForm2',
        					...
        					?>
    							...
    							<input type="hidden" name="ContactPopup[type]" value="Project Contracting" >
                                <div class="form-group">
        ...
        <div class="container">
            <div
                ...
                <div class="position-relative z-1">
                    ...
                    <?php echo $this->tag->getTag('project_contracting_solution','Transform Your Project Vision with Tailored Contracting Solutions');?>    </h2>
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="rg-we-partner-left">
                        ...
                        <?php echo $this->tag->getTag('project_contracting_faq','Frequently Asked Questions about Project Contracting');?>
                        </h2>
                        ...
                        <div class="accordion" id="accordionExample">
                            ...
                            <div class="accordion-item">
                                ...
                                <div id="collapseEight" class="accordion-collapse collapse"
                                    data-bs-parent="#accordionExample">
                                    <div class="accordion-body">
                                        <?php echo $this->tag->getTag('project_contracting_faq_8_ans','Initiating the process is simple—reach out to us through our contact channels. We\'ll guide you
