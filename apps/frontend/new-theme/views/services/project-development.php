    ...
    <section class="rg-page-header">
        <div class="container">
            <div class="rg-page-header-bg rg-project-development position-relative overflow-hidden">
                <div class="rg-page-header-content position-relative d-flex flex-column justify-content-center z-1">
                    <h1 class="rg-fs-40 rg-fw-600 text-white">
                          <?php echo $this->tag->getTag('project_development_dubai','Project Developments in Dubai') ?>
                        </h1>
                    <p class="rg-fs-16 mt-4 rg-text-gray-300">
                          <?php echo $this->tag->getTag('project_development_transform','Transform your vision into reality with RGEstate\'s expert project development in Dubai. Your trusted partner for tailored solutions and successful execution.') ?></p>
                    <div class="rg-breadcrumb mt-4">
                        <nav>
                            <ol class="breadcrumb rg-fs-16 rg-fw-400 mb-0">
                                <li class="breadcrumb-item"><a href="#">
                                    <?php echo $this->tag->getTag('home','Home') ?>
                                    </a></li>
                                <li class="breadcrumb-item active"><?php echo $this->tag->getTag('project_development','Project Development') ?></li>
                            </ol>
                        </nav>
                    </div>
                </div>
                ...
                <div class="col-lg-7">
                    <div class="rg-static-header position-relative d-flex flex-column justify-content-center">
                        <h2 class="rg-fs-40 rg-fs-sm-26 rg-fw-700 rg-text-blue">
                            <?php echo $this->tag->getTag('embark_project_development','Embark on Transformative Project Developments in Dubai:') ?>
                            
                            </h2>
                        <p class="rg-fs-18 rg-fw-400 rg-text-gray-800 mt-3 rg-w-420">
                            <?php echo $this->tag->getTag('success_project_development','Your Path to Success') ?>
                            
                        </p>
                    </div>
                    <p class="rg-fs-18 rg-fw-400 rg-text-gray-800">
                        <?php echo $this->tag->getTag('division_project_development','At RGEstate, a division of Riveria Global Group, we recognize the importance of well-executed project developments in Dubai\'s dynamic landscape. Our specialized Project Development services are meticulously designed to provide tailored solutions that empower individuals and businesses to bring their visions to life through successful project execution.') ?>
                        ...
                        <?php
					       ...
					       'id' =>'signUpForm2',
        					...
        					?>
    							...
    							<input type="hidden" name="ContactPopup[type]" value="Project Development" >
                                <div class="form-group">
                    ...
                    <ul class="rg-static-stats rg-br-10 d-flex flex-column flex-md-row">
                     ...
                     <p class="rg-fs-18 rg-fw-400 rg-text-gray-800">
                         <?php echo $this->tag->getTag('project_development_leveraging','Leveraging our deep understanding of the local market and unwavering commitment to excellence, we aim to be your strategic partner in transforming 
                         your project ideas into tangible reality. Discover how our Project Development services can accelerate the realization of your projects, enhance efficiency, 
                         and maximize the potential of your ventures.');?>
                         </p>
                </div>
               <div class="col-lg-5">
    ...
    <!--            <div class="col-lg-6">-->
    <!--                <div class="rg-static-header position-relative d-flex flex-column justify-content-center">-->
    <!--                    <h2 class="rg-fs-40 rg-fw-700 rg-text-blue">Achieve Your Project Development Vision with Customized Solutions, in partnership with RGEstate – Your Trusted Partner in Investments in UAE.</h2>-->
    <!--                    <p class="rg-fs-18 rg-fw-400 rg-text-gray-800 mt-3 rg-w-286">Schedule a Consultation Today</p>-->
    <!--                </div>-->
    ...
    <!--            </div>-->
    <!--            <div class="col-lg-6">-->
    <!--                <img class="d-block w-100 rg-br-20 object-fit-cover" src="<?php echo $this->app->apps->getBaseUrl('theme'); ?>/assets/images/project-development-invest-in-your-vision.jpg"-->
            ...
            <div
                ...
                <div class="position-relative z-1 py-5">
                    <h2 class="rg-fs-28 rg-fw-700 text-white mx-auto text-center">
                        <?php echo $this->tag->getTag('project_development_achieve','Achieve Your Project Development Vision with Customized Solutions, in partnership with RGEstate – Your Trusted Partner in Investments in UAE.');?>
                       
                        </h2>
                    <p class="rg-fs-16 rg-sm-fs-14 rg-fw-400 text-white text-center mt-3">
                        <?php echo $this->tag->getTag('project_development_consultaion','Schedule a Consultation Today');?>
                        </p>
                    <ul
                        ...
                        <li class="ms-0 ms-sm-4 mt-4 mt-sm-0">
                            <a href="<?php echo Yii::app()->createUrl('contact-us');?>" class="btn btn-outline-light">
                                <?php echo $this->tag->getTag('contact_us','Contact Us');?></a>
                        </li>
                    </ul>
                </div>
            </div>
                ...
                <div class="col-lg-6">
                    <div class="rg-we-partner-left">
                        <h2 class="rg-fs-40 rg-fs-sm-24 rg-fw-700 text-black">
                            <?php echo $this->tag->getTag('faq_prject_development','Frequently Asked Questions about Project Developments');?>
                            
                            </h2>
                        <p class="rg-fs-18 tp-bg-gray-600 rg-mt-20">
                            
                            <?php echo $this->tag->getTag('faq_prject_development_short','Get answers to common questions about our Project Development services.');?>
                            </p>
                        <a href="<?php echo Yii::app()->createUrl('contact-us');?>" class="btn btn-primary d-inline-flex align-items-center rg-mt-40">
                            <span><?php echo $this->tag->getTag('contact_us','Contact Us');?>s</span>
                            <svg width="15" height="11" class="ms-3">
                                <use xlink:href="<?php echo $this->app->apps->getBaseUrl('theme'); ?>/assets/images/icons.svg#rg-next-arrow"></use>
                            </svg>
                        </a>
                            ...
                            <div class="accordion-item">
                                <h2 class="accordion-header">
                                    <button class="accordion-button" type="button" data-bs-toggle="collapse"
                                        ...
                                        <?php echo $this->tag->getTag('faq_prject_development_1','What types of projects are suitable for development services?');?>
                                    </button>
                                </h2>
                                <div id="collapseOne" class="accordion-collapse collapse show"
                                    data-bs-parent="#accordionExample">
                                    <div class="accordion-body">
                                        <?php echo $this->tag->getTag('faq_prject_development_1_answe','Our Project Development services cover a wide range of projects, including residential, commercial, and mixed-use developments. Whether it\'s a luxury residence or a thriving business complex, we\'re here to discuss your development needs.');?>
                            ...
                            <div class="accordion-item">
                                <h2 class="accordion-header">
                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                        ...
                                        <?php echo $this->tag->getTag('faq_prject_development_2','How long does the development process typically take?');?>
                                    </button>
                                </h2>
                                <div id="collapseTwo" class="accordion-collapse collapse"
                                    data-bs-parent="#accordionExample">
                                    <div class="accordion-body">
                                        <?php echo $this->tag->getTag('faq_prject_development_2_answe','The timeline for project development can vary based on factors like project complexity and scope. We prioritize efficiency and aim for timely execution to help you bring your projects to life promptly.');?>
                                    </div>
                                </div>
                            </div>
                            <div class="accordion-item">
                                <h2 class="accordion-header">
                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                        ...
                                        <?php echo $this->tag->getTag('faq_prject_development_3','Is project feasibility analysis part of the development process?');?>    
                                ...
                                <div id="collapseThree" class="accordion-collapse collapse"
                                    data-bs-parent="#accordionExample">
                                    <div class="accordion-body">
                                       <?php echo $this->tag->getTag('faq_prject_development_3_answe','Absolutely, project feasibility analysis is a crucial aspect of the development process. Our experts will guide you through this during the consultation, ensuring a transparent and informed approach.');?>
                            ...
                            <div class="accordion-item">
                                <h2 class="accordion-header">
                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                       ...
                                       <?php echo $this->tag->getTag('faq_prject_development_4','Can startups or small businesses benefit from project development services?');?> 
                                ...
                                <div id="collapseFour" class="accordion-collapse collapse"
                                    data-bs-parent="#accordionExample">
                                    <div class="accordion-body">
                                       <?php echo $this->tag->getTag('faq_prject_development_4_answe','Certainly, we welcome projects of all scales, including startups and small businesses. Our tailored solutions cater to the unique development needs of various enterprises.');?> 
                            ...
                            <div class="accordion-item">
                                <h2 class="accordion-header">
                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                       ...
                                       <?php echo $this->tag->getTag('faq_prject_development_5','How are development strategies determined?');?> 
                                    </button>
                                </h2>
                                <div id="collapseFive" class="accordion-collapse collapse"
                                    data-bs-parent="#accordionExample">
                                    <div class="accordion-body">
                                       <?php echo $this->tag->getTag('faq_prject_development_5_answe','Development strategies are devised through a comprehensive assessment of project feasibility, market trends, and risk factors. This ensures strategies align with your project goals and market conditions.');?> 
                                    </div>
                                </div>
                            </div>
                            <div class="accordion-item">
                                <h2 class="accordion-header">
                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                       ...
                                       <?php echo $this->tag->getTag('faq_prject_development_6','What sets RGEstate\'s development services apart?');?> 
                                ...
                                <div id="collapseSix" class="accordion-collapse collapse"
                                    data-bs-parent="#accordionExample">
                                    <div class="accordion-body">
                                       <?php echo $this->tag->getTag('faq_prject_development_6_answe','RGEstate stands out for its market expertise, transparent communication, and client-centric approach. Our tailored development solutions and our commitment to excellence make us a preferred choice for successful project execution in Dubai.');?> 
                            ...
                            <div class="accordion-item">
                                <h2 class="accordion-header">
                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                       ...
                                       <?php echo $this->tag->getTag('faq_prject_development_7','Is support provided even after project execution?');?>
                                    </button>
                                </h2>
                                <div id="collapseSeven" class="accordion-collapse collapse"
                                    data-bs-parent="#accordionExample">
                                    <div class="accordion-body">
                                       <?php echo $this->tag->getTag('faq_prject_development_7_answe','Absolutely, our support extends beyond project execution. We offer ongoing assistance including project evaluation, consultation, and ensuring your project\'s alignment with your goals.');?>
                            ...
                            <div class="accordion-item">
                                <h2 class="accordion-header">
                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                       ...
                                       <?php echo $this->tag->getTag('faq_prject_development_8','How do I initiate the project development process with RGEstate?');?>
                                ...
                                <div id="collapseEight" class="accordion-collapse collapse"
                                    data-bs-parent="#accordionExample">
                                    <div class="accordion-body">
                                       <?php echo $this->tag->getTag('faq_prject_development_8_answe','To begin, simply reach out to us through our contact channels. We\'ll guide you through the initial steps, including a consultation to discuss project details and development requirements. Together, we\'ll transform your project vision into reality. 
                                        Feel free to customize and adjust this content according to your needs. If you have specific details or preferences you\'d like to include, please let me know!');?>
                                    </div>
                                </div>
                            </div>
                        </div>
