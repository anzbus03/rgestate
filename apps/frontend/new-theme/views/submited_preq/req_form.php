    ...
    <div class="row">
      ...
      <div class="col-md-10 col-sm-12 col-xs-12 main-div">
        ...
        <div class="property-query-area">
         	...
         	<?php
						$maintTaxt = $this->tag->getTag('submit_your_property_requireme','Submit Your Property Requirement');
	$Validating = $this->tag->getTag('validating','Validating..');
	$please_wait = $this->tag->getTag('please_wait','Please wait..');
					$form = $this->beginWidget('CActiveForm', array(
					       'id' =>'signUpForm',
					'action'=>Yii::app()->createUrl('submited_preq/index'),
          ...
          <style>
              ...
              html[dir="rtl"] .m-btu {  margin-right:0px;  margin-left:15px;}
               html[dir="rtl"]  label { margin-right: 5px; }
              .form-control { 
    ...
    text-indent: 10px;
        ...
        <div class="row form-group">
						<div class="col-sm-4 text-right">
						    <?php echo $form->labelEX($model, 'p_for');?>
						
						</div>
							<div class="col-sm-8">
								<?php   
					 
								$list = $model->p_forarray();
								echo $form->radiobuttonList($model, 'p_for', $list,  $model->getHtmlOptions('p_for',array('placeholder'=>'','template' => '<div class="m-btu">{input}{label}</div>', 'separator'=>''))); ; ?>
								<?php echo $form->error($model, 'p_for');?>
							</div>
	    </div>
		      ...
		      <div class="row form-group">
						<div class="col-sm-4 text-right">
							...
							<div class="col-sm-8">
								<?php    
								echo $form->dropDownList($model, 'property_type',   MainCategory::model()->generateOpt(), $model->getHtmlOptions('property_type',array('empty'=>$this->tag->getTag('please_select','Please Select')))); ; ?>
	 	 ...
	 	 <div class="row form-group">
						<div class="col-sm-4 text-right">
						    <label for="<?php echo $model->modelName;?>_budget_min" class="required"><?php echo $this->tag->getTag('budget','Budget');?> <span class="required">*</span></label>
							...
							<div class="col-sm-8">
							    <div class="row">
                                        <div class="col-sm-6">
                                        <?php    
                                        echo $form->textField($model, 'budget_min',  $model->getHtmlOptions('budget_min',array( 'oninput'=>"this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');"))); ; ?>
                                        <?php echo $form->error($model, 'budget_min');?>
                                        </div>
                                        <div class="col-sm-6">
                                        <?php    
                                        echo $form->textField($model, 'budget_max',  $model->getHtmlOptions('budget_max',array( 'oninput'=>"this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');"))); ; ?>
		 	 ...
		 	 <div class="row form-group">
						<div class="col-sm-4 text-right">
						    <label for="<?php echo $model->modelName;?>_area_min" class="required"><?php echo $this->tag->getTag('built_up_area','Built Up Area');?></label>
							...
							<div class="col-sm-8">
							    <div class="row">
							            <div class="col-sm-4">
                                        <?php    
                                        echo $form->dropDownList($model, 'unit', CHtml::listData(AreaUnit::model()->listData(),'master_id','master_name'),  $model->getHtmlOptions('unit')); ; ?>
                                        <?php echo $form->error($model, 'unit');?>
                                        </div>
                                        <div class="col-sm-4">
                                        <?php    
                                        echo $form->textField($model, 'area_min',  $model->getHtmlOptions('area_min',array( 'oninput'=>"this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');"))); ; ?>
                                        <?php echo $form->error($model, 'area_min');?>
                                        </div>
                                        <div class="col-sm-4">
                                        <?php    
                                        echo $form->textField($model, 'area_max',  $model->getHtmlOptions('area_max',array( 'oninput'=>"this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');"))); ; ?>
                                        <?php echo $form->error($model, 'area_max');?>
                                        </div>
								</div>
		    ...
		    <div class="row form-group">
						<div class="col-sm-4 text-right">
							...
							<div class="col-sm-8">
								<?php    
								 $cities =  CHtml::listData(States::model()->AllListingStatesOfCountry(66124) ,'state_id' , 'state_name') ;
								echo $form->dropDownList($model, 'city_id',  $cities, $model->getHtmlOptions('city_id',array('empty'=>$this->tag->getTag('please_select','Please Select')))); ; ?>
...
<h2 ><?php echo $this->tag->getTag('your_contact_details','Your Contact Details');?></h2>
			  <div class="row form-group">
						<div class="col-sm-4 text-right">
							...
							<div class="col-sm-8">
								...
								$list = $model->ownerarray();
								echo $form->radiobuttonList($model, 'owner_type', $list,  $model->getHtmlOptions('owner_type',array('placeholder'=>'','template' => '<div class="m-btu">{input}{label}</div>', 'separator'=>''))); ; ?>
        ...
        echo $form->textField($model, 'phone',  $model->getHtmlOptions('phone',array('placeholder'=>'','onchange'=>'validateThisInp()', 'oninput'=>"this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" ))); ; ?>
        	<?php 
