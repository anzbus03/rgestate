<div id="map_locator">
<?php $this->renderPartial('_filter_html_developer');?>
<?php 
if(empty($adsCount)){
...
<div class="container margin-top-40" id="">
            ...
            <div class="row hFrwo margin-0">
                <div class="col-md-6 padding-0 the-head-sorter">
                  <h3 class="headline  margin-bottom-0 margin-left-0"><?php echo $title ;?> Real Estate Developers</h3>
                </div>
            </div>
             ...
             <div class="row hFrwo margin-0  " >
                <div class="col-sm-4 padding-0 margin-0">
                    <span class="  margin-0" id="loader_againn">
                               ...
                               <?php 
                                if(!empty($title)){
    									    	echo Yii::t('trans', '{c} developers  available on {t} ' ,array('{c}'=>$adsCount ,'{t}'=> $title ))  ;
    										}else{
    										    echo Yii::t('trans', '{c} developers  available' ,array('{c}'=>$adsCount ))  ;
    							}
                                ?> 
  ...
  <a href="<?php echo Yii::app()->createUrl('user_listing/index',array('country'=>$v->slug,'user_type'=>'D'));?>">
                  <div class="col-md-3">
                     <div class="spanstyle">
...
<div class="container margin-top-20">
		   <h3 class="headline  margin-bottom-20 margin-left-0"> <?php echo $title ;?> Real Estate Developers</h3>
