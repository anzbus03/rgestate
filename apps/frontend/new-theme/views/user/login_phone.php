        ...
        <div class="sign-in-form style-1"  >
          ...
          <h4 class="subheading_font row bold-style"><a href="<?php echo $this->app->createUrl('user/login_option');?>" style="display:inline-block;margin-right:5px;" onclick="easyload(this,event,'pajax')" class="bld-link2"><span data-aut-id="enteruser-click-back" class="_2uUJF"><svg width="14px" height="14px" viewBox="0 0 1024 1024" data-aut-id="icon" class="" fill-rule="evenodd"><path class="rui-22SD7" d="M196.267 469.333l315.733-320-59.733-59.733-422.4 422.4 422.4 422.4 59.733-59.733-320-320h759.467l42.667-42.667-42.667-42.667h-755.2z"></path></svg></span></a>Log in with your phone</h4>
			...
			<?php $form=$this->beginWidget('CActiveForm', array(
							'id'=>'signin-form',
								'action'=>Yii::app()->createUrl('user/signin_phone'),
...
.iti input { margin-right:0px !important;    width: 100% !important; } .iti { width:100%; }
	...
	<div class="clearfix"></div>
		 ...
		 <div id="right-col" style="float:none !important;;border-left:0px !important; margin:auto;max-width: 300px;margin: auto;display:block;"  >
		...
		<div class="form-group  ">
							...
							<?php  	echo $form->textField($user , 'phone' ,  $user->getHtmlOptions('phone',array('class'=>'form_have_placeholder input-text form-control','placeholder'=>'','style'=>'font-size: 16px; line-height: 24px; padding: 12px 12px 12px 92px; height: auto; width: 100%;margin-right:0px !important;', 'oninput'=>"this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" )));  ?>
...
<a href="<?php echo Yii::app()->createUrl('user/signin');?>" onclick="easyload(this,event,'pajax')" class="bld-link2" >Login with Email?</a>
							</div>
		</div> 
							</div><!-- end #signin-form -->
	...
	<?php $this->endWidget();?>
			...
			<!-- Register -->
			 		<div class="clearfix"></div>
				<div class="lastrow margin-top-0"><span class="pull-left">Don't have an account? <a href="<?php echo Yii::App()->createUrl('user/signup');?>" onclick="easyload(this,event,'pajax')" class="link_color" style="font-weight:400">Click here to register</a></span><div class="clearfix"></div></div>
				<div class="clearfix"></div>
