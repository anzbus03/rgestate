	...
	*/
    ...
    width: 100% !important;
}#ListingUsers_phone{ direction:ltr; unicode-bidi:embed; }
#ListingUsers_con_password_em_{white-space: nowrap;}
		</style>
	 ...
	 <div class="clearfix"></div> 
		...
		<div class="form-group  ">
							...
							<div class="col-sm-6" style="width:50%;">
                                 <div class='input-text form-control   LJB smllinput ' placeholder="" style="width:100%;" id='ListingUsers_password'></div>
							<?php echo $form->error($model, 'password');?>
						 
                             
							</div>
									<div class="col-sm-6 padding-left-0 conp" style="width:50%;">
                        
                           
							<?php  	echo $form->passwordField($model , 'con_password' ,  $model->getHtmlOptions('con_password',array('class'=>'input-text form-control  LJB smllinput','placeholder'=>$this->tag->getTag('password_*','Confirm Password *')  )));  ?>
	 ...
	 <div class="clearfix"></div>  
	 	<div class="form-group  ">
                        	...
                        	unset(	$user_type_array['U']);	unset(	$user_type_array['A']);
...
<div class="clearfix"></div>
	...
	<div class="clear"></div>
					<div class="checkboxes">
						...
						<?php  echo $form->checkBox($model , 'agree',  $model->getHtmlOptions('agree',array('onchange'=>'agreeTerms(this)')) );  ?> 
	...
	<div class="form-group  margin-bottom-0 ">
							...
							<button  type="submit" class="btn btn-primary btn-block headfont btn-sm-s rounded-btn-n"  disabled id="bb"   style="margin-top:20px;width:100%;max-width: 100% !important;" ><?php echo $register;?></button>
...
<script  type="text/javascript" >
 $(function(){	
    ...
    $(function(){
		setTimeout(function(){ $('#ListingUsers_password').find('input').attr('placeholder','<?php echo $this->tag->getTag('password_*','Password *');?>');$('#ListingUsers_password').find('input').addClass('form-control LJB smllinput'); }, 300);
