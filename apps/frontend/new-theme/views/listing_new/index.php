        ...
        <div class="rg-properties-header d-flex flex-column flex-sm-row align-items-start align-items-sm-center justify-content-between mt-2">
            ...
            <div class="rg-filter-by d-flex align-items-center">
                ...
                <div class="dropdown rg-fs-14 ms-2 dropup-start">
                    <a class="dropdown-toggle rg-text-gray-700" type="button" data-bs-toggle="dropdown" aria-expanded="false">Default Order</a>
                ...
                <div class="col-xl-3 col-lg-4 col-md-6">
                    <div class="rg-featured-card rg-br-16 mt-5">
                        <div class="rg-featured-img position-relative">
                            <div class="rg-badges text-uppercase d-flex align-items-center justify-content-between position-absolute w-100">
                                <?php if ($add->featured == "Y" || $add->featured2 == 'Y') { ?>
                            ...
                            <a href="<?php echo $add->detailUrl; ?>">
                                <img src="<?php echo $add->getAd_image_singlenew("293"); ?>" title="<?php echo $titleText; ?>" class="d-block w-100 h-100 object-fit-cover" alt="<?php echo $titleAltText; ?>">
                            </a>
                        </div>
                        <div class="rg-featured-body">
                            <div class="rg-featured-body-top">
                                ...
                                <p class="rg-fs-12 rg-fw-500 rg-text-gray-600 text-capitalize d-flex align-items-center mt-4">
                                ...
                                <ul class="rg-featured-list d-flex flex-wrap">
                                    <li class="rg-fs-12 rg-fw-400 rg-text-gray-600 text-capitalize d-flex align-items-center w-50 mt-3">
                            ...
                            <ul class="rg-featured-footer d-flex align-items-center justify-content-between border-top">
                                <li>
                                    <a href="#" class="btn btn-outline-primary rg-fs-12 rg-fw-500 rg-br-4 d-flex align-items-center">
