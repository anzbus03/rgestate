...
<head>
    ...
    ?>
    <script>
        var baseid = '<?php echo ASKAAN_PATH_BASE; ?>';
        var baseid2 = '<?php echo ASKAAN_PATH_BASE . $prefx; ?>';
        $(function() {
            iniFrame()
        });
...
<style>
    ...
    .selcted-val .dropdown-search input::placeholder {
        color: #fff;
        opacity: 1;
    }

    .selcted-val .dropdown-search input:-ms-input-placeholder {
        color: #fff;
    }
    ...
    .selcted-val .dropdown-search input {
        position: relative;
        top: -5px;
    }
    ...
    .new-multiple .dropdown-display-label {
    ...
    @media only screen and (max-width: 600px) {
        ...
        .main-search-inner .nav-tabs--search {
            flex-wrap: wrap;
        }

        .main-search-inner .nav-tabs--search li {
            min-width: 50% !important;
            margin: 5px 0px;
        }

        .main-search-inner .slider-form .nav-link {
            line-height: 2 !important;
        }

        .main-search-inner .nav-tabs--search li.active a::before {
            content: unset;
        }

        #site .home_container.d-hm {
        ...
        #place_an_ad_no_login .banner,
        #submited_preq .banner,
        #submited_jvproposal .banner,
        #new_projects .banner {
            height: 200px;
        }

        #place_an_ad_no_login .bloghead,
        #submited_preq .bloghead,
        #submited_jvproposal .bloghead,
        #new_projects .bloghead {
            max-width: 90%;
        }

        #place_an_ad_no_login .bloghead .fancy-title,
        #submited_preq .bloghead .fancy-title,
        #submited_jvproposal .bloghead .fancy-title,
        #new_projects .bloghead .fancy-title {
            font-size: 25px;
        }

        #place_an_ad_no_login .site-blocks-wrapper,
        #new_projects .site-blocks-wrapper {
            padding: 0px 0px;
            top: unset;
            box-shadow: unset !important;
        }

        #place_an_ad_no_login .site-block,
        #new_projects .site-block {
            text-align: center;
        }

        html body #place_an_ad .box.place-property,
        html #new_projects .box {
            box-shadow: unset !important;
        ...
        html #new_projects .box.box-primary {
            margin-top: 0px;
        }

        #submited_preq .main-div,
        #submited_jvproposal .main-div {
            border: 0px;
            border-radius: 0px;
            box-shadow: unset !important;
            background: #fff;
        ...
        #submited_preq .main-div .text-right,
        #submited_jvproposal .main-div .text-right {
            text-align: left;
        }

        .mob-category-selector {
            display: block !important;
        }
        ...
        .foot-items .social-icons a {
            line-height: 29px;
        }

        #detail #frm_ctnt .col-sm-7 {
            width: 100% !important;
            text-align: right;
        }
        ...
        #listing .breadcrumb_content.style2 b {
            display: flex !important;
        }
    }

    @media only screen and (min-width: 992px) {
        .arab-drop-down button>span {
            width: 100%;
        }
    ...
    .right-handle .search-popup-cntainer {
        right: 0px;
...
<body id="<?php echo $this->id; ?>" class="<?php echo !empty($openFilter) ? 'openfilter' : ''; ?>">
    ...
    <noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-5Q8V4GM" height="0" width="0" style="display:none;visibility:hidden"></iframe></noscript>
    ...
    <div id="base-container">
        <div class="" hidden>
            ...
            <svg id="new_bed" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
                <path d="M9.196 14.603h15.523v.027h1.995v10.64h-3.99v-4.017H9.196v4.017h-3.99V6.65h3.99v7.953zm2.109-1.968v-2.66h4.655v2.66h-4.655z" fill="currentColor" />
            </svg>

            <svg id="new_bath" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
                <path d="M23.981 15.947H26.6v1.33a9.31 9.31 0 0 1-9.31 9.31h-2.66a9.31 9.31 0 0 1-9.31-9.31v-1.33h16.001V9.995a2.015 2.015 0 0 0-2.016-2.015h-.67c-.61 0-1.126.407-1.29.965a2.698 2.698 0 0 1 1.356 2.342H13.3a2.7 2.7 0 0 1 1.347-2.337 4.006 4.006 0 0 1 3.989-3.63h.67a4.675 4.675 0 0 1 4.675 4.675v5.952z" fill="currentColor" />
            </svg>

            <svg id="new_area" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
                <path d="M13.748 21.276l-3.093-3.097v3.097h3.093zm12.852 5.32H10.655v.004h-5.32v-.004H5.32v-5.32h.015V5.32L26.6 26.596z" fill="currentColor" />
            </svg>
                        ...
                        <div class="b-cookies-notification__container ">
                            <div class="b-cookies-notification__description">
                                <div>
                                    ...
                                    echo $cookie_test;
                                    if (!empty($cookie_url)) {
                                        echo 'Learn more by clicking on "More information".';
                                        echo '<a class="b-cookies-notification__terms" href="<?php echo $cookie_url; ?>" target="_blank">
                                            More Information
                                        </a>';
                                     } ?>
                                </div>
