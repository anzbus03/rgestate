...
return array(
    ...
    'Mailer' => 'smtp',
    'Host' =>Yii::app()->options->get('system.common.smtp_host'),
    'Port' => Yii::app()->options->get('system.common.smtp_port'),
    'SMTPSecure' => 'ssl',
    'SMTPAuth' => true,
    'Username' => Yii::app()->options->get('system.common.smtp_username'),
    'Password' => Yii::app()->options->get('system.common.smtp_password'),
);
