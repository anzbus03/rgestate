        ...
        'urlManager' => array(
            ...
            'rules' => array(
				...
				*/                
				...
				array('listing/index', 'pattern' =>'<sec:(property-for-sale|property-for-rent|to-rent|investments|new-development|all)>/<category:(.*)>/<type_of:(.*)>/<state:(.*)>/<sub_state:(.*)>/*'),
				array('listing/index', 'pattern' =>'<sec:(property-for-sale|property-for-rent|to-rent|investments|new-development|all)>/<category:(.*)>/<type_of:(.*)>/<state:(.*)>/*'),
				array('listing/index', 'pattern' =>'<sec:(property-for-sale|property-for-rent|to-rent|investments|new-development|all)>/<category:(.*)>/<type_of:(.*)>/<sub_state:(.*)>/*'),
				array('listing/index', 'pattern' =>'<sec:(property-for-sale|property-for-rent|to-rent|investments|new-development|all)>/<category:(.*)>/<state:(.*)>/*'),
				array('listing/index', 'pattern' =>'<sec:(property-for-sale|property-for-rent|to-rent|investments|new-development|all)>/<category:(.*)>/<type_of:(.*)>/*'),
				array('listing/index', 'pattern' =>'<sec:(property-for-sale|property-for-rent|to-rent|investments|new-development|all)>/<type_of:(.*)>/<state:(.*)>/*'),
				array('listing/index', 'pattern' =>'<sec:(property-for-sale|property-for-rent|to-rent|investments|new-development|all)>/<category:(.*)>/<sub_state:(.*)>/*'),
				array('listing/index', 'pattern' =>'<sec:(property-for-sale|property-for-rent|to-rent|investments|new-development|all)>/<type_of:(.*)>/<sub_state:(.*)>/*'),
				array('listing/index', 'pattern' =>'<sec:(property-for-sale|property-for-rent|to-rent|investments|new-development|all)>/<category:(.*)>/*'),
				array('listing/index', 'pattern' =>'<sec:(property-for-sale|property-for-rent|to-rent|investments|new-development|all)>/<type_of:(.*)>/*'),
				array('listing/index', 'pattern' =>'<sec:(property-for-sale|property-for-rent|to-rent|investments|new-development|all)>/<state:(.*)>/*'),
				array('listing/index', 'pattern' =>'<sec:(property-for-sale|property-for-rent|to-rent|investments|new-development|all)>/<sub_state:(.*)>/*'),
				array('listing/index', 'pattern' =>'<sec:(property-for-sale|property-for-rent|to-rent|investments|new-development|all)>/*'),  

				'<sec:(property-for-sale|property-for-rent|investments)>'=>'listing/index',
