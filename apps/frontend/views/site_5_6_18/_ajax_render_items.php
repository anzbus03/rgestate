    ...
    <div class="item homer">
                              ...
                              <a href="<?php echo $v->detailUrl;?>" class="listing-item-container">
                                 <div class="listing-item">
                                   <?php   $image = $this->app->apps->getBaseUrl('uploads/images/'.$v->ad_image);?>
                                    <img src="<?php echo $this->app->apps->getBaseUrl('timthumb.php');?>?src=<?php   echo  $image   ;?>&h=175&w=265&zc=1" alt="">
               ...
               <div class="container margin-top-40" id=""  >
				  ...
				  if(!empty($new_homes)){
				   ...
				   ?>
                  <div class="row <?php echo  $class_n;?>"   >
                     <div class="col-md-12 seperate_mar2"  >
                        <h3 class="headline  margin-bottom-10  col-md-12 no-margin-left  "> New Properties For Sale in <?php echo  $section_name;?> </h3>
                     </div>
                     <div class="col-md-12 seperate_mar"  >
                        <div>
                           <!-- Listing Item -->
                           ...
                           foreach($new_homes as $k=>$v){ 
						    ...
						    ?>    
                           <div class="item_ko <?php echo $s_class_n;?>">
                              <a href="<?php echo $v->detailUrl;?>" class="listing-item-container">
                                 <div class="listing-item">
                                    <?php   $image = $this->app->apps->getBaseUrl('uploads/images/'.$v->ad_image);?>
                                    <img src="<?php echo $this->app->apps->getBaseUrl('timthumb.php');?>?src=<?php   echo  $image   ;?>&h=175&w=265&zc=1" alt="">
                  ...
                  <div class="row <?php echo $class_n;?>"    >
                     <div class="col-md-12 seperate_mar2"  >
                        <h3 class="headline  margin-bottom-10  col-md-12 no-margin-left  "> New Properties For Rent in <?php echo  $section_name;?> </h3>
                     </div>
                     <div class="col-md-12 seperate_mar" >
                        <div>
                           <!-- Listing Item -->
               ...
               if(!empty($featured_developments)){
				   ...
				   <div class="row">
                     <div class="col-md-12">
                        <h3 class="headline  margin-bottom-10  col-md-12 no-margin-left  "> Featured Developments in <?php echo  $section_name;?> </h3>
                     </div>
                     <div class="col-md-12 seperate_mar">
                        <div>
                           <!-- Listing Item -->
