...
else
{
	?>
	<?php
	if(Yii::app()->user->hasFlash('verifySuccess'))
	{
		?>
	<div class="confirmation span12">			<span></span>  <?php echo Yii::app()->params['emailVerificationMessage'];?>	</div>
	<?php
	}
    ?>
<fieldset id="fbsignin-form" class="span12">
	...
	<div id="content-col">
		...
		<ul class="tabs">
			...
			<li id="registertab">
				<span class="lefttab"></span>
				<a href="<?php echo Yii::app()->createUrl("user/signiup");?>" onclick='return false;'>Register</a>
				<span class="righttab"></span>
			</li>
		</ul>
...
<div id="tab1" class="tab_content active_content">
	<?php $form=$this->beginWidget('CActiveForm', array(
		...
		<div id="right-col">
			...
			<div id="signin-form">
				<h4>Sign in with <?php echo   Yii::app()->options->get('system.common.site_name');?></h4>
				<?php
				if(Yii::app()->user->hasFlash('loginfail'))
				{
					?>   
				 <div class="error1" style="width:215px;">Please enter a valid email address and password.</div>
				 <?php
			 }
			 ?>
	...
	<?php $this->endWidget();?>
				...
				<div id="tab2" class="tab_content">
						...
						<div class="form-row" hint="username@provider.com">
							...
							<input id="id_email" type="text" class="textbox" value="<?php  echo $user->email ;?>" name="email" maxlength="75" />
							<div class="clear"></div>
						</div>
						...
						<div class="form-row" hint="username@provider.com (confirm)">
							...
							<input id="id_email2" type="text" class="textbox" value="<?php  echo $user->email ;?>" name="email2" maxlength="75" />
							<div class="clear"></div>
						</div>
						...
						<div class="form-row">
							...
							<div class="multiple">
								<div class="multiple_password1">
									<input id="id_password1_hint" type="text" value="Password" style="display:none" /><input id="id_password1" type="password" class="textbox" name="password1" />
								</div>
								<div class="multiple_password2">
									<input id="id_password2_hint" type="text" value="Confirm password" style="display:none" /><input id="id_password2" type="password" class="textbox" name="password2" />
								</div>
							</div>
							<div class="clear"></div>
						</div>
						...
						<div class="form-row" hint="Please enter your real name.">
							...
							<input id="id_first_name" type="text" class="textbox" <?php echo $user->first_name;?> name="first_name" />
							<div class="clear"></div>
						</div>
						...
						<div class="form-row" hint="Your last name will be kept private.">
							...
							<input id="id_last_name" type="text" class="textbox"  value="<?php  echo $user->last_name ;?>" name="last_name" />
							<div class="clear"></div>
						</div>
						...
						<?php
					    echo CHtml::dropDownList('country',$user->country,CHtml::listData(Countrieslist::model()->listData(),'id','name'),array("id"=>"id_nationality", "empty"=>"- Select One -","style"=>"width:207px;")); 
					    ?>
						<div class="clear"></div>
						</div>
					...
					<?php
					echo CHtml::dropDownList('position_level',$user->position_level,CHtml::listData(Occupation::model()->listData(),'occupation_id','occupation_name'),array("id"=>"id_role", "empty"=>"- Select One -","style"=>"width:207px;")); 
					?>
					...
					<div class="clear"></div>
						...
						<label for="id_education">My highest academic achievement is
						 ...
						 <?php
						 echo CHtml::dropDownList('education_level',$user->education_level,CHtml::listData(EducationLevel::model()->listData(),'education_id','education_name'),array("id"=>"id_education", "empty"=>"- Select One -","style"=>"width:207px;")); 
					     ?>
						<div class="clear"></div>
						</div>
						
						<div class="cb-form-row">
							<label for="id_third_party_emails">
								<input checked="checked" type="checkbox" name="updates" id="id_third_party_emails" />
								&nbsp;Send me occasional updates about this site.</label>
							<br />
							<label for="id_dubizzle_email_updates">
								<input checked="checked" type="checkbox" name="advertisement" id="id_dubizzle_email_updates" />
