...
<fieldset id="account-settings" class="span12">
  <legend class="nobackground"><i class="fa fa-gear" aria-hidden="true"></i> Account Settings</legend>
	<?php
  ...
  <div class="group" id="name" style="margin:20px 0px">
	...
	'htmlOptions' => array('class' => 'form-e'  ),
        ...
        <div class="col"><label for="id_last_name">Last Name: &nbsp </label>
         <?php echo $form->textField($user, 'last_name', array_merge($user->getHtmlOptions('last_name'),array( "class"=>"textbox"))); ?> 
  ...
  <div class="group" id="password">
	...
	<span id="edit-name-button:expandable:expandable-button frebites_button"><a href="javascript:void(0)" ><i class="fa fa-edit"></i> Edit</a></span> 
	</div>
