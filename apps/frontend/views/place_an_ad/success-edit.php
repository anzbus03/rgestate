               ...
               <div class="content_place_an_ad clb">
				 ...
				 <div class="content_head"  >Step 4 : Completed </div>
                    ...
                    <div id="header_title" class="span12">
							...
							<h3 class="pre-select-cat">Successfully updated your  listing  property on <?php echo $this->app->options->get('system.common.site_name');?> . <br /> After administrator valiadation , your listing  will active on main website. </h3>
							<?php } ?> 
