        ...
        <div class="box box-primary">
            ...
            <div class="box-body">
                ...
                <ol class="progtrckr" data-progtrckr-steps="4">
					...
					<li class="progtrckr-done">Coose Location</li>
                ...
                <div class="content_place_an_ad clb">
                    ...
                    <div id="header_title" class="span12">
							...
							<h3 class="pre-select-cat">Thanks for listing  property on <?php echo $this->app->options->get('system.common.site_name');?> . <br /> After administrator valiadation , your listing  will active on main website. </h3>
							<?php } ?> 
