...
switch(Yii::app()->controller->action->id)
{
	...
	break;
	case 'list':
	$title = $articleCategoryFromSlug->name;
	$keywords = $articleCategoryFromSlug->name;
	$description = $articleCategoryFromSlug->description;
	break;
	default:
	$title = Yii::app()->options->get('system.common.site_name')." Blog";
	$keywords =  Yii::app()->options->get('system.common.site_name')." Blog";
	$description = Yii::app()->options->get('system.common.site_name')." Blog";
	break;
