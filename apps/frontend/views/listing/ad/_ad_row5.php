   <div class="" id="<?php echo $rw_ids;?>">
				   <div class=" ">
                     ...
                     <div class="col-md-12 padding-0">
                        <h3 class="headline  <?php echo  empty($sub_header)? 'margin-bottom-10':'margin-bottom-0';?>    col-md-12 no-margin-left padding-left-0 "> <?php echo $header; ?> </h3>
							...
							<?php 
							 ...
							 foreach($field  as $k=>$v){
								   if($total_size>3){  ?> <div class="carousel-item"><?php } ?> 
												<div class=" padding-left-15  padding-right-0  col-xs-5th-1" style="<?php  if($total_size>3){ echo 'width:100%';} ?>">
												  <a href="<?php echo $v->detailUrl;?>" class="listing-item-container  margin-bottom-0">
													 ...
													 <div class="listing-item-content spanfont absC padding-right-0">
														<h3 class="white" style="color:#fff !important;padding:10px !important"><?php echo $v->adTitle;?></h3>
													 </div>
												  </a>
											   </div>
											   <?php
		 ...
		 if($total_size>3){
			 ?>
			 <script>  generateSliderC('<?php echo $rw_ids;?>',5);</script>
			 <?php
		 }
