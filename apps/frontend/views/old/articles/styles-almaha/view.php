...
<div id="pageContainer" class="container margin-top-240">
	...
	<div class="navigate_link"><span class="cmsCrumbar"><a href="<?php echo Yii::app()->apps->getBaseUrl('');?>">Home</a> <span>&gt;  <?php echo  Countries::model()->getDefaultCountry();?> </span><span> &gt; <?php echo $article->title;?></span></span></div>
	<div class="bottom_line_2 crmbrimg">
	<span></span>
	<span></span>
	</div>
	<h1 class="crumbarHeadingCms"> <span class="bluecolor"> <?php echo $article->title;?>  </span>  </h1>
	<?php
	if(!empty( $imageExist)){ ?> 
