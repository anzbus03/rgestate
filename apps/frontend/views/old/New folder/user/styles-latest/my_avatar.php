  		 ...
  		 ?>
            ...
            <div style="position:relative">
      			...
      			<div class="buttons">
					...
					<a class="awesome large maroon" href="javascript:" onclick="$('#profile-form').submit();">Replace</a> 
    ...
    <ul>
		...
		foreach($avatar as $k=>$v)
		{
			?>
				...
				<img class="profile_img" src="<?php echo Yii::app()->request->baseUrl;?>/uploads/avatar/<?php echo $v->avatar_name;;?>" style="width:50px;height:50px;">
