        ...
        <div class="box box-primary">
            ...
            <div class="box-body">
	           ...
	           <div style="clear:both"></div>
                <div class="content_place_an_ad">
				   ...
				   <div style="clear:both"></div>
				     ...
				     <div class="content_content">
									<div class="clearfix"><!-- --></div>
									  <div style="font-weight:bold;color:#6B6B6B;font-size:16px;margin-bottom:20px;">Ad Type : <?php echo $subcategory->category->category_name;?>/<?php echo $subcategory->sub_category_name;?>&nbsp;<a href="<?php echo Yii::app()->createUrl("place_an_ad/create"); ?>" class="my_link">Change</a></div>
                                    ...
                                    <div class="form-group col-lg-12">
										...
										<?php echo $form->textArea($model, 'ad_description',array_merge( array("cols"=>"880", "rows"=>"5","width"=>"100%" ))); ?>
				...
				<div class="condition">
				<p>
				By posting your ad,you are agreeing to the <?php echo Yii::app()->name; ?>				<a target="_blank" href="<?php echo Yii::app()->createUrl('article/terms');?>">Terms & Condition</a>
				and the  <?php echo Yii::app()->name; ?>
