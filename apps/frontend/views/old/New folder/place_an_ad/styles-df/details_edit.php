                 ...
                 <div class="content_place_an_ad">
				   ...
				   <div style="clear:both"></div>
				      <div class="content_content">
						...
						{
						echo $subcategory->category->category_name;?>/<?php echo $subcategory->sub_category_name;?>&nbsp;<a href="<?php echo Yii::app()->createUrl("place_an_ad/update",array("id"=>$model->id)); ?>">Change</a></div>
						<?php
						}	
						else
						{
								...
								?>  
								   ...
								   <?php }  ?>       
									...
									<div class="form-group col-lg-6">
										...
										<?php echo $form->dropDownList($model, 'model', array_replace(CHtml::listData(VehicleModel::model()->findByModels($model->sub_category_id),'model_id','model_name'),array(array('Others'=>'Others'))) , $mer ); ?>
