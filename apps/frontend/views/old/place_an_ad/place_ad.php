	...
	clear:both;
			...
			<div class="inner-wrap">
				<div class="percent50">
					...
					<?php $mer =  array_merge($model->getHtmlOptions('section_id'),array('empty'=>"Select","class"=>"form-control","onChange"=>"getCategory(this)")); ?>
				...
				<div class="percent50 fltright">	
					...
					<?php $mer =  array_merge($model->getHtmlOptions('category_id'),array('empty'=>"Select","class"=>"form-control","onChange"=>"getSubCategory(this)")); ?>
					<?php echo $form->dropDownList($model, 'category_id',  CHtml::listData(Category::model()->findAll(),'category_id','category_name') , $mer ); ?>
					<?php echo $form->error($model, 'category_id');?>
				</div>	
				<div class="clear"></div>
					<?php echo $form->labelEx($model, 'sub_category_id');?>
					<?php $mer =  array_merge($model->getHtmlOptions('sub_category_id'),array('empty'=>"Select","class"=>"form-control")); ?>
					<?php echo $form->dropDownList($model, 'sub_category_id',   CHtml::listData(Subcategory::model()->findAllByAttributes(array('category_id'=>$model->category_id)),'sub_category_id','sub_category_name') , $mer ); ?>
					<?php echo $form->error($model, 'sub_category_id');?>
				<div class="percent50">		
					<?php echo $form->labelEx($model, 'country');?>
					<?php $mer =  array_merge($model->getHtmlOptions('country'),array('empty'=>"Select","class"=>"form-control","onChange"=>"getState(this)")); ?>
					<?php echo $form->dropDownList($model, 'country', CHtml::listData(Countries::model()->Countrylist2(),'country_id','country_name') , $mer ); ?>
					<?php echo $form->error($model, 'country');?>
				</div>	
				<div class="percent50 fltright">		
					<?php echo $form->labelEx($model, 'state');?>
					<?php $mer =  array_merge($model->getHtmlOptions('state'),array('empty'=>"Select","class"=>"form-control","onChange"=>"getCity(this)")); ?>
					<?php echo $form->dropDownList($model, 'state', CHtml::listData(States::model()->findAllByAttributes(array('country_id'=>$model->country)),'state_id','state_name') , $mer ); ?>
					<?php echo $form->error($model, 'state');?>
				</div>		
				<div class="clear"></div>
				<div class="percent50">	
					<?php echo $form->labelEx($model, 'city');?>
					<?php $mer =  array_merge($model->getHtmlOptions('city'),array('empty'=>"Select","class"=>"form-control","onChange"=>"getDistrict(this)")); ?>
					<?php echo $form->dropDownList($model, 'city', array()  , $mer ); ?>
					<?php echo $form->error($model, 'city');?>
				</div>		
				<div class="percent50 fltright">	
					<?php echo $form->labelEx($model, 'district');?>
					<?php $mer =  array_merge($model->getHtmlOptions('district'),array('empty'=>"Select","class"=>"form-control","onChange"=>"getCommunity(this)")); ?>
				...
				<div class="percent50">	
					...
					<?php $mer =  array_merge($model->getHtmlOptions('community_id'),array('empty'=>"Select","class"=>"form-control","onChange"=>"getSubCommunity(this)")); ?>
				...
				<div class="percent50 fltright">		
					...
					<?php $mer =  array_merge($model->getHtmlOptions('sub_community_id'),array('empty'=>"Select","class"=>"form-control","onChange"=>"")); ?>
				...
				<div class="clear"></div>	
					...
					<?php $mer =  array_merge($model->getHtmlOptions('occupant_status'),array('empty'=>"Select","class"=>"form-control" )); ?>
			...
			<input type="submit" name="Submit" style="float:left;color:#fff !important;" value="Submit" class="  back-searchbutton" />
